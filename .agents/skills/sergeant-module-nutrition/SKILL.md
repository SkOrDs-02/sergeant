...
- Канон: [docs/product/modules/nutrition.md](../../../docs/product/modules/nutrition.md), включно з **§ Журнал рішень** — рішення там уже ухвалені, не перепитуй maintainer-а.
- Розбіжності канон↔код: [docs/work/specs/audits/product-knowledge-nutrition.md](../../../docs/work/specs/audits/product-knowledge-nutrition.md).
...
- Комора — append-only ledger: залишок **derived**, записи не мутуються ([ADR-0077](../../../docs/governance/adr/0077-pantry-append-only-ledger.md)).
- День-ключ логу їжі — за годинником пристрою, формат `YYYY-MM-DD` ([ADR-0078](../../../docs/governance/adr/0078-day-boundary-device-local.md)).
- Вага тіла НЕ живе в nutrition — єдине джерело істини fizruk ([ADR-0080](../../../docs/governance/adr/0080-body-weight-source-of-truth.md)).
