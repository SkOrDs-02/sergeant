...
- Канон: [docs/product/modules/finyk.md](../../../docs/product/modules/finyk.md), включно з **§ Журнал рішень** — рішення там уже ухвалені, не перепитуй maintainer-а.
- Розбіжності канон↔код: [docs/work/specs/audits/product-knowledge-finyk.md](../../../docs/work/specs/audits/product-knowledge-finyk.md).
...
- Фінансові періоди і серверні звіти — Europe/Kyiv; особиста доба користувача — за годинником пристрою ([ADR-0078](../../../docs/governance/adr/0078-day-boundary-device-local.md)).
- «Готівка на руках» — окрема сутність, не рахунок ([ADR-0076](../../../docs/governance/adr/0076-cash-on-hand-entity.md)).
- Минуле заморожене: закриті місяці не перераховуються, знаменник відсотка бюджету — канонічний ([ADR-0079](../../../docs/governance/adr/0079-frozen-past-and-canonical-denominator.md)).
