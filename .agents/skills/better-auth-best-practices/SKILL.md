...
- `docs/playbooks/change-auth-flow.md` — canonical-playbook для зміни самої auth-поведінки (login/logout/session/cookie/plugin) з verification на парі Vercel ↔ Railway.
