...
- Якщо змінюється cookie/session-поведінка — перечитай [docs/02-engineering/integrations/railway-vercel.md](../../../docs/02-engineering/integrations/railway-vercel.md).
...
- `docs/00-start/playbooks/change-auth-flow.md` — canonical-playbook для зміни самої auth-поведінки (login/logout/session/cookie/plugin) з verification на парі Vercel ↔ Railway.
