...
| **Планується** _(green)_ | Те, що описано у планах, founder апрувнув    | `docs/launch/...`, `docs/05-design/design/redesign-v2/...` |
...
- **Документи з обґрунтуванням.** Розгорнуті дискусії й decision logs
  лишаються у `docs/` (`docs/launch/`, `docs/05-design/design/`). Мокап посилається
