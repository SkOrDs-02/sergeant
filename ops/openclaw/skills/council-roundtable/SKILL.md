...
- Legacy implementation reference (grammy bot fallback): [`tools/console/src/openclaw/handler-commands.ts`](../../../../tools/console/src/openclaw/handler-commands.ts) `bot.command("council", …)`.
- Plugin-side budget gate helper: [`packages/openclaw-plugin/src/council.ts`](../../../../packages/openclaw-plugin/src/council.ts).
