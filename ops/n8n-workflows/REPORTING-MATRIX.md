...
⁽⁵⁾ Wave 3 §3.2 ADR-0038 — у CRITICAL гілці спочатку постить idempotent
...
Решта broadcast workflows (WF-01/02/05/06/08/15/16/17/19/30/60/63/98/99)
дотягають ack-row у наступних mechanical sub-PR — pattern зафіксований у
WF-04 + WF-03 + WF-18; кожен sub-PR ≈30 LOC + smoke у staging. Server-side
endpoint — [`apps/server/src/modules/alerts/store.ts`](../../apps/server/src/modules/alerts/store.ts).
