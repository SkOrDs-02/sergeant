...
- **Time:** день-ключ особистих сутностей — device-local ([ADR-0078](../../docs/governance/adr/0078-day-boundary-device-local.md)); `Europe/Kyiv` — для відображення та серверних звітів.
