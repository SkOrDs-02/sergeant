...
Source-of-truth для контексту і дорожньої карти: [`docs/90-work/planning/openclaw-migration-plan.md` § Reality update 2026-05-12](../../docs/90-work/planning/archive/openclaw-migration-plan.md). Цей README — короткий статус самого пакета.
