 ...
 * на ink-поверхнях він дає **1.11…2.74:1**. Заміри (fg на
 * bg #14100e / surface #1b1613 / surfaceHi #221c18):
 *
 *   brand     stone-800 #292524 — 1.25 / 1.18 / 1.11
 *   finyk     teal-800  #115e59 — 2.49 / 2.37 / 2.22
 *   fizruk    cyan-800  #155e75 — 2.60 / 2.47 / 2.32
 *   routine   rose-800  #8d4256 — 2.74 / 2.60 / 2.44
 *   nutrition lime-800  #466212 — 2.72 / 2.58 / 2.42
 *
 ...
 * тобто **1.64…1.84:1**: так само невидимо. Пара, яка сама нечитабельна,
...
export const accentInkHex = {
  brand: "#d6d3d1", // stone-300 — 12.04:1 на #1b1613
  finyk: "#2dd4bf", // teal-400  — 9.64:1 на #1b1613
  fizruk: "#22d3ee", // cyan-400  — 9.93:1 на #1b1613
  routine: "#f68da4", // rose-400  — 7.91:1 на #1b1613
  nutrition: "#b0e636", // lime-400  — 12.14:1 на #1b1613
};
