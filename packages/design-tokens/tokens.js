 ...
 * базу. У «Чорнилі» він дає 2.07:1 (red-800 #991b1b на картці #1f1a17),
 ...
 *
 * Пороги на ink-поверхнях (bg #14100e / surface #1f1a17 / surfaceHi
 * #2a231f) — 5.59…11.33:1, найтісніше в danger.
 */
export const statusInkHex = {
  success: "#34d399", // emerald-400 — 8.97:1 на #1f1a17
  warning: "#fbbf24", // amber-400   — 10.32:1 на #1f1a17
  danger: "#f87171", // red-400     — 6.23:1 на #1f1a17
  info: "#38bdf8", // sky-400      — 8.05:1 на #1f1a17
};
 ...
 * bg #14100e / surface #1f1a17 / surfaceHi #2a231f):
 *
 *   brand     stone-800 #292524 — 1.25 / 1.14 / 1.02
 *   finyk     teal-800  #115e59 — 2.49 / 2.27 / 2.04
 *   fizruk    cyan-800  #155e75 — 2.60 / 2.37 / 2.13
 *   routine   rose-800  #8d4256 — 2.74 / 2.50 / 2.24
 *   nutrition lime-800  #466212 — 2.72 / 2.48 / 2.22
 *
 ...
 * тобто **1.50…1.84:1**: так само невидимо. Пара, яка сама нечитабельна,
...
export const accentInkHex = {
  brand: "#d6d3d1", // stone-300 — 11.57:1 на #1f1a17
  finyk: "#2dd4bf", // teal-400  — 9.26:1 на #1f1a17
  fizruk: "#22d3ee", // cyan-400  — 9.54:1 на #1f1a17
  routine: "#f68da4", // rose-400  — 7.60:1 на #1f1a17
  nutrition: "#b0e636", // lime-400  — 11.67:1 на #1f1a17
};
