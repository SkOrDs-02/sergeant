...
const preset = {
  ...
  //
  // AI-DANGER: перевірку прив'язано до порядку в білді. Якщо Tailwind
  ...
  plugins: [
    function semanticTypography({ addUtilities }) {
      addUtilities({
        ...
        //
        // Ім'я `overline` лишили навмисно: перейменування зачепило б 15
        // call-site-ів заради синоніма, а «overline» у типографіці — це
        // рядок НАД заголовком, не «великі літери». Капс у це ім'я вклали
        // ми самі.
        ".text-style-overline": {
          fontSize: "0.75rem",
          lineHeight: "1.4",
