  ...
  plugins: [
    function semanticTypography({ addUtilities }) {
      addUtilities({
        ...
        // AI-NOTE: −0.03em підбиралось під латиницю. Пропозиція знизити до
        // −0.012em під кирилицю чекає на рішення власника — мокап
        // `mockups/product/display-tracking.html`, обґрунтування в
        // `docs/05-design/design/anti-slop-strategy.md` § «Суміжне:
        // типографіка тексту». Не міняй значення без того рішення.
        ".text-style-display": {
