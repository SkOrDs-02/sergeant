...
/**
 * Фон сторінки світлої теми та поверхня «Чорнила».
 *
 * AI-DANGER: 2026-09-12 — `INK_SURFACE` тут був літералом `#1b1613` — тобто
 * ГЕЙТ рахував проти поверхні, якої `inkTheme` не оголошує з 2026-09-06
 * (коміт `2f0c49a` підняв її на щабель, літерал лишився).
 * Літерал у гейті не просто дублює значення, він переживає його зміну
 * мовчки: тест лишався зеленим, бо `#1b1613` темніший за фактичну поверхню,
 * а отже давав контраст ВИЩИЙ за справжній. Бери значення з токенів.
 */
const PAGE_BG = "#ecebe7";
const CARD_BG = "#ffffff";
const INK_SURFACE = inkTheme.surface.surface;
