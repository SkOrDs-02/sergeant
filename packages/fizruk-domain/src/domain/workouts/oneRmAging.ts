 ...
 * піка небезпечно; (2) після паузи вмикається **м'який режим** зі зниженими
 ...
 * при цьому звичайна відпустка на 2 тижні ще не вмикає м'який режим —
 ...
 *
 * Це закриває розрив E-5 з [ADR-0083](../../../../../docs/04-governance/adr/0083-injury-model.md):
...
/** Чому ввімкнено м'який режим. `null` — режим вимкнено. */
...
export interface OneRmAging {
  ...
  /** М'який режим: знижені орієнтири, порівняння з піком ховаємо. */
...
function daysSince(
  ...
  // від'ємна давність, інакше орієнтир «омолодився» б.
