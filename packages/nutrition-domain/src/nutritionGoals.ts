 ...
 * 4. **М'яко видалений період (`deletedAt`) невидимий.** Це ретракція
 ...
 * ціль двічі за вечір) розв'язуються по `createdAt` — виграє останній. За
 ...
 * небезпечніше — з'явилась би залежність від таймзони середовища рівно в
