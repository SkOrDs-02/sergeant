 ...
 * відповідає за кодування. Якщо колись з'явиться інший спосіб віддати файл
...
/**
 * Колонки секції — **об'єднання** ключів усіх рядків, у порядку першої
 * появи.
 *
 ...
 * необов'язкове поле, відсутнє в першому рядку, зникло б для всіх.
 */
