 ...
 * провали: кракозябри в Excel, з'їдені колонки, зламані клітинки з комою в
 * описі транзакції.
 */
...
describe("escapeCsvValue", () => {
  ...
  it("знешкоджує formula injection", () => {
    ...
    // Від'ємне ЧИСЛО при цьому лишається числом — інакше зіпсували б
...
describe("collectColumns", () => {
  it("бере ОБ'ЄДНАННЯ ключів усіх рядків, не лише першого", () => {
    // Найтихіший баг цього файлу: колонки з першого рядка. Необов'язкове
