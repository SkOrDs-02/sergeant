...
export interface paths {
    ...
    "/api/me/profile": {
        ...
        /** Профіль/біометрія користувача (write-through блоб) */
        get: {
            parameters: {
                query?: never;
                header?: never;
            ...
            requestBody?: never;
            responses: {
                /** @description Profile blob; { profile: {}, updatedAt: null } коли рядка ще немає. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
        ...
        /** Перезаписати профіль/біометрію (upsert по user_id) */
        put: {
            parameters: {
                query?: never;
                header?: never;
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["UserProfilePutBody"];
                };
            };
            responses: {
...
export interface components {
    schemas: {
        /** @description PUT /api/me/profile request body — write-through профіль/біометрія (migration 115, НЕ oplog-sync). */
        UserProfilePutBody: {
            profile: {
                [key: string]: unknown;
            };
        ...
        /** @description Відповідь GET/PUT /api/me/profile. `profile: {}` / `updatedAt: null` — дефолт, коли рядка ще немає. */
        UserProfileResponse: {
            profile: {
                [key: string]: unknown;
            };
