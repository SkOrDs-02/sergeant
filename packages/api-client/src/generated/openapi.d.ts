...
export interface paths {
  ...
  "/api/sync/push": {
    ...
    get?: never;
    put?: never;
    /** Push module-data (LWW; per-module) */
    post: {
      parameters: {
        query?: never;
        header?: never;
  ...
  "/api/sync/pull": {
    ...
    get?: never;
    put?: never;
    /** Pull module-data (LWW; per-module) */
    post: {
      parameters: {
        query?: never;
        header?: never;
  ...
  "/api/sync/pull-all": {
    ...
    /** Pull всіх модулів одразу (LWW resolved snapshot) */
    get: {
      parameters: {
        query?: never;
        header?: never;
    ...
    put?: never;
    /** Pull всіх модулів (POST варіант для клієнтів без GET-body) */
    post: {
      parameters: {
        query?: never;
        header?: never;
  ...
  "/api/sync/push-all": {
    ...
    get?: never;
    put?: never;
    /** Bulk push модулів за один request */
    post: {
      parameters: {
        query?: never;
        header?: never;
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["SyncPushAll"];
        };
      };
      responses: {
        /** @description OK */
...
export interface components {
  schemas: {
    ...
    SyncPush: {
      /** @enum {string} */
      module: "finyk" | "fizruk" | "routine" | "nutrition" | "profile";
      data: unknown;
