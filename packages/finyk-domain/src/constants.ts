...
export const MCC_CATEGORIES = [
  ...
  {
    // 4829 (card-to-card / переказ коштів) додано 2026-09-11 — саме цим
    // кодом Monobank стамплює переказ на кредитну картку іншого банку, і
    // без нього щомісячне погашення не потрапляло в жодну mcc-групу і
    // падало в «Інше» (звіт власника про непорахований борг). Ціна: 4829
    // несуть і p2p-перекази друзям — такі рядки тепер теж стартують як
    // «Борги та кредити», доки людина не перекатегоризує; підказка
    // внутрішнього переказу (`transferMatching`) на них і далі працює.
    // 6010/6011 (готівка в касі/банкоматі) СВІДОМО не тут: зняття готівки
    // — не борг, а майбутній міст до «Готівки на руках» (ADR-0076).
    id: "debt",
    label: "Борги та кредити",
    mccs: [4829, 6012, 6051, 6099],
    keywords: [
      "погашення",
      "кредит",
      "позика",
