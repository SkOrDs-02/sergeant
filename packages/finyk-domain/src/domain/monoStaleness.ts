 ...
 * «витрат не було» і «зв'язок обірвався» виглядають однаково, бо
 ...
 * «зв'язок обірвався» було б вигадкою, а мовчати — тією самою тихою
...
export interface MonoStalenessInput {
  ...
  /**
   * Чи вважається з'єднання активним (`status === 'active'` і webhook
   * зареєстрований). Для неактивного з'єднання staleness не рахуємо:
...
export interface MonoStalenessResult {
   ...
   * чого (немає активного з'єднання, немає жодної події, або дата
   * непарситься).
   */
