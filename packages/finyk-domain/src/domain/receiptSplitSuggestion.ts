...
const NAME_KEYWORD_MAP: ReadonlyArray<readonly [RegExp, string]> = [
  [
    /(цигарк|сигарет|тютюн|цигар|стіки?\s|iqos|heets?|(?<!\p{L})(glo|veev|lyft)(?!\p{L})|снюс)/iu,
    "smoking",
  ],
  [
    ...
    /(алкогол|(?<!\p{L})(вино|вина|пиво|пива|джин|ром|сидр|бренді|вермут)(?!\p{L})|ігрист|шампанськ|віскі|коньяк|горілк|лікер|текіл|наливк|настоянк)/iu,
    "alcohol",
  ],
  [
