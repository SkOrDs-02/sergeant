...
describe("evaluateMonoStaleness", () => {
  ...
  it("не рахує staleness для неактивного з'єднання", () => {
    // У відключеного/невалідного з'єднання вже є власна, точніша
  ...
  it("клемпить майбутній lastEventAt у 0, а не у від'ємні дні", () => {
