...
> **Last validated:** 2026-05-04 by @Skords-01 (S1.3 + S1.4 + S1.5 + S2.4 + S3.4 виконані). **Next review:** 2026-08-01.
> **Status:** Active
...
- **S3.1 / S3.2 / S3.3a/b / S3.5** — наступні кандидати (S3.5 особливо — single-hero rule strengthening, без deps).
