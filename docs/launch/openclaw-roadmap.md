...
> **Last validated:** 2026-05-02 by @sonher468. **Next review:** 2026-08-01.
> **Status:** Active
...
```
       ...
       Console ───→  │ apps/console (Telegram entrypoint) │ ✅ Bot framework
       ...
       Policy ────→  │ ADR-0027 OpenClaw MCP policy     │ ✅
                     ...
                     │   ТРЕБА ЗРОБИТИ (40%)            │
                     ├──────────────────────────────────┤
       1. Webhook handler у apps/console для
...
- Новий Telegram bot service у `apps/console`:
...
| Bot service   | `apps/console` (розширити існуючий entry, додати другий webhook)                           | Уже є для `@Sergeant_alert_bot`; додати другий handler з різними системними prompt-ами і tool-set-ами |
...
новим webhook handler у `apps/console`, Railway env додатками. Все за §3.1.
