...
| [M18](./M18-openclaw-per-call-usd-cap.md)      | OpenClaw daily $5 budget without per-call cap        | Medium   | console  | 0.1 d _(closed 2026-05-04 — PR [#1760](https://github.com/Skords-01/Sergeant/pull/1760); pre-flight cost estimator + guard in `apps/console/src/openclaw/policy.ts`; metric `openclaw.per_call_cap_hit_total` wired)_                                        |
