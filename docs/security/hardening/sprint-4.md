...
| [I6](./I6-threat-model.md)                 | Document the STRIDE threat model per module          | Info     | platform | 1 d _(closed 2026-05-06 — `docs/security/threat-model.md` shipped with per-module STRIDE tables + cross-cutting controls; linked from `docs/security/README.md`)_                                                                         |
