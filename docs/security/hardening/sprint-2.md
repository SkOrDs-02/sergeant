...
> **Status:** Active (H5, H7, H8, H9 closed 2026-05-04 — `exp://` gate + Vercel SSOT + per-route CORP override + transcribe USD cap shipped alongside Sprint 1 H2 closure; H9 closed partial — per-user USD cap enforced inline, S3 pre-signed upload deferred).
