...
| Файл                                        | Інваріант                                                                                                                                                                                                                                                                      |
| ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `FinykApp.tsx`                              | `?sync=` у URL: **одноразово** при mount — `storage`/`toast` не повинні перезапускати імпорт. Другий effect: при `pwaAction === add_expense` — `navigate` вважається стабільним з `useFinykRoute()` (react-router-driven, initiative 0006 Phase 2.b); не додаємо всі setter-и. |
