...
| C2     | [`c2-containers.md`](./c2-containers.md)           | Деплоймент-топологія: `apps/web` (Vercel), `apps/server` (Railway, Express + BullMQ in-process), `apps/console` (Telegram bot), `apps/mobile` / `apps/mobile-shell`, Postgres/Redis/n8n/Sentry. |
