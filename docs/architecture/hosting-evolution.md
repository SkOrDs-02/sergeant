...
- [`docs/launch/business/03-services-and-toolstack.md`](../launch/business/03-services-and-toolstack.md) — повний каталог сервісів з цінами.
...
7. **Локальний n8n / OpenClaw** — якщо [docs/launch/business/05-operations-and-automation.md](../launch/business/05-operations-and-automation.md) реально запускається і n8n cloud починає кусатись.
...
- **Stripe** — платежі. Див. [`docs/launch/business/06-monetization-architecture.md`](../launch/business/06-monetization-architecture.md).
...
- Повний каталог сервісів + ціни: [`docs/launch/business/03-services-and-toolstack.md`](../launch/business/03-services-and-toolstack.md).
- Monthly cost projection по фазах: [`03 §9`](../launch/business/03-services-and-toolstack.md#9-повна-monthly-cost-projection).
- Pre-launch чеклист (де observability — requirement): [`docs/launch/business/04-launch-readiness.md#3-моніторинг-та-алерти`](../launch/business/04-launch-readiness.md#3-моніторинг-та-алерти).
