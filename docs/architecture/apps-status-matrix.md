...
| ------------------------ | ------------------- | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@sergeant/web`          | `apps/web`          | `active`    | React 18 + Vite PWA — канонічна продакшн-апка (Vercel статика + Railway `/api`). Sync v2 (SQLite-WASM + outbox), billing/pricing UI, observability pageview tracking.                                                                          | [`docs/architecture/platforms.md` §1](platforms.md), [`docs/architecture/frontend-overview.md`](frontend-overview.md), [`docs/tech-debt/frontend.md`](../tech-debt/frontend.md)         |
| `@sergeant/server`       | `apps/server`       | `active`    | Node 20 / TypeScript / Express `/api/v1/*` + `/api/v2/*`, Better Auth, Postgres, Anthropic tool-use. Нові surfaces: billing (Stripe), transcribe (Whisper), waitlist, openclaw (GitHub App), alerts, observability, topic-archive.             | [`docs/architecture/api-v1.md`](api-v1.md), [`docs/tech-debt/backend.md`](../tech-debt/backend.md), [`AGENTS.md`](../../AGENTS.md)                                                      |
