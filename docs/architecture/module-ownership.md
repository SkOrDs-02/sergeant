...
| `apps/server/src/migrations/**`        | `@Skords-01` | TBD (data-engineer)     | n/a                                     | n/a                                              | Sequential `NNN_*.sql` (currently 001–069). No gaps. Two-phase for DROP — see [Rule #4](../governance/rules/04-sql-migrations-sequential-two-phase.md).         |
