...
| `apps/server/src/modules/chat/**`      | `@Skords-01` | TBD (backend-engineer)  | Vitest                                  | n/a                                   | Anthropic tool defs split per domain in `toolDefs/`. See [`ai-tool-execution-path.md`](./ai-tool-execution-path.md) below.                                      |
