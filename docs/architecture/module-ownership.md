...
| `apps/server/src/migrations/**`        | `@Skords-01` | TBD (data-engineer)     | n/a                                     | n/a                                              | Sequential `NNN_*.sql` (currently 001–074). No gaps. Two-phase for DROP — see [Rule #4](../governance/rules/04-sql-migrations-sequential-two-phase.md).         |
...
| `packages/eslint-plugin-sergeant-design/**`           | `@Skords-01` | TBD (frontend-engineer) | Vitest     | n/a             | Custom ESLint rules enforcing the design system (opacity scale, `-strong` companion fills, etc.).                                                                      |
