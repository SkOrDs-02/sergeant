...
| File                                                                                                                               | Role                                                                                                         |
| ---------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| [`apps/server/src/migrations/063_ai_memory_backfill_state.sql`](../../apps/server/src/migrations/063_ai_memory_backfill_state.sql) | `ai_memory_backfill_state` — resumable state ledger (один row per run).                                      |
