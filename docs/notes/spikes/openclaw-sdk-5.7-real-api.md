...
> **Last validated:** 2026-05-12 by Devin. **Next review:** після Stage 4a hook implementation (живий smoke на Gateway).
> **Status:** Active
...
| --- | --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Hook API                                            | `api.registerHook(events: string \| string[], handler, opts?)` — реальний канонічний enum з **34 hook-ів** (`PluginHookName` у `plugin-sdk/src/plugins/hook-types.d.ts`). Найкорисніші для нас: `before_dispatch` (Stage 4b Layer 0), `llm_input`, `llm_output`, `before_agent_finalize`, `agent_end`, `before_tool_call`, `after_tool_call`, `tool_result_persist`, `session_start`, `session_end`, `heartbeat_prompt_contribution`. **`before_agent_start` позначений `@deprecated`** у real SDK (`hook-types.d.ts:566` JSDoc + `hook-before-agent-start.types.d.ts`) — used as Stage 4a audit-open hook **тимчасово**, з відомою TODO-міграцією.                                                                                                                                                                                                                                                                                                                                                                                                                       | Stage 4a (budget+audit) поки використовує `llm_input` (per-call gate) + `agent_end` (finalize) + `before_agent_start` (open invocation — needs follow-up: real event shape є `{ prompt, runId?, messages? }`, не `userMessage`, тому реальні `userMessage`-reads повертають `undefined`; міграція на `session_start` або `agent_turn_prepare` у окремому PR). **Stage 4b shortcut router живе на `before_dispatch`, не `before_agent_start`** — див. рядок 5 нижче для канонічного контракту.                                                                                                                                                                                                                                                                                                                                                                                                                             |
