...
| --- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Hook API              | `api.registerHook(events: string \| string[], handler, opts?)` — реальний канонічний enum з **34 hook-ів** (`PluginHookName` у `plugin-sdk/src/plugins/hook-types.d.ts`). Найкорисніші для нас: `llm_input`, `llm_output`, `before_agent_finalize`, `agent_end`, `before_tool_call`, `after_tool_call`, `tool_result_persist`, `session_start`, `session_end`, `heartbeat_prompt_contribution`.                                                                        | Stage 4a (budget+audit) має використовувати `llm_input` (per-call gate) + `agent_end` (finalize) — без вигадування назв. Stage 4b shortcut-router lives in `before_agent_start`.                                                                                                                                                                                                                                                             |
