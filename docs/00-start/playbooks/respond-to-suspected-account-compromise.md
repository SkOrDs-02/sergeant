...
> **Superseded by:** [access-governance.md § Suspected account compromise](./access-governance.md#4-suspected-account-compromise) — merged 2026-05-04 (initiative [0009](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/_0009-agent-os-hardening.md) PR 2.4).
