...
> **Last validated:** 2026-07-10 by @devin-ai. **Next review:** 2026-10-08.
> **Status:** Active
...
| [`sync-rn-migration-progress.md`](./sync-rn-migration-progress.md) | Sync RN Migration Progress | після merge порту web → mobile (див. `port-web-screen-to-mobile.md`) — оновити progress tracker `docs/02-engineering/mobile/react-native-migration.md`. |
