...
> **Last touched:** 2026-08-16 by @github-actions[bot]. **Next review:** 2026-12-07.
> **Status:** Active
...
Якщо endpoint змінює product behavior, занотуй короткий spec у `docs/05-design/design/specs/` або в PR description.
