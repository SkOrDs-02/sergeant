...
> **Last touched:** 2026-09-01 by @Skords-01. **Next review:** 2026-12-11.
> **Status:** Active
...
Якщо endpoint змінює product behavior, занотуй короткий spec у `docs/90-work/planning/specs/` або в PR description.
