...
> **Last touched:** 2026-08-07 by @github-actions[bot]. **Next review:** 2026-11-05.
> **Status:** Active
...
| PR                                                     | Title                                                                      | Merged     |
| ------------------------------------------------------ | -------------------------------------------------------------------------- | ---------- |
| [#708](https://github.com/Skords-01/Sergeant/pull/708) | docs(server): виправити коментарі, які стверджують, що Redis у проді немає | 2026-08-07 |
