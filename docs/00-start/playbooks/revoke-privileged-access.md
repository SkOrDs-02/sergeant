...
> **Superseded by:** [access-governance.md § Revoke privileged access](./access-governance.md#2-revoke-privileged-access) — merged 2026-05-04 (initiative [0009](../../90-work/initiatives/archive/_0009-agent-os-hardening.md) PR 2.4).
