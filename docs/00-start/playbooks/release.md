...
> **Last touched:** 2026-06-26 by @github-actions[bot]. **Next review:** 2026-09-24.
> **Status:** Active
...
| PR                                                   | Title                                                       | Merged     |
| ---------------------------------------------------- | ----------------------------------------------------------- | ---------- |
| [#10](https://github.com/Skords-01/Sergeant/pull/10) | docs: актуалізувати 01-product + 05-design + 02-engineering | 2026-06-26 |
