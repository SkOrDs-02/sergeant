...
> **Last touched:** 2026-08-16 by @github-actions[bot]. **Next review:** 2026-11-27.
> **Status:** Active
...
- [`docs/00-start/agents/agent-workflows.md`](../agents/agent-workflows.md) §12 — parallel fan-out layer.
