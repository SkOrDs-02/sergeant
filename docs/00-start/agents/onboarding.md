...
| `sergeant-design/no-hex-in-classname` (дизайн-конвенція)      | `AGENTS.md` § [Design conventions](../../../AGENTS.md#design-conventions) — правило ESLint-only ([ADR-0081](../../04-governance/adr/0081-repository-simplification.md)): ESLint plugin: [`packages/eslint-plugin-sergeant-design/`](../../../packages/eslint-plugin-sergeant-design). |
| `sergeant-design/no-foreign-module-accent` (дизайн-конвенція) | Те саме. Cross-module surface (`core/`, `shared/`) — exempt.                                                                                                                                                                                                                          |
| `sergeant-design/no-raw-palette-dark-pair` (дизайн-конвенція) | Те саме. Lift у design-tokens layer (`bg-success-soft`, `text-brand-strong`).                                                                                                                                                                                                         |
| `sergeant-design/prefer-focus-visible` (дизайн-конвенція)     | Те саме. `focus:` → `focus-visible:` всюди, крім `focus:outline-none`.                                                                                                                                                                                                                |
