...
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-28 | Deprecated-вказівник `sergeant-hubchat` видаляємо цілком (тека + lock-entry + graph-вузол + 4 eval-кейси) після 2026-10-28 або раніше, щойно зникнуть зовнішні посилання на скіл                                 | agent-OS           | [спека agent-module-owners, рішення 4](../../90-work/planning/specs/agent-module-owners.md)                                                                                                                                                                       |
| 2026-08-28 | Модульний шар агентного OS: module-owner скіли (продуктовий контекст × surface-скіл), журнал рішень у каноні модуля, `sergeant-hubchat` поглинуто `sergeant-module-ai`                                           | agent-OS / product | [спека agent-module-owners](../../90-work/planning/specs/agent-module-owners.md)                                                                                                                                                                                  |
