...
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-06-29 | Web-first до traction: native mobile, Expo-shell і Capacitor-shell не тягнемо в launch-readiness; повертаємось до них після стабільного web і реальних користувачів | product / launch   | maintainer decision; testing loop: [`production-readiness-testing-loop.md`](../../90-work/audits/archive/production-readiness-testing-loop.md)                                 |
