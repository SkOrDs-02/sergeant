...
| **Runbook**    | `docs/03-operations/runbooks/` | Інцидент / DR-вправа      | _Як саме_ на нашому стеку (Railway, pgBouncer, key-ring) |
| **Deploy-doc** | `docs/03-operations/deploy/`   | Конфігурація платформи    | Довідник по Railway / Vercel-налаштуваннях               |
