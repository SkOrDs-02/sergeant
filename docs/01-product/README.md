...
> **Last touched:** 2026-07-22 by @Skords-01. **Next review:** 2027-01-18.
> **Status:** Active

Продуктовий шар: tone-of-voice, маркетинг, go-to-market і release-нотатки.
Жанр — **informational**, окрім `launch/` (активний tracker).

| Розділ                                | Що тут                                                                          |
| ------------------------------------- | ------------------------------------------------------------------------------- |
| [`copy/`](./copy/README.md)           | UA-copy tone-of-voice — еталон для кожного кирилічного JSX-літерала.            |
| [`launch/`](./launch/README.md)       | **Tracker.** GTM, монетизація, ops і product-OS роадмапи (FTUX master tracker). |
| [`model/`](./model/finyk.md)          | Продуктові канони модулів: для кого, що обіцяємо, чого свідомо не робимо.       |
