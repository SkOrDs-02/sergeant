...
1. **Створи markdown** `docs/01-product/whats-new/YYYY-MM-DD-<slug>.md` за шаблоном
...
3. **Запусти tests** — `releases.test.ts` валідовує:
   ...
   - markdown-файл `docs/01-product/whats-new/{id}.md` існує (drift gate),
