...
> **Last validated:** 2026-07-06 by @claude. **Next review:** 2026-10-04.
...
> лише *звідки* приходять перші 20-50 тестерів. Готовий до copy-paste контент нижче.
...
- [ ] **Lighthouse CI gate live** — T5 з [`sprint-roadmap-q2q3-2026.md`](../../../90-work/planning/sprint-roadmap-q2q3-2026.md) — якщо ще ні, manual run щотижня.
