...
> [05-operations-and-automation.md](../../business/05-operations-and-automation.md) (Telegram як control-room),
...
> [ADR-0036](../../../../04-governance/adr/0036-openclaw-write-tools-with-approval.md) (write-tools approval),
> [ADR-0037](../../../../04-governance/adr/0037-openclaw-write-audit-persistence.md) (write-audit persistence).
...
- Боти **не діляться** функціоналом (per [ADR-0031 §НЕ робимо](../../../../04-governance/adr/0031-openclaw-v0-telegram-cofounder.md)).
...
- W3 PR-1 — [#1473](https://github.com/Skords-01/Sergeant/pull/1473) — [ADR-0038](../../../../04-governance/adr/0038-tg-alert-acks-and-escalation.md) + `tg_alert_acks` table + 4 internal endpoint-и (`/post`/`/ack`/`/pending`/`/escalate`) + 26 unit/route tests.
...
**Pain закриває:** P2.
**ADR:** [ADR-0038](../../../../04-governance/adr/0038-tg-alert-acks-and-escalation.md) ("Alert acknowledgement + escalation").
...
**Pain закриває:** P4.
**ADR:** [ADR-0041 — OpenClaw Telegram delivery via webhook](../../../../04-governance/adr/0041-openclaw-telegram-webhook.md) §5 (production rollout) + race-condition note.
...
- **OpenClaw в group chats.** DM-only — фіксація per [ADR-0031](../../../../04-governance/adr/0031-openclaw-v0-telegram-cofounder.md) і [openclaw-roadmap.md §1](./openclaw-roadmap.md). Co-founder режим — приватний.
- **HubChat ↔ OpenClaw інтеграція.** [ADR-0032](../../../../04-governance/adr/0032-console-consolidated-into-openclaw.md) фіксує: HubChat = end-user surface; OpenClaw = founder DM. Spillover — anti-pattern.
...
- [ADR-0031 — OpenClaw v0 Telegram co-founder](../../../../04-governance/adr/0031-openclaw-v0-telegram-cofounder.md)
- [ADR-0032 — Console consolidated into OpenClaw](../../../../04-governance/adr/0032-console-consolidated-into-openclaw.md)
- [ADR-0033 — OpenClaw multi-personas + council](../../../../04-governance/adr/0033-openclaw-multi-personas-and-council.md)
- [ADR-0036 — OpenClaw write-tools with approval](../../../../04-governance/adr/0036-openclaw-write-tools-with-approval.md)
- [ADR-0037 — OpenClaw write-audit persistence](../../../../04-governance/adr/0037-openclaw-write-audit-persistence.md)
- [openclaw-roadmap.md — phase plan](./openclaw-roadmap.md)
- [05-operations-and-automation.md §6.2](../../business/05-operations-and-automation.md) — Telegram як control-room
