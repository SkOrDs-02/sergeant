...
| Cards          | [H6](../../04-governance/security/hardening/archive/H6-email-verification.md), [I8](../../04-governance/security/hardening/archive/I8-periodic-external-pentest.md) (engagement preparation)      |
...
[H6](../../04-governance/security/hardening/archive/H6-email-verification.md) було закрито 2026-05-04 у статусі `Closed (partial)`:
...
Атака, від якої захищаємось — той же scenario, що й H6 ([H6 § Impact](../../04-governance/security/hardening/archive/H6-email-verification.md#impact)):
...
- **External pen-test engagement (I8).** Sweep — internal hardening, не engagement з зовнішнім pen-tester-ом. Engagement має власний tracker у [`docs/04-governance/security/hardening/I8-periodic-external-pentest.md`](../../04-governance/security/hardening/archive/I8-periodic-external-pentest.md).

## Cross-references

- H6 card: [`docs/04-governance/security/hardening/H6-email-verification.md`](../../04-governance/security/hardening/archive/H6-email-verification.md)
