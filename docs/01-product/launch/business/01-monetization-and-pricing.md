...
> **Superseded 2026-08-08 → [07 — Юніт-економіка](./07-unit-economics.md).** Чинний
> розрахунок живе там і генерується з `scripts/economics/assumptions.json`. Цей
> розділ лишається як історія вимірів вартості AI (§ 9.5–9.6 — досі найповніший
> опис того, звідки взялась ціна префікса). Що в ньому більше не діє: беззбитковість
> «~17 підписників» (не враховує ЄСВ ₴1 902/міс і вартість Free-трафіку), «AI API
> marginal cost ≈ ₴5/міс», LTV:CAC 20:1–150:1 (порахований на виручці, не на маржі),
> і висновок «Pro під водою в 6–20 разів» (знятий переходом чату на OpenRouter).
>
