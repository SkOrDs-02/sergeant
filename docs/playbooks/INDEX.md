...
> **Last validated:** 2026-05-12 by @devin-ai. **Next review:** 2026-08-10.
> **Status:** Active
...
| [`cutover-openclaw-gateway.md`](./cutover-openclaw-gateway.md) | Cutover OpenClaw на зовнішній Gateway (Stage 7) | Stage 6b parallel-run завершений, founder підтвердив паритет Gateway з grammy-ботом. Готовність до перемикання production-трафіку з `@OpenClaw_sergeant_bot` (grammy) на `@kOPENCLAW_GATEWAY_BOT` (OpenClaw Gateway). |
