...
- Coupled surface: `.agents/skills-lock.json`, `docs/agents/agent-skills-catalog.md`, `.agents/skills/sergeant-start-here/SKILL.md`
...
- Мінімум один лінк на playbook у `docs/playbooks/` або на `docs/agents/agent-skills-catalog.md`.
...
Якщо додав **новий** skill — додай рядок у таблицю Active Skills у `docs/agents/agent-skills-catalog.md` і, якщо це новий routing-сценарій, у роутинг-таблицю `.agents/skills/sergeant-start-here/SKILL.md`. Без оновленого lock-у CI (`skill-freshness.yml`) падає з посиланням на `pnpm skills:lock`.
...
- [docs/agents/agent-skills-catalog.md](../agents/agent-skills-catalog.md) — додай рядок у Active Skills
