...
- Так (`sameSite`, домен куки, проксі `/api/*`, `ALLOWED_ORIGINS`) → перечитай [`docs/integrations/railway-vercel.md`](../../integrations/railway-vercel.md) **до** правки; це частина auth-контракту.
...
- [docs/integrations/railway-vercel.md](../../integrations/railway-vercel.md) — cross-site cookie контракт
