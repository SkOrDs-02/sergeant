...
> **Не ініціатива в `docs/work/specs/initiatives/`** через [audit-freeze 2026-05-05 → 2026-06-02](https://github.com/SkOrDs-02/sergeant/blob/4da4557c5cadb298f889fbea3d7457f71bd223ee/docs/04-governance/governance/audit-freeze-2026-05-05.md). Якщо post-freeze команда вирішить підняти це в формальну initiative-у з owner-ом і ETA — створити `docs/work/specs/initiatives/00NN-skills-evolution.md` і перенести скоуп туди; цей файл тоді стає секцією `## Sources` в новій initiative-і. До того часу — це **discovery roadmap**, не зобов'язання.
...
- Опційно: розширити `pnpm lint:skills` гейтом `description.length >= 200`. Якщо так — зафіксувати ескалацію severity у [`hard-rules.json`](../../governance/governance/hard-rules.json) як sub-clause до Rule #10 (lifecycle markers) або як новий "skill description quality" rule (нова active-initiative; не blocker до runs of evals у PR 7).
...
- [`docs/governance/governance/rules/04-sql-migrations-sequential-two-phase.md`](../../governance/governance/rules/04-sql-migrations-sequential-two-phase.md) — наш супутній hard-rule.
...
- `.agents/skills-lock.json`.
- `docs/start/agents/agent-skills-catalog.md` (новий рядок).
...
- Розділ "Skill body security" додано в [`docs/governance/governance/rules/`](../../governance/governance/rules) — або як sub-clause до Rule #10, або як нова Rule #22 (`active-initiative`, deadline 2026-Q3).
...
- `docs/governance/governance/hard-rules.json` (якщо нова rule).
- `docs/governance/governance/hard-rules-matrix.md` (regenerated).
- `docs/governance/governance/rules/22-skill-body-security-scan.md` (опційно).
...
- Існуючий `docs/governance/governance/rules/07-pre-commit-hooks-via-husky.md` — формат hard-rule файлу.
...
- Додати секцію "Reference files convention" у `docs/start/agents/agent-skills-catalog.md` (або винести в окремий `docs/start/agents/skill-authoring-guide.md`).
...
- Документ у `docs/start/agents/` із прикладом (адаптована sample-сторінка зі stop-skip locked).
...
- `docs/start/agents/skill-authoring-guide.md` АБО розширення `docs/start/agents/agent-skills-catalog.md`.
- `scripts/lint-skills.mjs`.
- `docs/start/agents/README.md` (додати рядок у table).
...
- Документ у `docs/start/agents/skill-authoring-guide.md` (PR 6) розширено інструкцією про evals.
...
- Один рядок у `docs/start/agents/onboarding.md` § "Перед PR" — те саме посилання.
...
- `docs/start/agents/onboarding.md`.
...
- `.agents/skills/sergeant-start-here/SKILL.md` (routing-таблиця).
- `.agents/skills-lock.json`.
- `docs/start/agents/agent-skills-catalog.md`.
...
Цей документ — discovery roadmap, не active initiative. PR-и можна брати в довільному порядку (з урахуванням dependencies в матриці вище). Якщо post-freeze (≥ 2026-06-02) команда вирішить підняти це у формальну initiative-у з owner-ом і ETA — створити `docs/work/specs/initiatives/00NN-skills-evolution.md` і перенести скоуп з цього файлу. До того часу:
...
- [`docs/start/agents/README.md`](./README.md) — індекс agent-OS docs.
- [`docs/start/agents/agent-skills-catalog.md`](./agent-skills-catalog.md) — поточна skill-routing таблиця.
- [`docs/work/specs/initiatives/archive/_0009-agent-os-hardening.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/_0009-agent-os-hardening.md) — попередня agent-OS initiative-а (closed 2026-05-05).
