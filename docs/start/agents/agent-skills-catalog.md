...
Повторні продуктові перевірки використовують [комплекти верифікації](../../engineering/testing/verification/README.md): каталог сценаріїв, профілі акаунтів і журнал прогонів. Це спільні артефакти для owner-, E2E-, QA- та review-агентів. Перед новим прогоном прочитай попередній handoff; статуси знахідок оновлюй у [реєстрі](../../work/specs/audits/verification/README.md), не у паралельному списку старого аудиту.
