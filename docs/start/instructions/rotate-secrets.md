...
> **Last touched:** 2026-09-11 by @claude. **Next review:** 2026-11-24.
> **Status:** Active
> **Runtime-specific:** no
...
- Створити `docs/operations/postmortems/YYYY-MM-DD-secret-rotation.md`
...
- [ADR-0074](../../governance/adr/0074-hosting-hetzner-coolify.md) — хостинг-топологія (Hetzner/Coolify); повний інвентар env-змінних — `apps/server/src/env/env.ts`
