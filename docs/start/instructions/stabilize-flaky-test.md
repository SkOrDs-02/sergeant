...
- Coupled surface: `.github/workflows/mobile-flaky-verify.yml` (20-run verification — єдиний наявний flaky-воркфлоу; `flaky-tests-dashboard.yml` прибрано [ADR-0082](../../governance/adr/0082-private-storage-repo-posture.md) §4), список карантину — у секції § «Pre-existing flaky tests» цього ж playbook-а
