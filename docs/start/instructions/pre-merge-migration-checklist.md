...
> **Last touched:** 2026-09-11 by @claude. **Next review:** 2026-11-17.
> **Status:** Active
> **Runtime-specific:** no
...
````markdown
## Pre-merge migration checklist (docs/start/instructions/pre-merge-migration-checklist.md)
...
- [ ] У `docs/work/specs/tech-debt/backend.md` оновлено секцію "Database & migrations" якщо міграція змінює invariant-и (індекси, foreign keys, нові таблиці-домени).
...
- [`docs/work/specs/tech-debt/backend.md`](../../work/specs/tech-debt/backend.md) — Database & migrations review.
```
