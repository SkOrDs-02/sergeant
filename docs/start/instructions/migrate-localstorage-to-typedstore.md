...
- **`createTypedStore`** (`apps/web/src/shared/lib/storage/typedStore.ts`) — основна, типобезпечна, sync across tabs.
...
- [frontend-tech-debt.md](../../work/specs/tech-debt/frontend.md) — §2 Прямі localStorage виклики
