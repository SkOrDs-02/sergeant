...
- Перегляньте [engineering-metrics.md](../../operations/observability/engineering-metrics.md), [feature-flags.md](../../governance/governance/feature-flags.md) і [review-checklist.md](../../governance/governance/review-checklist.md).
...
- джерело: вкладка Actions репозиторію + [`docs/governance/pr-ledger/index.json`](../../governance/pr-ledger/index.json) (мердж-історія, оновлюється Hard Rule #26 при кожному PR, що чіпає canonical docs).
