...
- Перечитати [incident-severity-policy.md](../../governance/governance/incident-severity-policy.md) і [service-catalog.md](../../engineering/architecture/service-catalog.md).
