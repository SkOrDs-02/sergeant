...
cat docs/engineering/architecture/apps-web-exhaustive-deps.md
```
...
Оновити `docs/engineering/architecture/apps-web-exhaustive-deps.md` — видалити або позначити виправлені файли.
...
- [ ] `docs/engineering/architecture/apps-web-exhaustive-deps.md` оновлено
...
- [apps-web-exhaustive-deps.md](../../engineering/architecture/apps-web-exhaustive-deps.md) — повний список warnings
- [frontend-tech-debt.md](../../work/specs/tech-debt/frontend.md) — загальний фронтенд tech debt
