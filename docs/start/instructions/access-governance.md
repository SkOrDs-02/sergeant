...
- Перевір [access-policy.md](../../governance/security/access-policy.md), [access-matrix.md](../../governance/security/access-matrix.md) і [secret-ownership-register.md](../../governance/security/secret-ownership-register.md).
- Для подій компрометації додатково перевір [security-incident-policy.md](../../governance/governance/security-incident-policy.md) і тримай напохваті [rotate-secrets.md](./rotate-secrets.md).
...
- Оціни severity згідно з [security-incident-policy.md](../../governance/governance/security-incident-policy.md).
