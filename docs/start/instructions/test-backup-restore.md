...
- Прочитай [disaster-recovery.md](../../governance/security/disaster-recovery.md) і [service-catalog.md](../../engineering/architecture/service-catalog.md), щоб мати свіжі цифри RPO/RTO та перелік критичних поверхонь.
...
- Розгорни бекап у безпечне середовище за конкретними командами з [`docs/start/instructions/database-backup-restore.md`](./database-backup-restore.md) §2.
