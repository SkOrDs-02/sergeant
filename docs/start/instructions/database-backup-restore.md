...
- Secrets (Better Auth, Mono, Stripe…) — окремий шлях через
  [`rotate-secrets.md`](./rotate-secrets.md) і
  [`docs/start/instructions/encryption-key-rotation.md`](./encryption-key-rotation.md).
...
[`disaster-recovery.md`](../../governance/security/disaster-recovery.md)). Файли **never**
...
> [`restore-from-backup.md`](./restore-from-backup.md) — зупини
...
1. `pg_dump` напряму з публічного Coolify-Postgres URL (secret `MIGRATE_DATABASE_URL` — окремий GH Actions secret, той самий connection string, що Coolify використовує внутрішньо для pre-deploy міграцій per [ADR-0074](../../governance/adr/0074-hosting-hetzner-coolify.md); секрет опційний — без нього job graceful-skip-ає у migration-only verify без production-даних).
...
[`test-backup-restore.md`](./test-backup-restore.md); the weekly CI
...
- Process flow: [`restore-from-backup.md`](./restore-from-backup.md), [`test-backup-restore.md`](./test-backup-restore.md)
- RPO / RTO: [`disaster-recovery.md`](../../governance/security/disaster-recovery.md)
- Migration conventions: [`docs/governance/adr/0013-db-migrations-conventions.md`](../../governance/adr/0013-db-migrations-conventions.md)
