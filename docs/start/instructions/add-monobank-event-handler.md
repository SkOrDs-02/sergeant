...
- Оновити `docs/engineering/integrations/monobank-roadmap.md` якщо нова подія змінює архітектурну діаграму.
- Оновити `docs/engineering/integrations/monobank-roadmap.md` якщо подія була у плані.
...
- [monobank-roadmap.md](../../engineering/integrations/monobank-roadmap.md) — план покращень Monobank-інтеграції
- [monobank-roadmap.md](../../engineering/integrations/monobank-roadmap.md) — архітектура Monobank-інтеграції та roadmap
