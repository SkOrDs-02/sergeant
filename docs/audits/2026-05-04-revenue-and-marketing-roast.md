...
- **`apps/console` → `tools/console/`** як ankle-PR (одна година, поза фазами 1–6).
...
8. **`tools/console` як окремий застосунок.** Internal tool, не «app». Перенести в `tools/console/` або в окремий repo.
