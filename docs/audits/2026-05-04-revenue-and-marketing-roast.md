...
`docs/audits/2026-05-03-ftux-onboarding-roast.md` + `docs/launch/product-os/ftux-sprint-plan.md` — це **єдиний документ у репо, який пише жорстко про продукт**. 90% згоди. Що залишається болючим:
