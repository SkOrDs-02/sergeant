...
| [`2026-05-13-security-observability-roast.md`](./2026-05-13-security-observability-roast.md)       | Security & observability roast — CSP, secrets, Sentry/OTel/web-vitals, audit logs                                              | Active | 2/9              | 7             | embedded §Прогрес-виконання + §P0/P1/P2                                                                      |
