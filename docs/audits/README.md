...
> **Last validated:** 2026-05-13 by Devin (P1-4 cleanup — архівовано `2026-04-28-implementation-roadmap.md` + `2026-04-28-ux-improvement-plan.md` у `archive/` за [`2026-05-13-ftux-onboarding-roast.md`](./2026-05-13-ftux-onboarding-roast.md) § P1-4; P2-D `useSyncStatus` polling closed: counter on `2026-05-13-web-architecture-state-roast.md` raised to 6/6; previous: re-sync `2026-05-03-readme-gap-analysis.md` row `0/8 ≈ / 8 ≈` → `13/15 ≈ / 2` per [`2026-05-13-documentation-hygiene-roast.md`](./2026-05-13-documentation-hygiene-roast.md) § P1-1; додано рядок для `2026-05-13-mobile-reliability-ux-roast.md`; Status-row sync з file headers: `2026-05-04-csp-disable-retrospective` → Closed (A1–A5 resolved 2026-05-06)). **Next review:** 2026-08-11.
...
| [`2026-05-13-web-architecture-state-roast.md`](./2026-05-13-web-architecture-state-roast.md)       | Roast #3/10 — Web Architecture & State (provider invariant test, typed standalone routes registry, state-write-paths doctrine, `useSyncStatus` polling) | Active | 6/6 closed in PR | 5 P1 deferred | self (§1.1 / §1.2 / §2.1 / P2-D closed; P1-A/B/C/D/E carried forward)                                        |
| [`2026-05-13-web-frontend-ergonomics-roast.md`](./2026-05-13-web-frontend-ergonomics-roast.md)     | Прожарка #2/10 Web Frontend Ergonomics — toast policy, shortcuts, modal a11y, PWA defer                                        | Active | 3/7              | 4             | self                                                                                                         |
