...
> [`docs/audits/archive/2026-05-03-ftux-onboarding-roast.md`](./2026-05-03-ftux-onboarding-roast.md) — попередня FTUX-прожарка.
...
Власник `@Skords-01` ухвалив рішення по 15 ключових питаннях прожарки. Цей блок фіксує, **що прийнято**, **що відкладено**, і **що відхилено** з рекомендацій нижче. План-document — [`docs/initiatives/0010-revenue-first-launch.md`](../../initiatives/0010-revenue-first-launch.md).
...
`docs/audits/archive/2026-05-03-ftux-onboarding-roast.md` + `docs/01-product/launch/product-os/ftux-sprint-plan.md` — це **єдиний документ у репо, який пише жорстко про продукт**. 90% згоди. Що залишається болючим:
...
З `docs/audits/archive/2026-04-28-sergeant-comprehensive-audit.md`:
