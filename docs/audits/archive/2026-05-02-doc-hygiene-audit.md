...
| 1.3 | **Дублікат «next review» дат**                                                                                                        | README.md, AGENTS.md, docs/README.md, docs/03-operations/postmortems/README.md, docs/governance/README.md, docs/playbooks/README.md мають один і той самий `Last validated: 2026-05-02 by @claude` — не баг, але видно що це bulk-bump, не реальна ревалідація.                                     |
