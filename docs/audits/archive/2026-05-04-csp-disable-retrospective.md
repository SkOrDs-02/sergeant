...
| 2026-05-04              | Initiative 0011 (vector-assessment 100-PR-roast) виявив, що audit на «чи був enabled у проді» НЕ зроблений у PR #1631 (operational boundary). | [`docs/initiatives/archive/_0011-foundation-adoption-and-process-discipline.md`](../../initiatives/archive/_0011-foundation-adoption-and-process-discipline.md) §Чому зараз |
