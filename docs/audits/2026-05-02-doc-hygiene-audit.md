...
| `docs/audits/archive/2026-04-28-ux-ui-audit.md` | "Дата аудиту: 28 квітня 2026" + "Дата оновлення: 2 травня 2026" + `Last validated: 2026-05-02` — три параметри дат у різних місцях шапки. Краще канонізувати під єдиний freshness-header. | Не розв'язано (medium-task) |
...
6. **`2026-04-28-ux-ui-audit.md` дати** — канонізувати під єдиний freshness-header (зараз 3 параметри в шапці).
