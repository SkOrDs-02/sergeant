...
- **Один умисний placeholder.** `docs/launch/post-mortems/s6-cleanup-batch.md` згадується як «буде створений по завершенню» — конвертовано з markdown-link у code-mention, щоб не ламати лінкер.
...
| `docs/launch/ftux-sprint-plan.md`                | `[…s6-cleanup-batch.md](./post-mortems/...)`     | code-reference (link removed)                                  | Файл «буде створений по завершенню» — link-checker не вгадає.       |
