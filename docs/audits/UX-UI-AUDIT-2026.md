...
> бампив тільки `Last validated`, тому інші дві дрейфували. Тепер
> джерело істини — `Last validated`. Initial audit date залишається як
> історичний context (секція "Виявлені проблеми" фіксує стан на 2026-04-28).
...
_Initial audit: 2026-04-28. Поточна дата валідації — у `Last validated`-маркері в шапці._  
_Наступний аудит рекомендовано: Q3 2026._
