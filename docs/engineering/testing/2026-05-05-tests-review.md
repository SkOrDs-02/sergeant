...
- Stryker налаштований правильно (paths-фільтр на cloudSync, weekly cron, threshold break/low/high), документація є (`docs/engineering/testing/mutation.md`). Бракує лише розширення scope.
