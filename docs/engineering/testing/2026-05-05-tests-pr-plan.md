...
>
> **Replacement:** current testing contracts live in [`README.md`](./README.md); actionable work must appear in [`docs/open-work.md`](../../open-work.md) or the canonical `docs/work` queue before an agent picks it up.
>
