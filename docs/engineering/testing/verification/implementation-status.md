...
Бібліотека реалізує v1 [спеки](../../../work/specs/repeatable-verification.md). Це маршрут повторюваної перевірки й обліку, а не твердження, що вся продуктова матриця вже пройдена. Результати продуктового тестування записуються лише у runs.
