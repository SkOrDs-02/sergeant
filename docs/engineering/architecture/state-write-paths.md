...
- [`docs/work/specs/audits/2026-05-03-web-deep-dive/02-architecture-and-state.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-05-03-web-deep-dive/02-architecture-and-state.md) §2.1 — chatActions-як-другий-writer (audit findings)
- [`docs/work/specs/audits/2026-05-13-web-architecture-state-roast.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-05-13-web-architecture-state-roast.md) — Roast #3/10 (this doc landed alongside it)
- [`docs/engineering/architecture/diagrams/c3-chat-tool-use.md`](./diagrams/c3-chat-tool-use.md) — sequence для tool-use round-trip
- [`docs/engineering/architecture/module-ownership.md`](./module-ownership.md) — який RQ-keys factory належить якому модулю
...
- [`docs/governance/governance/hard-rules.json`](../../governance/governance/hard-rules.json) — RQ-keys / no-raw-localStorage / max-lines інваріанти
