...
- **Sync v2 architecture:** [`docs/engineering/architecture/diagrams/c3-cloudsync.md`](./diagrams/c3-cloudsync.md)
- **Mobile API:** [`docs/engineering/mobile/overview.md`](../mobile/overview.md)
- **Architecture overview:** [`docs/engineering/architecture/service-catalog.md`](./service-catalog.md)
