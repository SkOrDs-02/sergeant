...
- [`docs/work/specs/audits/2026-05-13-testing-devx-roast.md` § P1-5](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-05-13-testing-devx-roast.md#p1-5-pre-commit-timing-не-вимірюється) — origin audit item.
- [`docs/governance/governance/rules/07-pre-commit-hooks-via-husky.md`](../../governance/governance/rules/07-pre-commit-hooks-via-husky.md) — Hard Rule #7.
