...
>
> **Розподіл ролей з Dependabot:** див. [ADR-0044](../../governance/adr/0044-renovate-vs-dependabot.md). Коротко — Renovate primary для regular weekly bumps; Dependabot security-only daily fallback. Якщо бачиш одночасно два PR-и на той самий пакет — закривай Dependabot-PR з коментарем `duplicate of Renovate group: <name>`.
...
- Попросити нову AI-сесію (Claude Code / Codex) пофіксити код у тій же гілці.
...
- `docs/work/specs/planning/dev-stack-roadmap.md` #7 — навіщо ми це робили
