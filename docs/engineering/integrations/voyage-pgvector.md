...
на сотнях тисяч rows-ів, без token-cost-а у Anthropic-context-і. На відміну від [Memory Bank](../../governance/adr/0021-memory-bank.md) (local-first, structured user-facts) — pgvector-store зберігає embedding-и довільного тексту і повертає top-K-семантично-найближчих.
...
- ADR-0028 — `docs/governance/adr/0028-pgvector-ai-memory.md`
