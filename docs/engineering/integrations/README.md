...
> **Last validated:** 2026-05-13 by @devin-ai-integration[bot].
> **Status:** Active
...
| [`railway-vercel.md`](./railway-vercel.md)                         | ⚠️ Legacy Railway setup — бекенд переїхав на Hetzner/Coolify (ADR-0074); актуальний backend-деплой оновлюється окремо. Vercel-частина чинна. |
