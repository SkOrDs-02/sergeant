...
## 1. PostgreSQL на Railway (історичне — актуальний бекенд-деплой у [ADR-0074](../../governance/adr/0074-hosting-hetzner-coolify.md))
...
## 2. API на Railway (історичне — актуальний бекенд-деплой у [ADR-0074](../../governance/adr/0074-hosting-hetzner-coolify.md))
...
ADR — [`docs/governance/adr/0026-n8n-workflow-source-of-truth.md`](../../governance/adr/0026-n8n-workflow-source-of-truth.md).
