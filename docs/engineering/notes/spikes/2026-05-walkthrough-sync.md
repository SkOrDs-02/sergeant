...
> **Last touched:** 2026-09-11 by @claude. **Next review:** 2027-11-19.
> **Status:** Draft
...
| `docs/governance/adr/0043-cloudsync-v1-sunset.md` | Рішення про sunset CloudSync v1; поточний стан — v2                          |
...
- CloudSync v1 sunset: `docs/governance/adr/0047-cloudsync-v1-410-gone.md`
- v2 architecture: `docs/governance/adr/0043-cloudsync-v1-sunset.md`
