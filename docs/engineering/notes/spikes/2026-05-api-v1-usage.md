...
> **Last touched:** 2026-05-13 by Devin. **Next review:** 2026-11-11.
...
[`docs/engineering/architecture/api-v1.md`](../../architecture/api-v1.md). Видалити
...
[ADR-0053](../../../governance/adr/0053-api-versioning-policy.md), а PR-08 закрити по
research-фазі.
...
2. сонячно догорить mobile beta (target за `docs/engineering/architecture/api-v1.md` —
...
- [x] [ADR-0053](../../../governance/adr/0053-api-versioning-policy.md) — політика
      версіонування + умови видалення shim.
- [x] [`pr-08-api-versioning-consolidation.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/stack-pulse-2026-05/archive/pr-08-api-versioning-consolidation.md)
...
- [`docs/engineering/architecture/api-v1.md`](../../architecture/api-v1.md) — як влаштоване версіонування.
