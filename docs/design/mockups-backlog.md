...
3 рівні з `docs/design/empty-states.md`: повноекранний (4 модулі) /
...
### Інфраструктура
- `_shared/tokens.css` — дзеркало `docs/design/design-system.md`.
...
| `docs/design/redesign-v2/handoff-package/*.html` | `mockups/product/{module}/*.html` | ✅ |
...
3. **Знайди план у `docs/launch/product-os/` або `docs/design/`** — у картці
