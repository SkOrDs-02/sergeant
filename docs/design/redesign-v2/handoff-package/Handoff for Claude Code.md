...
- Update `docs/design/unified-bottom-nav.md` — переписати «однакову форму» секцію (форми тепер ідентичні з v2 shape, лише accent differs)
- Розмір: **M** (1 shared file + 4 module re-wires + Storybook + updated doc)
...
- `docs/design/redesign-v2/governance.md` — governance
- `docs/design/redesign-v2/execution-plan.md` — phases
- `docs/design/redesign-v2/backlog.md` — polish items
- `docs/design/redesign-v2/migration.md` — BEFORE/AFTER patterns
- `docs/design/unified-bottom-nav.md` — **потребує оновлення** (опис v2 для module nav)
- `docs/design/brandbook.md` — voice, palette
