...
### Module-accent containment (дизайн-конвенція — tokens + review, ex-Hard Rule #12, retired [ADR-0081](../../governance/adr/0081-repository-simplification.md))
...
- [`docs/design/design/brandbook.md`](./brandbook.md) — WCAG-AA `-strong` Tier
  - повна per-family-таблиця контрасту.
- [`docs/design/design/archive/brand-palette-wcag-aa-proposal.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/05-design/design/archive/brand-palette-wcag-aa-proposal.md) — migration-історія (PR-и #854 / #855 / #857).
