...
([`frontend.md` п.8](../../work/specs/tech-debt/frontend.md)).
...
4. Git history — закриті аудити та superseded specs.
...
Закриті аудити та реалізовані пропозиції — повний індекс і підсумки кожного у [`archive/README.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/05-design/design/archive/README.md). Файли тут лишені як **історичний контекст** для governance-посилань (HR #9, HR #13, ADR-0007), не як живий контракт.

| Документ                                                                                                                                                                                           | Статус      |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| [`archive/dark-mode-audit.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/05-design/design/archive/dark-mode-audit.md)                               | Closed      |
| [`archive/brand-palette-wcag-aa-proposal.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/05-design/design/archive/brand-palette-wcag-aa-proposal.md) | Implemented |
