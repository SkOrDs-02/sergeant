...
Коли всі пункти закриються — документ переїде в [`archive/`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/05-design/design/archive/README.md).
