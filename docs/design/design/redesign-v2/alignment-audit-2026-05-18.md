...
| Scope             | Весь `apps/web/src` (поточний код) vs `docs/design/design/redesign-v2/` (план) vs `mockups/` (Claude-design мокапи)         |
...
**Statement:** Жоден doc у `docs/design/design/redesign-v2/` не згадує landing / pricing / marketing surfaces. Це implicit exclusion, не documented exclusion.
...
- `project_redesign-v2-alignment-2026-05-18.md` | type: project | content: «v2 plan stale (P4.1 primitives shipped P2.0); Fizruk only module not on MeshBackground; 11 unowned surfaces (6 mockup-novel + 5 code-orphan); marketing scope absent from plan; landing direction unlocked. Council audit doc: `docs/design/design/redesign-v2/alignment-audit-2026-05-18.md`».
