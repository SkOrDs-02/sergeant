...
| Phase 2 (polish migration codemod)   | `sergeant-web-ui` + read `docs/design/design/redesign-v2/migration.md` | BEFORE/AFTER patterns canonical.                                         |
| Phase 3 (friction UX)                | `sergeant-web-ui` + read `docs/design/design/undo-pattern.md`          | Pattern A for F2 (set-delete undo).                                      |
...
4. `docs/design/design/redesign-v2/execution-status.md` — current progress.
5. `docs/design/design/redesign-v2/execution-plan.md` — intent / sequencing.
6. `docs/design/design/redesign-v2/governance.md` — governance.
7. `docs/design/design/redesign-v2/migration.md` — BEFORE/AFTER patterns.
