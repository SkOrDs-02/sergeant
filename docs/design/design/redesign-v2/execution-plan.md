...
1. Прочитай `AGENTS.md` (Hard Rules, особливо #11–#17), `docs/design/design/redesign-v2/governance.md` (governance), `docs/design/design/redesign-v2/migration.md` (BEFORE/AFTER tokens).
...
4. **Storybook оновлення**: якщо торкаєш `@shared/components/ui` — спочатку онови `*.stories.tsx`, тоді бампай freshness у `design-system.md` (як описано в `docs/design/design/README.md`).
...
- Aудит контексту: `docs/design/design/redesign-v2/governance.md` § PR sequence, § Risks, § Open questions
- Backlog (raw items): `docs/design/design/redesign-v2/backlog.md`
- Migration patterns: `docs/design/design/redesign-v2/migration.md`
- DS canonical contract: `docs/design/design/design-system.md`
- Brand voice: `docs/design/design/brandbook.md` (потребує align з `redesign-v2.md` — див. T4)
- Empty state patterns: `docs/design/design/empty-states.md`
- Undo pattern doctrine: `docs/design/design/undo-pattern.md` (применить consistently — F2)
- Module accent rules: `docs/design/design/module-accent.md`
