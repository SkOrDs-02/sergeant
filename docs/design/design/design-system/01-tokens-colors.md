...
| `surface`        | Картки, панелі                      | `#ffffff` | `#1f1a17` |
| `surface-muted`  | Інпути, hover, допоміжні поверхні   | `#f6f5f2` | `#2a231f` |
| `surface-strong` | Стек сторінки під модалкою          | = `bg`    | = `bg`    |
| `border`         | Розмежувачі, обводки картки         | `#e2e0da` | `#3b332e` |
| `border-strong`  | Сильніший дільник (інпути, таблиці) | `#ddd3c5` | `#524841` |
...
>
> **`apps/mobile` досі шипить стару генерацію** — `#171412 / #201c19 / #302a25`
> у [`apps/mobile/global.css`](../../../../apps/mobile/global.css). Це не дрейф
> коментаря, а не проведена міграція: темна тема мобайла — інша тема, ніж у
> веба. Контраст там AA тримає (найтісніше `subtle` 4.61:1 і `danger-ink`
> 5.12:1 на `panel-hi`), тож це не баг доступності, а розбіжність вигляду.
> Рішення про міграцію — за власником; борг записано в
> [аудиті 2026-09-11](../../../work/specs/audits/2026-09-11-founder-ux-review-round2.md).
...
| `subtle` | Третинний текст, плейсхолдери       | `#605a54`           | `#878079` |
