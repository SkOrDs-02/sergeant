...
- [`docs/design/specs/archive/2026-04-24-assistant-quick-actions-v1-design.md`](./archive/2026-04-24-assistant-quick-actions-v1-design.md) — попередній етап (chips), на якому будується catalogue
