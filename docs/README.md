...
> 🟡 **Docs trust: WARNING** — _оновлено 2026-07-02 via `pnpm docs:gen-trust-badge`_
>
> 2 stale, 0 WIP soft-violation — варто прибрати найближчим тижнем. Деталі → [`today.md`](./today.md).
