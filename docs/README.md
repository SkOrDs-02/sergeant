...
> 🟡 **Docs trust: WARNING** — _оновлено 2026-06-11 via `pnpm docs:gen-trust-badge`_
>
> 1 stale, 0 WIP soft-violation — варто прибрати найближчим тижнем. Деталі → [`today.md`](./today.md).
