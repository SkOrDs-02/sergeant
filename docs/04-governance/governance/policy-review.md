...
1. На початку кожного місяця копіюємо цей файл як
   `docs/04-governance/governance/reviews/YYYY-MM-policy-review.md`.
...
- `docs/04-governance/security/audit-exceptions.md` — активні винятки `audit-exception`.
...
Джерело: `docs/04-governance/security/audit-exceptions.md`.
...
- `docs/04-governance/security/audit-exceptions.md` — формат запису `audit-exception`.
