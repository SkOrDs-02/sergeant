...
Procedure для ротації / емержансі — [`docs/00-start/playbooks/rotate-openclaw-credentials.md`](../../../00-start/playbooks/rotate-openclaw-credentials.md). Migration-план — [`docs/90-work/initiatives/stack-pulse-2026-05/pr-06-openclaw-github-app.md`](../../../90-work/initiatives/archive/stack-pulse-2026-05/archive/pr-06-openclaw-github-app.md).
