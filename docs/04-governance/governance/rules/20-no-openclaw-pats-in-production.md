...
Procedure для ротації / емержансі — [`docs/00-start/playbooks/rotate-openclaw-credentials.md`](../../../00-start/playbooks/rotate-openclaw-credentials.md). Migration-план — [`docs/90-work/initiatives/stack-pulse-2026-05/pr-06-openclaw-github-app.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/stack-pulse-2026-05/archive/pr-06-openclaw-github-app.md).
