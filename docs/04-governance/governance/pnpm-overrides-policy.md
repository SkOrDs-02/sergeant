...
1. **Кожен запис `pnpm.overrides` повинен мати відповідний рядок у [`pnpm-overrides.md`](../../../pnpm-overrides.md)**
   ...
   Повний перелік чинних override-ів веде таблиця «Повний реєстр» наприкінці того файла;
   станом на 2026-08-05 прозове обґрунтування має ~12 із 32 записів, решта — CVE-піни
   audit-свіпів із боргом на дописування (`pnpm lint:pnpm-overrides` перевіряє форму
   override-ів, а не наявність прози, тож борг видно лише очима).
