...
> **Один рядок уточнено: [ADR-0085](./0085-free-ai-quota-five-per-day.md) (2026-08-06)** — Free AI-чат **5** повідомлень/добу, а не 15; анонім — 1. Причина: вимір unit-економіки, який показав, що число 15 стояло на заниженій у 2.4–3.5 раза оцінці префікса промпта. Решта цього ADR — ціна ₴199/₴1490, reverse trial, cloud-sync 2 пристрої, Pro-набір — **чинна без змін**, тому статус лишається `Accepted`. Тіло нижче — запис на момент ухвалення.
