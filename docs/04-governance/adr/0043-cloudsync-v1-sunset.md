...
- **Related:**
  ...
  - [Initiative 0003 — Sync v2 rollout & v1 sunset](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/_0003-sync-v2-rollout-and-v1-sunset.md) — rationale-документ із 6-фазним планом.
  ...
  - `apps/server/src/modules/sync/clientSurvey.ts` — Phase 1 measurement counter (historical; **removed** Phase 7 / #326).
  - [`apps/server/src/routes/sync.ts`](../../../apps/server/src/routes/sync.ts) — current v2 + audit routes after Phase 7.
...
(специфікація — [Initiative 0003](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/_0003-sync-v2-rollout-and-v1-sunset.md)):
...
`v1SunsetHeadersMiddleware` (`apps/server/src/modules/sync/sunsetHeaders.ts`, **removed** Phase 7 / #326) додавав:
