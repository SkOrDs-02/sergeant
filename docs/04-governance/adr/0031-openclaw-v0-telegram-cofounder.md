...
5. **Strategy-docs ownership — завжди suggest-PR.**
   - OpenClaw ніколи не commit-ить напряму у `docs/strategy/`,
     `docs/01-product/launch/`, або `docs/04-governance/adr/`.
...
| `read_strategy_docs`          | read           | filesystem (server-side)  | path-allowlist (`docs/strategy/`, `docs/01-product/launch/`, `docs/04-governance/adr/`) |
