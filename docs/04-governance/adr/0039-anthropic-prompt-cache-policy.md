...
- **Related:**
  ...
  - [Initiative 0005 — AI cost optimisation (prompt cache)](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/_0005-ai-cost-and-prompt-cache.md) — це rationale-документ для рішень, прийнятих під час її закриття.
...
- [Initiative 0005 — AI cost optimisation (prompt cache)](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/_0005-ai-cost-and-prompt-cache.md)
