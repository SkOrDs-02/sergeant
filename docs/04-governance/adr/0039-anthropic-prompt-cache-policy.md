...
- **Related:**
  ...
  - [Initiative 0005 — AI cost optimisation (prompt cache)](../../90-work/initiatives/archive/_0005-ai-cost-and-prompt-cache.md) — це rationale-документ для рішень, прийнятих під час її закриття.
...
- [Initiative 0005 — AI cost optimisation (prompt cache)](../../90-work/initiatives/archive/_0005-ai-cost-and-prompt-cache.md)
