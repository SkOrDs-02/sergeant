...
- **Related:**
  ...
  - PR-історія: PR-4.D (audit `docs/90-work/audits/archive/2026-04-26-sergeant-audit-devin.md`).
...
Аудит-документ (`docs/90-work/audits/archive/2026-04-26-sergeant-audit-devin.md`, рядок PR-4.D) вимагає codegen-рішення.
