...
- **Supersedes:** —
- **Related:**
  - [`docs/04-governance/adr/0002-tool-lifecycle.md`](./0002-tool-lifecycle.md) — ADR-2.7 (cache breakpoint), ADR-2.8 (model selection / version bumps вийняті в окремий ADR — цей).
...
| PR                                                   | Title                                                              | Merged     |
| ---------------------------------------------------- | ------------------------------------------------------------------ | ---------- |
| [#17](https://github.com/Skords-01/Sergeant/pull/17) | feat(server): pro tiered model degradation + prod llm env defaults | 2026-06-27 |
