...
- **Related:**
  ...
  - [`docs/01-product/launch/tech/telegram-improvements-roadmap.md` §3.2](../../01-product/launch/tech/telegram-improvements-roadmap.md#32-acknowledge-кнопка-на-p0p1-alert-ах--15-min-escalation) — pain P2.
...
Pain (per [telegram-improvements-roadmap §2 P2](../../01-product/launch/tech/telegram-improvements-roadmap.md#2-pain-points--що-зараз-слабко)):
...
- [`docs/01-product/launch/tech/telegram-improvements-roadmap.md` §3.2](../../01-product/launch/tech/telegram-improvements-roadmap.md#32-acknowledge-кнопка-на-p0p1-alert-ах--15-min-escalation) — pain P2 context.
