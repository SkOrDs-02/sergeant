...
- **Status:** Accepted
- **Note:** Historical — paths describe pre-decommission OpenClaw types/layout; alert acks ship via `apps/server/src/modules/alerts/`; see [ADR-0075](./0075-openclaw-gateway-decommissioned.md).
...
- **Related:**
  ...
  - [`docs/01-product/launch/tech/telegram-improvements-roadmap.md` §3.2](../../01-product/launch/archive/tech/telegram-improvements-roadmap.md#32-acknowledge-кнопка-на-p0p1-alert-ах--15-min-escalation) — pain P2.
...
Pain (per [telegram-improvements-roadmap §2 P2](../../01-product/launch/archive/tech/telegram-improvements-roadmap.md#2-pain-points--що-зараз-слабко)):
