...
- **Input:** `docs/04-governance/governance/symbol-index.json` (Phase 2 output). Кожен `package.exports[].usedBy[]` запис → файл-шлях; групування за workspace prefix (`apps/*`, `packages/*`, `tools/*`) → cross-workspace edges.
- **Output content:**
