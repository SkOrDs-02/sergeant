...
- **Supersedes:** —
- **Related:**
  - [`docs/90-work/initiatives/stack-pulse-2026-05/pr-03-bcrypt-password-limit.md`](../../90-work/initiatives/archive/stack-pulse-2026-05/archive/pr-03-bcrypt-password-limit.md) — original PR-план (premised on bcrypt; superseded by this ADR).
