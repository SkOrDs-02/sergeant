...
- **Supersedes:** —
- **Related:**
  - [`docs/90-work/initiatives/stack-pulse-2026-05/pr-03-bcrypt-password-limit.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/stack-pulse-2026-05/archive/pr-03-bcrypt-password-limit.md) — original PR-план (premised on bcrypt; superseded by this ADR).
