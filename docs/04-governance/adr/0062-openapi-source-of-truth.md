...
- **Deciders:** @Skords-01
- **Supersedes:** —
- **Related:** [ADR-0053](./0053-api-versioning-policy.md) (API versioning), [ADR-0025](./0025-openapi-generation.md) (zod→OpenAPI generator — цей ADR підтверджує code-first як канонічне SoT, не суперечить 0025), PR-23 у [`docs/90-work/initiatives/stack-pulse-2026-05/pr-23-openapi-contract-tests.md`](../../90-work/initiatives/archive/stack-pulse-2026-05/archive/pr-23-openapi-contract-tests.md)
