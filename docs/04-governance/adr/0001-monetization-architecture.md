...
- **Supersedes:** —
- **Related:**
  - [`docs/01-product/launch/business/01-monetization-and-pricing.md`](../../01-product/launch/business/01-monetization-and-pricing.md) — бізнес-модель, тіри, ціни.
  - [`docs/01-product/launch/business/06-monetization-architecture.md`](../../01-product/launch/business/06-monetization-architecture.md) — технічний скелетон v2 (PR-розбивка, schema, risk register).
...
ADR посилається на «Phase N» декілька разів. Глосарій (синхронізовано з [`docs/01-product/launch/business/04-launch-readiness.md`](../../01-product/launch/business/04-launch-readiness.md)):
...
Schema див. [`docs/01-product/launch/business/06-monetization-architecture.md` §3.1](../../01-product/launch/business/06-monetization-architecture.md#31-migration-009--subscriptions-правки-v1).
...
Trigger див. [`docs/01-product/launch/business/06-monetization-architecture.md` §3.1](../../01-product/launch/business/06-monetization-architecture.md#31-migration-009--subscriptions-правки-v1).
...
See original version in git history (`git log docs/04-governance/adr/0001-monetization-architecture.md`).
