...
- `docs/04-governance/governance/hard-rules.schema.json` уже включає `category` як required-поле з enum `[blocker-invariant, lint-enforced-convention, active-initiative]` (виставлено в Initiative 0009 фаза 1.5).
