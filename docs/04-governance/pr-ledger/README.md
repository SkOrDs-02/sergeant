...
> **Last validated:** 2026-06-09 by @claude. **Next review:** 2026-09-10.
> **Status:** Active
...
- `index.json` matches the JSON schema at [`docs/04-governance/governance/schemas/pr-ledger.schema.json`](../governance/schemas/pr-ledger.schema.json).
