...
Each card under `docs/04-governance/security/hardening/` carries a `Status: Closed` badge and
...
- [`docs/04-governance/security/hardening/README.md`](../hardening/README.md) — full hardening backlog
- [`docs/04-governance/security/disaster-recovery.md`](../disaster-recovery.md) — recovery posture for security incidents
- [`docs/90-work/initiatives/archive/_0011-foundation-adoption-and-process-discipline.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/_0011-foundation-adoption-and-process-discipline.md) — owning initiative
