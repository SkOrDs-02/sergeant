...
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Owner**    | platform                                                                                                                                                                                                |
| **Source**   | [`pr-plan-2026-05.md` PR-48](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/planning/archive/pr-plan-2026-05.md) — round 2 (slim audit beyond crypto) |
...
| [`apps/server/src/obs/spans.ts`](../../../apps/server/src/obs/spans.ts) ignored headers                    | Span attribute scrubbing (OTel `obs/tracing.ts` reverted, PR #9 — `aiSpan` passthrough лишився) |
...
- **Roll-out playbook**: [`docs/04-governance/security/api-internal-hmac.md`](./api-internal-hmac.md).
