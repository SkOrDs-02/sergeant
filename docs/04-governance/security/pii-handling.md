...
> [`docs/90-work/audits/2026-05-13-security-observability-roast.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-05-13-security-observability-roast.md) §P0-S1..S5
...
2. Створи `docs/04-governance/security/incidents/YYYY-MM-DD-<topic>.md` з timeline + impact + fix.
...
- [`docs/90-work/audits/2026-05-03-web-deep-dive/04-security-observability-testing-devx.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-05-03-web-deep-dive/04-security-observability-testing-devx.md) §6.5 (origin)
