...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/H7-vercel-config-drift.md`.
...
- `docs/04-governance/security/access-matrix.md` — link Vercel project settings to the
