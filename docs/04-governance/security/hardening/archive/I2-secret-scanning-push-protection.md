...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/I2-secret-scanning-push-protection.md`.
...
- Ensure the founder + every external contributor receives the secret-found
  email.
- Document the policy in `docs/04-governance/security/README.md` so future contributors
...
- `docs/04-governance/security/README.md` — add a paragraph and link to GitHub's docs.
- `docs/04-governance/security/audit-exceptions.md` — document any provider keys that the
...
- `docs/04-governance/security/README.md` — додано секцію `Secret scanning policy` з
...
- `docs/04-governance/security/audit-exceptions.md` — додано дві нові секції:
