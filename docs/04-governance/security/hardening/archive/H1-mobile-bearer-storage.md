...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/H1-mobile-bearer-storage.md`.
...
- [docs/04-governance/security/hardening/H3-session-revoke-and-binding.md](./H3-session-revoke-and-binding.md) (Sprint 2) — TTL + revoke-on-password-change (Phase 2 для H1).
- [docs/02-engineering/mobile/shell.md](../../../../02-engineering/mobile/shell.md) — Capacitor shell architecture.
