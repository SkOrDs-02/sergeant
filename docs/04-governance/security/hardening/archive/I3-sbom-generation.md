...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/I3-sbom-generation.md`.
...
- `docs/04-governance/security/container-scan.md` — link to the SBOM artifact location.
- `docs/04-governance/security/audit-exceptions.md` — note any policy exceptions
