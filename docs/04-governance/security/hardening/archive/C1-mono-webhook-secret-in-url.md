...
> **Last validated:** 2026-05-29. **Next review:** ніколи (read-only архів).
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/C1-mono-webhook-secret-in-url.md`.
...
| **Owner**          | backend                                                                                                                                                                                                                                        |
| **Effort**         | 1 person-day                                                                                                                                                                                                                                   |
| **Status**         | Closed (2026-06-01) — mitigated-final; Phase 2 re-scoped (rotation shipped; Monobank header infeasible)                                                                                                                                        |
...
- [docs/04-governance/security/vulnerability-sla.md](../../vulnerability-sla.md) — Critical = 24h acknowledge / 14d fix.
