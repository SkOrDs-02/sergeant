...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/sprint-2.md`.
...
After Sprint 2 every Sprint 2 High-severity item is closed; **H4
(encryption-key rotation)** lives in Sprint 3 and Phase 1 of it shipped on
2026-05-04 — see the Sprint 3 board for the cross-sprint status.

## Scope

| ID                                       | Title                                            | Severity | Owner    | Effort                                                                                  |
| ---------------------------------------- | ------------------------------------------------ | -------- | -------- | --------------------------------------------------------------------------------------- |
| [H3](./H3-session-revoke-and-binding.md) | Session 30 d, no revoke-on-password-change       | High     | backend  | 1 d _(closed 2026-05-04 — PR [#1669](https://github.com/Skords-01/Sergeant/pull/1669))_ |
...
| [M1](./M1-csp-disable-runtime-flag.md)   | `CSP_DISABLE=1` env-fault-injection              | Medium   | backend  | 0.25 d _(closed 2026-05-04)_                                                            |
