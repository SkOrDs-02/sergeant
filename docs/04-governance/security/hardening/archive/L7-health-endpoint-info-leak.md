...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/L7-health-endpoint-info-leak.md`.
...
- Sentry traces sampler — exclude `/health` (already done by tracking
  rule [PR #12](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/stack-pulse-2026-05/archive/pr-12-sentry-traces-sampler.md);
