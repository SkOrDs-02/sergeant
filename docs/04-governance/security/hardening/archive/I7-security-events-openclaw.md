...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/I7-security-events-openclaw.md`.
...
- `docs/03-operations/runbooks/security-events.md` (new) — operator playbook for each
  event type.
