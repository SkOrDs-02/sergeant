...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/M11-eslint-plugin-security.md`.
...
- `docs/04-governance/security/audit-exceptions.md` — document any false positives that
  must be silenced.
...
- `docs/04-governance/security/audit-exceptions.md` — new "SAST baseline warnings"
