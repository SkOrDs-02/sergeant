...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/M21-coep-stripe-compatibility.md`.
...
- If any planned integration cannot meet COEP, downgrade to
  ...
  in `docs/04-governance/security/audit-exceptions.md`.

## Correction points

- `docs/03-operations/deploy/vercel.md` — add a "Third-party iframe compatibility" matrix
  with one row per planned integration.
- `docs/04-governance/security/audit-exceptions.md` — entry if/when COEP is downgraded.
...
matrix to [`docs/03-operations/deploy/vercel.md`](../../../../03-operations/deploy/vercel.md)
