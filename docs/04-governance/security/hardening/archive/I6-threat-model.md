...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/I6-threat-model.md`.
...
Author `docs/04-governance/security/threat-model.md` with a section per module:
...
- [`docs/04-governance/security/threat-model.md`](../../threat-model.md) (new) — STRIDE
...
- [`docs/04-governance/security/README.md`](../README.md) — link added to the
...
- **Living doc:** every new finding card cross-references the relevant
  STRIDE row in [`docs/04-governance/security/threat-model.md`](../../threat-model.md).
...
Added [`docs/04-governance/security/threat-model.md`](../../threat-model.md), a STRIDE map for
