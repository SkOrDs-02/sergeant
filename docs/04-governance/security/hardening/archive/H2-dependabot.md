...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/H2-dependabot.md`.
...
| `docs/04-governance/security/audit-exceptions.md`  | Перевірити, що manual-pin-и (uuid, tar, postcss, xmldom, serialize-javascript) задокументовані як exceptions.   |
...
2. **First-batch verification** — once Dependabot opens its first batch
   ...
   [`docs/04-governance/security/nightly-audit.md`](../../nightly-audit.md). The
...
- [docs/04-governance/security/audit-exceptions.md](../../audit-exceptions.md) — manual-pin-и (overrides у `package.json`).
- [docs/04-governance/security/nightly-audit.md](../../nightly-audit.md) — реактивна частина (стає supplementary).
- [docs/04-governance/security/vulnerability-sla.md](../../vulnerability-sla.md) — SLA на оновлення.
