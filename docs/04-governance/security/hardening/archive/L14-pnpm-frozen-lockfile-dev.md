...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/L14-pnpm-frozen-lockfile-dev.md`.
...
- Added an explicit `pnpm install --frozen-lockfile` paragraph to
  [`CONTRIBUTING.md` → Setup](../../../../../CONTRIBUTING.md) explaining
