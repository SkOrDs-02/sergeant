...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/04-governance/security/hardening/L11-csp-monitoring-allowlist.md`.
...
- `docs/04-governance/security/audit-exceptions.md` — record any vendor host that
  required a wildcard.
