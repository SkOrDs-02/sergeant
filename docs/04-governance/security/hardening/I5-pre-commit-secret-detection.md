...
> **Status:** **Closed (2026-05-14)** — gitleaks pre-commit step wired into Husky via `scripts/pre-commit-gitleaks.mjs` + documented in `CONTRIBUTING.md`. CI gate (`.github/workflows/ci.yml :: secret-scan`) remains the authoritative defense-in-depth check.
