...
> **Last validated:** 2026-05-03 by @Skords-01 (PR D closeout — `032_query_plan_documentation.sql` доб'є COMMENT ON expected-plan на гарячих обʼєктах синку/push/AI-квоти; всі CHECK / FK / partial-index requirements уже були в коді з 002–024). **Next review:** 2026-07-31.
> **Status:** Active
