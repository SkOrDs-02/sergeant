...
| Великі файли (>600 LOC)                  | **Середній**            | **3** production-файли >600 LOC у mobile (re-count 2026-05-13, після #2780): `fizruk/lib/dualWrite/adapter.ts` 804 (was 737), `fizruk/lib/dualWrite/diff.ts` 633 (newly over threshold), `PlanCalendar.tsx` 661 (was 616). `routine/pages/Calendar.tsx` 628 → decomposed into `pages/Calendar/` folder (P2.2b, #2780) — `index.tsx` 183 LOC. `OnboardingWizard.tsx` лишається у 390 LOC. |
