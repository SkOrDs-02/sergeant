...
| --- | -------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| 1   | `noUncheckedIndexedAccess` (`arr[i]` стає `T \| undefined`)                                                                      | **1225 baseline / 280 файлів** (виміряно 2026-05-03, PR § 6a). Flipped у base, **8 / 13 пакетів** мігровано: routine-domain, db-schema, shared, nutrition-domain, insights, console, mobile-shell, api-client (sync через `node scripts/strict-coverage.mjs`). Залишилось 5: `apps/web`, `apps/server`, `apps/mobile`, `packages/finyk-domain`, `packages/fizruk-domain`. | 🟢 in-flight |
