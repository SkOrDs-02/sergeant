...
> **Last validated:** 2026-05-21 by @Skords-01 (NotFoundPage re-export shim видалено — closes audit F24 із `docs/audits/2026-05-13-page-audit-10-errors-pwa-marketing.md`; single callsite `StandaloneRoutes.tsx:56` мігрований на `../errors/NotFoundPage`; i18n allowlist clean). **Next review:** 2026-08-19.
> **Status:** Active
