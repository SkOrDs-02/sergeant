...
> **Last validated:** 2026-05-22 by @Skords-01 (2 SW smoke `test.skip` (b) closed as audit misclassification — обидва є runtime-guard conditional skips, не unconditional bypass; коментар inline пояснює). **Next review:** 2026-08-20.
> **Status:** Active
