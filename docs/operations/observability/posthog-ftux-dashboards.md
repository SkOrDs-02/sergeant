...
> **Cross-refs:**
> [`docs/operations/observability/frontend.md`](./frontend.md) — analytics
> transport · [`docs/work/specs/launch/product-os/ftux-sprint-plan.md` §2](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/01-product/launch/archive/product-os/ftux-sprint-plan.md#2-sprint-0--analytics-live-1-тиждень)
> — Sprint 0 deliverable spec (this doc is **S0.5**) ·
> [`docs/work/specs/launch/business/01-monetization-and-pricing.md` §7](../../work/specs/launch/business/01-monetization-and-pricing.md)
...
| `streak_milestone_reached`       | [`dashboardCards.tsx`](../../../apps/web/src/core/hub/dashboard/dashboardCards.tsx) `<StreakIndicator/>` crossing detector (toast-only path; dedicated celebration modal не існує — `StreakCelebration` був deleted у PR #2998 як unused orphan, see [alignment-audit-2026-05-18.md §Q8](../../design/design/redesign-v2/alignment-audit-2026-05-18.md)) | `days: number`, `type: "toast"` (contract reserves `"modal"` if a future celebration surface is wired)                                                                                                                                                |
| `hint_dismissed`                 | [`useHints.ts`](../../../apps/mobile/src/core/hints/useHints.ts) timeout after a mobile hint; web emitter retired with the web hint orchestrator                                                                                                                                                                                                         | `id: string`, `via: "timeout"` (contract reserves `"x" \| "swipe"` for explicit dismiss UI)                                                                                                                                                           |
| `hint_completed`                 | Contract retained in [`analyticsEvents.ts`](../../../packages/shared/src/lib/analyticsEvents.ts); no active emitter after the web hint orchestrator was retired                                                                                                                                                                                          | `id: string`, `via: "action"`                                                                                                                                                                                                                         |
...
[`ftux-sprint-plan.md` §8](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/01-product/launch/archive/product-os/ftux-sprint-plan.md#8-roll-up-success-metrics-dashboard)) ·
...
[`ftux-sprint-plan.md` §5](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/01-product/launch/archive/product-os/ftux-sprint-plan.md#5-sprint-3--reward-у-правильний-момент--value-progress-2-тижні))
needs to ship.
...
- **Mobile parity (S0.3).** Until `apps/mobile` writes to PostHog
  (planned in
  [`ftux-sprint-plan.md` §2](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/01-product/launch/archive/product-os/ftux-sprint-plan.md#2-sprint-0--analytics-live-1-тиждень)
