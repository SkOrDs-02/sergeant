...
Telegram-консоль (OpenClaw) декомісована — [ADR-0075](../../governance/adr/0075-openclaw-gateway-decommissioned.md).
...
- `docs/operations/observability/logging.md` — log schema and transport pipeline
- `docs/operations/observability/prometheus/alert_rules.yml` — `AiDailyCostHigh` alert
