...
не існувало (аудит `docs/work/specs/audits/web-qa-pre-beta.md`).
...
```yaml
rule_files:
  - "docs/operations/observability/prometheus/recording_rules.yml"
  - "docs/operations/observability/prometheus/alert_rules.yml"
```
