...
[`findings.md`](../../work/specs/audits/2026-09-01-product-audit/findings.md).
...
[`report.md § 4`](../../work/specs/audits/2026-09-01-product-audit/report.md).
...
Саме цей ярус дає **hit-rate по ярусах**, який [дослідження баз штрихкодів](../../work/specs/planning/barcode-database-research.md) § 4 називає метрикою для рішення «чи потрібен платний API»: скільки сканів закриває власна база, скільки — безкоштовний OFF, і скільки лишається непокритими.
