...
Політика для runtime container-image Hub API (`Dockerfile.api`). Описує rationale за distroless multi-stage build (PR-30 — `docs/work/specs/initiatives/stack-pulse-2026-05/pr-30-dockerfile-cleanup-cve.md`), CVE-бюджет, healthcheck-семантику, і rollout-послідовність.
...
- [`docs/work/specs/initiatives/stack-pulse-2026-05/pr-30-dockerfile-cleanup-cve.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/stack-pulse-2026-05/archive/pr-30-dockerfile-cleanup-cve.md) — PR-30 design doc.
- [`docs/work/specs/security-hardening/L13-docker-platform-pin.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/L13-docker-platform-pin.md) — `--platform=linux/amd64` pin policy.
