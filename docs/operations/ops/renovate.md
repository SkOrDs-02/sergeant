...
Відповідно до [ADR-0044](../../governance/adr/0044-renovate-vs-dependabot.md):
...
5. **Якщо Mend off-line > 7 днів:** відкривай incident у `docs/operations/postmortems/` (template є). Розгляд Option 1/2 з ADR-0044 — переключитися на Dependabot повністю або шукати альтернативу (Renovate Self-Hosted, GitHub Renovate Action).
...
- [ADR-0044 — Renovate vs Dependabot](../../governance/adr/0044-renovate-vs-dependabot.md) — рішення про розподіл ролей.
...
- [`docs/engineering/integrations/renovate-usage.md`](../../engineering/integrations/renovate-usage.md) — гід контриб'ютора (review-cheatsheet, FAQ).
- [`docs/work/specs/security-hardening/H2-dependabot.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H2-dependabot.md) — Sprint 1 setup card (Dependabot scope-reduction).
- [`docs/governance/security/nightly-audit.md`](../../governance/security/nightly-audit.md) — реактивна частина (`pnpm audit` + OSV-Scanner).
- [`docs/governance/security/vulnerability-sla.md`](../../governance/security/vulnerability-sla.md) — SLA для security-bumps.
