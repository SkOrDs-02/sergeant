...
Після [ADR-0032](../../governance/adr/0032-console-consolidated-into-openclaw.md) активний
...
- [service-catalog.md](../../engineering/architecture/service-catalog.md) — `sergeant-openclaw` рядок (раніше `sergeant-hubchat`)
- [§«Railway service rename runbook»](#railway-service-rename-runbook) — як виконати фактичний rename у Railway dashboard
- [secret-ownership-register.md](../../governance/security/secret-ownership-register.md)
