...
| 2.5   | ModuleBottomNav v2 unification (decision 3.2) | ✅ Shipped [#2971]   | Окремий PR per locked decision. Shape match HubBottomNav v2. Module-tinted active pill (`bg-{module}-strong`). Routine FAB як sibling. 10px→12px labels (ex-Hard Rule #16, retired ADR-0081). v1 top-pill indicator + icon glow видалено.                                                                                                                                                                                         |
