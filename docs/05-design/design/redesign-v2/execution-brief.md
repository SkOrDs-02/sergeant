...
| Phase 2 (polish migration codemod)   | `sergeant-web-ui` + read `docs/05-design/design/redesign-v2/migration.md` | BEFORE/AFTER patterns canonical.                                         |
| Phase 3 (friction UX)                | `sergeant-web-ui` + read `docs/05-design/design/undo-pattern.md`          | Pattern A for F2 (set-delete undo).                                      |
...
4. `docs/05-design/design/redesign-v2/execution-status.md` — current progress.
5. `docs/05-design/design/redesign-v2/execution-plan.md` — intent / sequencing.
6. `docs/05-design/design/redesign-v2/governance.md` — governance.
7. `docs/05-design/design/redesign-v2/migration.md` — BEFORE/AFTER patterns.
