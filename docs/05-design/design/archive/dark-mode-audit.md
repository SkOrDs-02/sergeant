...
> **Last validated:** 2026-05-13 by @Codex. **Next review:** N/A (closed audit).
...
Наявні токени: `bg-success-soft`, `bg-warning-soft`, `bg-danger-soft`, `bg-info-soft` уже адаптуються per-theme — задокументовано в `docs/05-design/design/design-system.md` § 2.4.
...
- `dark:bg-white/5`, `dark:bg-white/10`, `dark:border-white/15` — патерн «barely-there glass-wash на dark-поверхні», задокументований у `docs/05-design/design/design-system.md` § 2.1; семантично «підвищити контраст на dark» — це коректно.
