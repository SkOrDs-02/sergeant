...
> **Last touched:** 2026-08-08 by @claude. **Next review:** 2027-02-13.
> **Status:** Active
...
3. **`-strong` — під `text-white`.** Сатуровані `-500`-shade-и регресують до ~2.4–2.8 : 1 проти білого. Див. [`docs/05-design/design/brandbook.md`](./brandbook.md) § WCAG-AA `-strong` Tier — повна per-family-таблиця контрасту.
