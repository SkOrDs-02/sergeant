...
Найважливіше правило цього файлу — [`apps/web/src/sw.ts`](../../../apps/web/src/sw.ts) не має форсувати активацію в `install`. Порушення цього інваріанта тихо вимикає всі чотири шари нижче, і саме так репо прожило до 2026-08-05:
