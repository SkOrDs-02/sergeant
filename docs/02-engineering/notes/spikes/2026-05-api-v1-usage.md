...
[`docs/02-engineering/architecture/api-v1.md`](../../architecture/api-v1.md). Видалити
...
2. сонячно догорить mobile beta (target за `docs/02-engineering/architecture/api-v1.md` —
...
- [`docs/02-engineering/architecture/api-v1.md`](../../architecture/api-v1.md) — як влаштоване версіонування.
