...
> **Last validated:** 2026-06-23 by @Skords-01. **Next review:** 2026-09-21.
> **Status:** Active
...
| ---- | ---------------------------- | --------- | ------- |
| 1    | `@sergeant/shared`           | 351       | 1       |
| 2    | `@sergeant/nutrition-domain` | 87        | 1       |
| 3    | `@sergeant/fizruk-domain`    | 81        | 1       |
| 4    | `@sergeant/routine-domain`   | 62        | 1       |
