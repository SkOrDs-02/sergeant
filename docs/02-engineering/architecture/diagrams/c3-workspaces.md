...
> **Last validated:** 2026-06-18 by @Skords-01. **Next review:** 2026-09-16.
> **Status:** Active
...
| ---- | ---------------------------- | --------- | ------- |
| 1    | `@sergeant/shared`           | 342       | 1       |
| 2    | `@sergeant/nutrition-domain` | 84        | 1       |
| 3    | `@sergeant/fizruk-domain`    | 64        | 1       |
| 4    | `@sergeant/routine-domain`   | 56        | 1       |
