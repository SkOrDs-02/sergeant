...
| `@sergeant/server`       | `apps/server`       | `active`    | Node 20 / TypeScript / Express `/api/v1/*` + `/api/v2/*`, Better Auth, Postgres, Anthropic tool-use, Voyage AI memory. Нові surfaces: billing (Stripe), transcribe (Whisper), waitlist, openclaw (GitHub App), alerts, observability, topic-archive. | [`docs/02-engineering/architecture/api-v1.md`](./api-v1.md), [`docs/tech-debt/backend.md`](../../tech-debt/backend.md), [`AGENTS.md`](../../../AGENTS.md)                                                                              |
...
| --------------- | ---------------------------------------- | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `billing`       | `apps/server/src/modules/billing/`       | `active`    | Stripe Checkout, Customer Portal, webhook, subscription state і plan limits. Поточна таблиця — `subscriptions`; старі згадки `billing_subscriptions` / migration 047 є історичними. | [`docs/02-engineering/architecture/api-v1.md`](./api-v1.md), [`docs/planning/pr-plan-revenue-2026-05.md`](../../planning/pr-plan-revenue-2026-05.md)                                                                                                     |
