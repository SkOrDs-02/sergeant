...
- [`docs/90-work/audits/2026-05-03-web-deep-dive/02-architecture-and-state.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-05-03-web-deep-dive/02-architecture-and-state.md) §2.1 — chatActions-як-другий-writer (audit findings)
- [`docs/90-work/audits/2026-05-13-web-architecture-state-roast.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-05-13-web-architecture-state-roast.md) — Roast #3/10 (this doc landed alongside it)
