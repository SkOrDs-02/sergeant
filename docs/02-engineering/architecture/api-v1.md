...
> **Last touched:** 2026-08-29 by @Skords-01. **Next review:** 2026-12-25.
> **Status:** Active
...
- **Sync v2 architecture:** [`docs/02-engineering/architecture/diagrams/c3-cloudsync.md`](./diagrams/c3-cloudsync.md)
- **Mobile API:** [`docs/02-engineering/mobile/overview.md`](../mobile/overview.md)
- **Architecture overview:** [`docs/02-engineering/architecture/service-catalog.md`](./service-catalog.md)
