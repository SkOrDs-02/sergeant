...
> **Last touched:** 2026-09-02 by @claude. **Next review:** 2027-03-22.
> **Status:** Active
      ...
      - name: Run drift checker
        ...
        run: |
          ...
          if [ -z "$STAGING_BASE_URL" ]; then
            echo "::error::STAGING_BASE_URL secret is not configured. See docs/02-engineering/testing/pact-drift-runbook.md § Setup."
            exit 2
          fi
        ...
        with:
          ...
          script: |
            ...
            const body = [
              ...
              '',
              'Follow [`docs/02-engineering/testing/pact-drift-runbook.md`](../../blob/main/docs/02-engineering/testing/pact-drift-runbook.md)',
              'for triage. TL;DR:',
              '',
...
- [`docs/02-engineering/architecture/api-contracts.md`](../architecture/api-contracts.md) — Pact pipeline overview, як додати новий endpoint.
