...
| 3   | Sync v2 + офлайн outbox                    | 🔵 In progress | 1                            | MMKV/SQLite outbox + `SyncEnginePushScheduler` + NetInfo flush-on-reconnect. v1 `useCloudSync` знятий (ADR-0047). Writer-wiring per module — див. [`2026-05-06-sync-engine-writer-wiring.md`](../../90-work/superpowers/plans/2026-05-06-sync-engine-writer-wiring.md). |
