...
> **Last touched:** 2026-08-04 by @Skords-01. **Next review:** 2027-03-06.
> **Status:** Active
...
| 3    | CloudSync v1 → Sync v2 (op-log + outbox) | 🔵 In progress | v1 client cut-over ([#2010](https://github.com/Skords-01/Sergeant/pull/2010)) + mobile engine drop ([`20793ad`](https://github.com/Skords-01/Sergeant/commit/20793adb)) + сервер `module_data` / v1 handlers видалено ([`75dcdd5`](https://github.com/Skords-01/Sergeant/commit/75dcdd5c)). Mobile writer-wiring трекає [plan 2026-05-06](../../90-work/superpowers/plans/archive/2026-05-06-sync-engine-writer-wiring.md). Деталі — Q13 + storage-roadmap Stage 5–7                                                                                                                                 |
...
- Push: `expo-notifications` + `PushRegistrar`-компонент, який після
  ...
  `POST /api/v1/push/register` (див. [`docs/02-engineering/mobile/overview.md`](./overview.md)).
...
- [`docs/02-engineering/mobile/overview.md`](./overview.md) +
  [`apps/mobile/docs/mobile.md`](../../../apps/mobile/docs/mobile.md) —
  API-контракт для мобілки: auth, deep links, push register,
  troubleshooting.
- [`docs/02-engineering/architecture/api-v1.md`](../architecture/api-v1.md) — опис
  `/api/v1/*` ендпоінтів.
- [`docs/05-design/design/brandbook.md`](../../05-design/design/brandbook.md) — вся візуальна
...
- **Sync v2 op-log на mobile.** Per-module dual-write адаптери
  ...
  **змонтований у boot-pipeline**:
  ...
  - виклик `bootSyncEngineWriter({ captureException: captureError })` у
    ...
    [`docs/90-work/superpowers/plans/2026-05-06-sync-engine-writer-wiring.md`](../../90-work/superpowers/plans/archive/2026-05-06-sync-engine-writer-wiring.md)
...
| 3   | Sync v2 + офлайн outbox                    | 🔵 In progress | 1                            | MMKV/SQLite outbox + `SyncEnginePushScheduler` + NetInfo flush-on-reconnect. v1 `useCloudSync` знятий (ADR-0047). Writer-wiring per module — див. [`2026-05-06-sync-engine-writer-wiring.md`](../../90-work/superpowers/plans/archive/2026-05-06-sync-engine-writer-wiring.md).                                     |
...
- Дизайн-патерни — секція «Native Patterns (iOS / Android)» у
  [`docs/05-design/design/brandbook.md`](../../05-design/design/brandbook.md) (PR
...
- Deep-links — таблиця у [`docs/02-engineering/mobile/overview.md`](./overview.md)
  § «Deep links».
...
- Payload — платформо-агностичний (один `PushPayload` shape, сервер
  ...
  [`docs/02-engineering/mobile/overview.md` § Push](./overview.md#push-notifications).
