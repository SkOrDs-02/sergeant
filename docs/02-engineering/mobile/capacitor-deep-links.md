...
> **Last validated:** 2026-06-09 by @claude. **Next review:** 2027-01-08.
> **Status:** Active
...
- **Custom scheme** (`com.sergeant.shell://scan`) — працював і раніше
  ...
  `apps/mobile-shell/src/index.ts` і `docs/02-engineering/architecture/platforms.md`.
...
Поточні hosts (див. `docs/02-engineering/mobile/overview.md` секція CORS — «prod»):
