...
Реалізація: [`apps/server/src/modules/alerts/telegramShipper.ts`](../../../apps/server/src/modules/alerts/telegramShipper.ts) + міграція [`060_tg_alert_acks_dedup_signature.sql`](../../../apps/server/src/migrations/060_tg_alert_acks_dedup_signature.sql). Roadmap-контекст: [`docs/01-product/launch/tech/telegram-improvements-roadmap.md` §4.2](../../01-product/launch/archive/tech/telegram-improvements-roadmap.md), [`docs/90-work/planning/sprint-roadmap-q2q3-2026.md` §1.2 B.1](../../90-work/planning/archive/sprint-roadmap-q2q3-2026.md).
