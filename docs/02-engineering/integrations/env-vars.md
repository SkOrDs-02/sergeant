...
> **Last touched:** 2026-08-29 by @Skords-01. **Next review:** 2026-12-13.
> **Status:** Active
...
| `UPCITEMDB_BASE_URL`    | `https://api.upcitemdb.com/prod/trial`      | Третє джерело каскаду штрихкодів. Дефолт — **тріал: 100 req/добу на весь продукт**, не на користувача. До 2026-07-25 був захардкоджений і не задокументований. Заміна — крок 2 у [дослідженні джерел](../../90-work/research/2026-07-25-barcode-sources-and-moderation.md).                                                                                     |
...
Дивись [`docs/04-governance/security/hardening/H6-email-verification.md`](../../04-governance/security/hardening/archive/H6-email-verification.md).
...
[Hardening карта H9](../../04-governance/security/hardening/archive/H9-transcribe-usd-cap.md) — per-user-per-day USD cap на `/api/transcribe`, у _micros_ (1 USD = 1_000_000 micros).
...
`CSP_DISABLE` видалено в M1 — дивись [`docs/04-governance/security/hardening/M1-csp-disable-runtime-flag.md`](../../04-governance/security/hardening/archive/M1-csp-disable-runtime-flag.md). Для швидкого вимкнення CSP без блокувань — `CSP_REPORT_ONLY=1`.
...
Дивись [`apps/mobile/src/lib/observability/posthog.ts`](../../../apps/mobile/src/lib/observability/posthog.ts) і [`docs/01-product/launch/product-os/ftux-sprint-plan.md`](../../01-product/launch/archive/product-os/ftux-sprint-plan.md) §S0.3.
...
Реалізація: [`apps/server/src/modules/alerts/telegramShipper.ts`](../../../apps/server/src/modules/alerts/telegramShipper.ts) + міграція [`060_tg_alert_acks_dedup_signature.sql`](../../../apps/server/src/migrations/060_tg_alert_acks_dedup_signature.sql). Roadmap-контекст: [`docs/01-product/launch/tech/telegram-improvements-roadmap.md` §4.2](../../01-product/launch/archive/tech/telegram-improvements-roadmap.md), [`docs/90-work/planning/sprint-roadmap-q2q3-2026.md` §1.2 B.1](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/planning/archive/sprint-roadmap-q2q3-2026.md).
