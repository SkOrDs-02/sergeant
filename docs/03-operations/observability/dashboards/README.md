...
> **Last touched:** 2026-08-07 by @Skords-01. **Next review:** 2026-11-14.
> **Status:** Active
...
Жодних додаткових темплейт-змінних, окрім `DS_PROMETHEUS`. Усі SLI-запити посилаються на попередньо обчислені recording rules з `docs/03-operations/observability/prometheus/recording_rules.yml`.
