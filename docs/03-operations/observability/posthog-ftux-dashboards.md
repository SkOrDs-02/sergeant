...
> transport · [`docs/01-product/launch/product-os/ftux-sprint-plan.md` §2](../../01-product/launch/archive/product-os/ftux-sprint-plan.md#2-sprint-0--analytics-live-1-тиждень)
> — Sprint 0 deliverable spec (this doc is **S0.5**) ·
> [`docs/01-product/launch/business/01-monetization-and-pricing.md` §7](../../01-product/launch/business/01-monetization-and-pricing.md)
...
[`ftux-sprint-plan.md` §8](../../01-product/launch/archive/product-os/ftux-sprint-plan.md#8-roll-up-success-metrics-dashboard)) ·
...
[`ftux-sprint-plan.md` §5](../../01-product/launch/archive/product-os/ftux-sprint-plan.md#5-sprint-3--reward-у-правильний-момент--value-progress-2-тижні))
needs to ship.
...
- **Mobile parity (S0.3).** Until `apps/mobile` writes to PostHog
  (planned in
  [`ftux-sprint-plan.md` §2](../../01-product/launch/archive/product-os/ftux-sprint-plan.md#2-sprint-0--analytics-live-1-тиждень)
