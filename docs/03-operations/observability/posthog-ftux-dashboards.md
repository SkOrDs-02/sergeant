...
> transport · [`docs/01-product/launch/product-os/ftux-sprint-plan.md` §2](../../01-product/launch/product-os/ftux-sprint-plan.md#2-sprint-0--analytics-live-1-тиждень)
...
| `hint_dismissed`                 | Контракт збережено в [`analyticsEvents.ts`](../../../packages/shared/src/lib/analyticsEvents.ts); активного emitter після видалення hint-orchestrator немає                                                                                                                                                                                                 | `id: string`, `via: "timeout"` (contract reserves `"x" \| "swipe"` for explicit dismiss UI)                                                                                                                                                           |
| `hint_completed`                 | Контракт збережено в [`analyticsEvents.ts`](../../../packages/shared/src/lib/analyticsEvents.ts); активного emitter після видалення hint-orchestrator немає                                                                                                                                                                                                 | `id: string`, `via: "action"`                                                                                                                                                                                                                         |
...
[`ftux-sprint-plan.md` §8](../../01-product/launch/product-os/ftux-sprint-plan.md#8-roll-up-success-metrics-dashboard)) ·
...
[`ftux-sprint-plan.md` §5](../../01-product/launch/product-os/ftux-sprint-plan.md#5-sprint-3--reward-у-правильний-момент--value-progress-2-тижні))
needs to ship.
...
- **Mobile parity (S0.3).** Until `apps/mobile` writes to PostHog
  (planned in
  [`ftux-sprint-plan.md` §2](../../01-product/launch/product-os/ftux-sprint-plan.md#2-sprint-0--analytics-live-1-тиждень)
