...
> **Last touched:** 2026-08-04 by @Skords-01. **Next review:** 2026-11-12.
> **Status:** Active
...
- Алерти: `DbPoolWaitingSustained` (5m, ticket) і `DbPoolSaturated` (10m, page) —
  у [`docs/03-operations/observability/prometheus/alert_rules.yml`](./prometheus/alert_rules.yml).
...
- Read-replica pool sizing — у [`docs/03-operations/runbooks/postgres-read-replica.md`](../runbooks/postgres-read-replica.md).
