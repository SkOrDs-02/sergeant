...
> **Last touched:** 2026-08-31 by @Skords-01. **Next review:** 2026-12-13.
> **Status:** Active
...
5. **Якщо Mend off-line > 7 днів:** відкривай incident у `docs/03-operations/postmortems/` (template є). Розгляд Option 1/2 з ADR-0044 — переключитися на Dependabot повністю або шукати альтернативу (Renovate Self-Hosted, GitHub Renovate Action).
