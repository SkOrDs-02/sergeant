...
| -------------- | ------------------------------ | -------------------------------------------------------------------- | ------------------------------------------------ | ----------------------------------------------------------------------------------------------------- |
| **Deploy-doc** | `docs/03-operations/deploy/`   | Налаштовуєш платформу або вперше деплоїш поверхню                    | Інженер, що конфігурує Coolify / Vercel          | Новий файл у `deploy/`, рядок у [`deploy/README.md`](./deploy/README.md)                              |
