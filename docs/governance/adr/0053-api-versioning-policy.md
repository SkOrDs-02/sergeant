...
- **Related:**
  ...
  - [`docs/engineering/architecture/api-v1.md`](../../engineering/architecture/api-v1.md)
  - [`docs/work/specs/initiatives/stack-pulse-2026-05/pr-08-api-versioning-consolidation.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/stack-pulse-2026-05/archive/pr-08-api-versioning-consolidation.md)
  - [`docs/engineering/notes/spikes/2026-05-api-v1-usage.md`](../../engineering/notes/spikes/2026-05-api-v1-usage.md)
...
- Web (за замовчуванням), mobile (примусово), mobile-shell і `@sergeant/api-client`
  усі шлють у `/api/v1/*`. Деталі — у [spike `2026-05-api-v1-usage.md`](../../engineering/notes/spikes/2026-05-api-v1-usage.md).
...
4. **Видалення legacy `/api/*`-префікса** дозволено лише після:
   - mobile beta-rollout-у завершено (`docs/engineering/architecture/api-v1.md` #FAQ);
...
- Plain `/api/*` ↔ `/api/v1/*` mirror створює оманливе враження про
  ...
  `docs/engineering/architecture/api-v1.md` + ADR-цей.
...
- Завершення mobile beta-rollout-у (target 2026-Q4 за `docs/engineering/architecture/api-v1.md`).
