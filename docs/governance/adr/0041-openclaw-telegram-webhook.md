...
- **Related:**
  ...
  - [`docs/work/specs/launch/tech/openclaw-roadmap.md` §3.5](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/01-product/launch/archive/tech/openclaw-roadmap.md) — pain "approval-кнопки 2-3 с".
  - [`docs/operations/deploy/openclaw.md`](../../operations/deploy/openclaw.md) — Railway env vars + healthcheck.
...
- Set Railway env vars on `sergeant-openclaw` service (renamed from `sergeant-hubchat` per ADR-0032 / Pain P10; per `docs/operations/deploy/openclaw.md`).
...
Activated on Railway service `sergeant-openclaw` (project `humorous-eagerness`, environment `production`; service was renamed from `sergeant-hubchat` per ADR-0032 / Pain P10 — see `docs/operations/deploy/openclaw.md` rename runbook):
...
- `docs/operations/deploy/openclaw.md` lists all required env vars and the new `GET /healthz` Railway healthcheck.
- governance-sync CI keeps this ADR linked from `docs/work/specs/launch/tech/openclaw-roadmap.md` §3.5.
