...
- **Status:** Superseded by [ADR-0053](./0053-api-versioning-policy.md)
...
- **Related:**
  ...
  - [`docs/engineering/architecture/api-v1.md`](../../engineering/architecture/api-v1.md) — operational reference.
  - [`docs/governance/adr/0017-better-auth-choice-and-session-model.md`](./0017-better-auth-choice-and-session-model.md) — чому `/api/auth/*` поза версіонуванням.
...
- Якщо коли-небудь будемо breaking-change-ити auth-flow, потрібно зробити
  ...
  Documented у `docs/engineering/architecture/api-v1.md` § FAQ.
...
- Cognitive overhead: розробники мусять знати про обидва префікси.
  Mitigation: `docs/engineering/architecture/api-v1.md` як onboarding.
