...
- **Related:**
  ...
  - [`docs/start/instructions/add-sql-migration.md`](../../start/instructions/add-sql-migration.md) — authoring how-to.
  - [`docs/start/instructions/pre-merge-migration-checklist.md`](../../start/instructions/pre-merge-migration-checklist.md) — review-чек-лист.
