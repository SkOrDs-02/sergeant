...
3. **Stabilization-PR-template** у `docs/start/instructions/stabilize-flaky-test.md` — чек-ліст: відтворення локально (loop 100×), root cause, fix, переконатися що 200 запусків поспіль зелені.
