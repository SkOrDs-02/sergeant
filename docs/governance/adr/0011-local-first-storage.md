...
- **Related:**
  ...
  - [Storage roadmap §Stage 4 (per-module SQLite mirror)](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/planning/archive/storage-roadmap.md) і §Stage 7 (cleanup, drop `module_data` blob) — реалізують перехід.
  - [`docs/engineering/architecture/data-exchange-storage-audit.md`](../../engineering/architecture/data-exchange-storage-audit.md) — поточний знімок архітектури (валідовано 2026-05-08).
  - [`docs/engineering/mobile/react-native-migration.md`](../../engineering/mobile/react-native-migration.md) §6 — mobile sync-subsystem.
...
| Аспект                  | Оригінально (цей ADR)                                                                    | Поточний стан (2026-07)                                                                                                                                                                                                                       |
| ----------------------- | ---------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
