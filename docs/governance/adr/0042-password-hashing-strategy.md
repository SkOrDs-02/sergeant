...
- **Supersedes:** —
- **Related:**
  - [`docs/work/specs/initiatives/stack-pulse-2026-05/pr-03-bcrypt-password-limit.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/stack-pulse-2026-05/archive/pr-03-bcrypt-password-limit.md) — original PR-план (premised on bcrypt; superseded by this ADR).
  - [ADR-0017](./0017-better-auth-choice-and-session-model.md) — вибір Better Auth.
  - [`docs/engineering/integrations/env-vars.md`](../../engineering/integrations/env-vars.md) — `MIN_/MAX_PASSWORD_LENGTH` опис.
...
- `docs/engineering/integrations/env-vars.md` — згадка про bcrypt 72-byte limit
...
- `docs/engineering/integrations/env-vars.md`: розділ `MIN_/MAX_PASSWORD_LENGTH` оновлено з `72 (bcrypt limit)` → `256 (DoS cap, scrypt-based)`. Лінк на цей ADR.
