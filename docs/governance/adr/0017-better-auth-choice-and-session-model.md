...
- **Related:**
  ...
  - [`docs/governance/adr/0016-user-deletion-and-pii-handling.md`](./0016-user-deletion-and-pii-handling.md) — взаємодія з deleteUser-flow.
  - [`docs/governance/adr/0018-api-versioning-policy.md`](./0018-api-versioning-policy.md) — чому `/api/auth/*` поза версіонуванням.
...
([`docs/governance/security/better-auth-audit-2026-05.md`](../security/better-auth-audit-2026-05.md))
