...
- **Related:**
  - [`docs/work/specs/initiatives/stack-pulse-2026-05/pr-22-mobile-expo-sdk-53.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/stack-pulse-2026-05/archive/pr-22-mobile-expo-sdk-53.md) — source PR plan (M6 finding)
...
- Bump does not merge until: Detox iOS + Android green on SDK 53 (New-Arch ON), EAS Preview 7-day soak on ≥3 testers with no critical regressions, clean `pnpm install` (patch resolved), and `docs/engineering/mobile/sdk-version-history.md` updated — per the PR-22 DoD checklist.
...
- [`docs/work/specs/initiatives/stack-pulse-2026-05/pr-22-mobile-expo-sdk-53.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/stack-pulse-2026-05/archive/pr-22-mobile-expo-sdk-53.md) — source plan + acceptance criteria
