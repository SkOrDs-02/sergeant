...
- **Supersedes:** —
- **Related:**
  - [`docs/work/specs/initiatives/archive/_0014-knowledge-graph-and-catalogs.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/_0014-knowledge-graph-and-catalogs.md) §Phase 2
  ...
  - [`docs/governance/governance/schemas/symbol-catalog.schema.json`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/04-governance/governance/schemas/symbol-catalog.schema.json)
...
- Output: `<workspace>/symbols.json` (per-package) + `docs/governance/governance/symbol-index.{json,html}` (aggregated).
