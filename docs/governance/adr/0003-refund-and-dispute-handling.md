...
- **Supersedes:** —
- **Related:**
  - [`docs/governance/adr/0001-monetization-architecture.md`](./0001-monetization-architecture.md) — ADR-1.1 (Stripe primary), ADR-1.8 (webhook event-id retention), ADR-1.11 (cancel-at-period-end).
  - [`docs/work/specs/launch/business/01-monetization-and-pricing.md`](../../work/specs/launch/business/01-monetization-and-pricing.md) — тіри і ціни (Pro **₴199/міс**, **₴1490/рік** per ADR-0068).
  - [`docs/work/specs/launch/business/06-monetization-architecture.md`](../../work/specs/launch/business/06-monetization-architecture.md) — risk register #8 («нічого про refund / proration»).
...
- Anti-fraud за замовчуванням: founder бачить контекст (як давно юзер,
  ...
  email +1).
- Refund policy документ один — той, що в `docs/work/specs/launch/legal/refund.md`
  (TBD; писати разом з Privacy Policy).

**Негативні:**

- 24h SLA на support — хто його закриває коли founder спить? Документуємо
  у `docs/work/specs/launch/business/05-operations-and-automation.md` як "support manual,
...
- **Refund policy document.** Окремий артефакт у `docs/work/specs/launch/legal/refund.md`
