...
- **Supersedes:** —
- **Related:**
  - [`docs/governance/governance/harness-versioning.md`](../governance/harness-versioning.md) — operational rules and bump matrix
  - [`.agents/harness-versions.json`](../../../.agents/harness-versions.json) — version registry (шлях з 2026-08-28, [ADR-0088](./0088-devin-kilo-harness-retirement.md); історично `.kilo/harness-versions.json`)
  - [`scripts/ci-bump-harness-version.mjs`](../../../scripts/ci-bump-harness-version.mjs) — local PR-time bumper
  - [`docs/governance/adr/0067-engagement-mechanism-standardization.md`](./0067-engagement-mechanism-standardization.md) — прецедент централізованого реєстру
  - [`docs/governance/adr/0021-memory-bank.md`](./0021-memory-bank.md) — прецедент персистентного cross-session state
...
2. **Bump policy** (see governance doc for the full matrix):
   - **major** — any Hard Rule file changes (rules under `docs/governance/governance/rules/`) or any breaking edit to AGENTS.md that invalidates a prior reading.
