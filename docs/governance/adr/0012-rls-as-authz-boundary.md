...
- **Deciders:** @Skords-01
- **Supersedes:** —
- **Related:** [`apps/server/src/http/requireSession.ts`](../../../apps/server/src/http/requireSession.ts), [`apps/server/src/auth.ts`](../../../apps/server/src/auth.ts), [ADR-0011](./0011-local-first-storage.md), [`docs/governance/security/audit-exceptions.md`](../security/audit-exceptions.md)
