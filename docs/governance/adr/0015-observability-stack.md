...
- **Supersedes:** —
- **Related:**
  - [`docs/operations/observability/SLO.md`](../../operations/observability/SLO.md) — SLI/SLO і burn-rate алерти.
  - [`docs/operations/observability/dashboards.md`](../../operations/observability/dashboards.md) — Grafana стартер-пак.
  - [`docs/operations/observability/runbook.md`](../../operations/observability/runbook.md) — playbook на алерти.
...
[`prometheus/alert_rules.yml`](../../operations/observability/prometheus/alert_rules.yml) +
визначено у [`docs/operations/observability/SLO.md`](../../operations/observability/SLO.md):
...
[`SLO.md#7-process`](../../operations/observability/SLO.md#7-process-рівня-не-slo-hard-alerts)).
...
- Складніший mental model для нової людини. Runbook
  ([`docs/operations/observability/runbook.md`](../../operations/observability/runbook.md)) пояснює.
