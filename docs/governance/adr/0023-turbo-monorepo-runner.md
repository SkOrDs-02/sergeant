...
- [`docs/work/specs/audits/archive/2026-04-26-sergeant-audit-devin.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-04-26-sergeant-audit-devin.md) — пункт 10 ("Turbo вже добре працює на цьому масштабі").
