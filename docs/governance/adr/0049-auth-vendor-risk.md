...
- **Related:**
  ...
  - [`docs/governance/security/better-auth-crypto-review.md`](../security/better-auth-crypto-review.md)
  - [`docs/work/specs/initiatives/stack-pulse-2026-05/pr-10-better-auth-security-review.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/stack-pulse-2026-05/archive/pr-10-better-auth-security-review.md)
  - [`docs/work/specs/security-hardening/H4-encryption-key-rotation.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H4-encryption-key-rotation.md)
...
- **PR-48** додає `docs/governance/security/better-auth-crypto-review.md` з періодичним
