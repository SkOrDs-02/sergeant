...
- Дві конфігурації в репо. Майбутні зміни treba робити двічі (одну в Renovate, дзеркальну в Dependabot security-only). Митиґація — ADR + `docs/engineering/integrations/renovate-usage.md` посилається на цей ADR.
...
- `docs/engineering/integrations/renovate-usage.md` — оновлено з лінком на цей ADR.
- `docs/work/specs/security-hardening/H2-dependabot.md` — статус оновлено: «scope reduced to security-only per ADR-0044».
