...
- **Related:**
  ...
  - [`docs/work/specs/launch/tech/openclaw-roadmap.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/01-product/launch/archive/tech/openclaw-roadmap.md) — phasing + scope.
  - [`docs/work/specs/launch/business/05-operations-and-automation.md`](../../work/specs/launch/business/05-operations-and-automation.md) — operations architecture.
...
5. **Strategy-docs ownership — завжди suggest-PR.**
   - OpenClaw ніколи не commit-ить напряму у `docs/strategy/`,
     `docs/work/specs/launch/`, або `docs/governance/adr/`.
...
| `read_strategy_docs`          | read           | filesystem (server-side)  | path-allowlist (`docs/strategy/`, `docs/work/specs/launch/`, `docs/governance/adr/`) |
...
- [ ] Update `docs/work/specs/launch/tech/openclaw-roadmap.md` §4.3 → Resolved decisions
      (link до цього ADR).
...
- [`docs/work/specs/launch/tech/openclaw-roadmap.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/01-product/launch/archive/tech/openclaw-roadmap.md)
