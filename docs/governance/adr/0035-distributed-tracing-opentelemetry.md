...
- **Related:**
  ...
  - [`docs/operations/observability/frontend.md`](../../operations/observability/frontend.md) §7 «Sentry-події не з'єднані» — поточний gap.
  ...
  - [`docs/work/specs/audits/archive/2026-04-28-sergeant-comprehensive-audit.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-04-28-sergeant-comprehensive-audit.md) §P3-2 — audit row.
...
`docs/operations/observability/frontend.md:451` має TODO: «додати `x-request-id` header у fetch-клієнт». Half-fix — додати `requestId`. Full-fix — додати W3C `traceparent` (включає `requestId` як trace-id + parent span context).
...
- Audit row: [`docs/work/specs/audits/archive/2026-04-28-sergeant-comprehensive-audit.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-04-28-sergeant-comprehensive-audit.md) §P3-2.
