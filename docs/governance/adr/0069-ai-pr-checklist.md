...
- **Supersedes:** —
- **Related:**
  - [`docs/governance/governance/ai-pr-checklist.md`](../governance/ai-pr-checklist.md) — user-facing doc
...
- [x] `docs/governance/governance/ai-pr-checklist.md` створено
- [x] ADR `0069-ai-pr-checklist.md` створено (цей файл)
- [x] `docs/governance/pr-ledger/index.json` оновлено (Hard Rule #26) — deferred до merge (schema вимагає non-null `merged_at` і `number >= 1`; PR ще не змерджений на момент написання ADR)
