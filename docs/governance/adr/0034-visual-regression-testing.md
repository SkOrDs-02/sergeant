...
- **Related:**
  ...
  - [`docs/work/specs/audits/archive/2026-04-28-sergeant-comprehensive-audit.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-04-28-sergeant-comprehensive-audit.md) §P3-1 — audit row, що тригернув формалізацію.
...
- **CI:** workflow `visual-regression.yml` наразі тригериться лише через `workflow_dispatch` (manual). Автоматичні тригери (`push: main` + `pull_request:`) свідомо вимкнені, доки Argos baseline не bulk-approved у Argos UI (див. disable-note в шапці workflow). Тому відсутність screenshot-job-у на PR зараз — **очікувана**, не підозріла; запускай вручну (`gh workflow run visual-regression.yml`) при потребі звірити visual diff. Re-enable PR-тригера — разом із поверненням `continue-on-error: false`.
...
- Audit row: [`docs/work/specs/audits/archive/2026-04-28-sergeant-comprehensive-audit.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-04-28-sergeant-comprehensive-audit.md) §P3-1.
