...
- **Supersedes:** —
- **Related:**
  - [`docs/product/modules/fizruk.md`](../../product/modules/fizruk.md) — канон fizruk §3, §10.
  - [`docs/product/modules/nutrition.md`](../../product/modules/nutrition.md) — TDEE/BMR споживають вагу.
  ...
  - [`docs/work/specs/audits/product-knowledge-fizruk.md`](../../work/specs/audits/product-knowledge-fizruk.md) § C3/D-3.
