...
- **Related:**
  - <!-- e.g. [`docs/work/specs/launch/business/06-monetization-architecture.md`](../../work/specs/launch/business/06-monetization-architecture.md) -->
...
<!-- How do we verify that the decision is being followed?
     ...
     playbook `docs/start/instructions/add-hubchat-tool.md`, manual review checklist. -->
