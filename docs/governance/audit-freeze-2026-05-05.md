...
- `docs/launch/`, `docs/03-operations/observability/`, `docs/integrations/`, `docs/architecture/`, `docs/05-design/design/`, `docs/agents/`, **не** заморожуються — це функціональна документація, що часто синкається з shipped code.
