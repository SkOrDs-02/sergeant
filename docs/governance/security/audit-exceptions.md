...
| Field      | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Advisory   | https://github.com/advisories/GHSA-jmr9-qjv8-65gv (CVE-2026-56876) і https://github.com/advisories/GHSA-7pqw-9j4j-h8q3 — той самий дефект symlink-розпакування, розписаний upstream-ом двома записами (traversal при читанні / довільний запис файлів)                                                                                                                                                                                                                           |
| Package    | `extract-zip@2.0.1`; вразливі `<=2.0.1` — тобто **всі опубліковані версії, включно з останньою**                                                                                                                                                                                                                                                                                                                                                                                 |
| Severity   | high (CVSS 8.1 обидва) — розпакування архіву не валідує symlink-и, тож підготовлений zip може записати файл поза цільовою текою                                                                                                                                                                                                                                                                                                                                                  |
...
| Due date   | 2026-11-30 — переоцінити обидва id разом, коли upstream опублікує `extract-zip` з фіксом або коли `@lhci/cli` перейде на новіший `puppeteer-core` без цього транзитива. Якщо ні того, ні того — підняти окремим `security:medium` issue, не продовжувати виняток мовчки.                                                                                                                                                                                                         |
| Owner      | @SkOrDs-02                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
