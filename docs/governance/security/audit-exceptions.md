...
### extract-zip — path traversal через невалідований symlink (GHSA-JMR9-QJV8-65GV / CVE-2026-56876, GHSA-7PQW-9J4J-H8Q3)

| Field      | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Advisory   | https://github.com/advisories/GHSA-jmr9-qjv8-65gv (CVE-2026-56876) і https://github.com/advisories/GHSA-7pqw-9j4j-h8q3 — друге advisory на ту саму ваду («arbitrary file writes through symlink archive entries»), опубліковане окремо; той самий пакет, той самий вразливий діапазон `<=2.0.1`, той самий порожній `patched_versions`, тож виняток покриває обидва id.                                                                                                          |
| Package    | `extract-zip@2.0.1`; вразливі `<=2.0.1` — тобто **всі опубліковані версії, включно з останньою**                                                                                                                                                                                                                                                                                                                                                                                 |
| Severity   | high — розпакування архіву не валідує symlink-и, тож підготовлений zip може записати файл поза цільовою текою                                                                                                                                                                                                                                                                                                                                                                    |
...
| Due date   | 2026-11-30 — переоцінити, коли upstream опублікує `extract-zip` з фіксом або коли `@lhci/cli` перейде на новіший `puppeteer-core` без цього транзитива. Якщо ні того, ні того — підняти окремим `security:medium` issue, не продовжувати виняток мовчки.                                                                                                                                                                                                                         |
| Owner      | @SkOrDs-02                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
