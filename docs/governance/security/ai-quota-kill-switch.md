...
> **Last touched:** 2026-09-11 by @claude. **Next review:** 2027-10-16.
> **Status:** Active
...
4. Канонічний приклад значень — `docs/engineering/integrations/env-vars.md`
...
- ADR-0022 — `docs/governance/adr/0022-atomic-sql-quotas.md` (ADR-12.3: buckets
  `default` vs `tool:<name>`, atomic UPSERT-гейт).
- ADR-0042 — `docs/governance/adr/0042-password-hashing-strategy.md` (similar
