...
| Field        | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Initiative   | [`0011`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/_0011-foundation-adoption-and-process-discipline.md) Phase 3 PR 3.1                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Cards        | [H5](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H5-trusted-origins-exp-scheme.md), [H6](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H6-email-verification.md), [H8](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H8-corp-per-route.md), [H9](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H9-transcribe-usd-cap.md) |
...
Each card under `docs/work/specs/security-hardening/` carries a `Status: Closed` badge and
...
[0011 Phase 3](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/_0011-foundation-adoption-and-process-discipline.md#фаза-3--hardening-verification-для-launch-readiness--2-тижні-2026-06-23--2026-07-07-поста-0010-launch)
...
Use this document together with [`docs/start/instructions/security-pen-test-checklist.md`](../../../start/instructions/security-pen-test-checklist.md)
...
**Reference:** [`docs/work/specs/security-hardening/H5-trusted-origins-exp-scheme.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H5-trusted-origins-exp-scheme.md), PR #1604.
...
**Reference:** [`docs/work/specs/security-hardening/H6-email-verification.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H6-email-verification.md), PR #1608.
...
- Legacy users with `email_verified=false` still exist in the prod DB.
  ...
  plan is documented at `docs/work/specs/launch/email-verification-sweep.md` (created
...
**Reference:** [`docs/work/specs/security-hardening/H8-corp-per-route.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H8-corp-per-route.md), PR #1606.
...
**Reference:** [`docs/work/specs/security-hardening/H9-transcribe-usd-cap.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H9-transcribe-usd-cap.md), PRs #1567 and #1613.
...
- [ ] PR 3.4 (`docs/work/specs/launch/email-verification-sweep.md` — added by that PR)
      closes the H6 legacy-user residual risk before the global flag flips
      to `true`.

## Related documents

- [`docs/start/instructions/security-pen-test-checklist.md`](../../../start/instructions/security-pen-test-checklist.md) — the recipe that points to this transcript
- [`docs/work/specs/security-hardening/README.md`](../../../work/specs/security-hardening/README.md) — full hardening backlog
- [`docs/governance/security/disaster-recovery.md`](../disaster-recovery.md) — recovery posture for security incidents
- [`docs/work/specs/initiatives/archive/_0011-foundation-adoption-and-process-discipline.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/_0011-foundation-adoption-and-process-discipline.md) — owning initiative
