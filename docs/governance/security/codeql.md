...
[`hardening/M11-eslint-plugin-security.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/M11-eslint-plugin-security.md))
...
4. Baseline ≤ 5 алертів (audit verification): якщо перший scheduled run
   ...
   sprint-у згідно з [`hardening/I1-codeql-workflow.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/I1-codeql-workflow.md).
