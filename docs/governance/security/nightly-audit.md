...
> **Last touched:** 2026-09-11 by @claude. **Next review:** 2027-11-29.
> **Status:** Active
...
1. Задокументуй виняток у [docs/governance/security/audit-exceptions.md](./audit-exceptions.md) — з `Due date`.
...
- [docs/governance/security/audit-exceptions.md](./audit-exceptions.md) — винятки з аудиту.
- [docs/governance/security/vulnerability-sla.md](./vulnerability-sla.md) — SLA-матриця.
