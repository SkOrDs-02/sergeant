...
> **Last touched:** 2026-09-11 by @claude. **Next review:** 2027-11-06.
> **Status:** Active
...
| Coolify / Hetzner production admin         | `Tier 1` | Founder | Founder, core engineer                       | Can deploy API, mutate env, reach prod DB and VPS resources  | Coolify account + restricted VPS access                | Biweekly       |
