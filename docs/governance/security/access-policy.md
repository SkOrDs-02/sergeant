...
- Access grant: [access-governance.md § Grant privileged access](../../start/instructions/access-governance.md#1-grant-privileged-access)
- Access revoke: [access-governance.md § Revoke privileged access](../../start/instructions/access-governance.md#2-revoke-privileged-access)
- Access review: [access-governance.md § Periodic access review](../../start/instructions/access-governance.md#3-periodic-access-review)
- Suspected compromise: [access-governance.md § Suspected account compromise](../../start/instructions/access-governance.md#4-suspected-account-compromise)

## Runtime security knobs

- **No runtime CSP kill switch.** As of 2026-05-04 ([M1](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/M1-csp-disable-runtime-flag.md)),
