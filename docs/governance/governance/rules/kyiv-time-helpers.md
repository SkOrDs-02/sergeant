...
[`metric-registry.md § Часовий шов`](../../../engineering/architecture/metric-registry.md).

## Cross-refs

- [ADR-0078](../../adr/0078-day-boundary-device-local.md) — межа доби за пристроєм (рішення)
- [`docs/engineering/architecture/domain-invariants.md`](../../../engineering/architecture/domain-invariants.md) — інваріанти часу після ADR-0078
- [`apps/web/src/shared/lib/time/kyivTime.ts`](../../../../apps/web/src/shared/lib/time/kyivTime.ts) — реалізація Kyiv-хелперів
- [`docs/work/specs/audits/2026-05-13-page-audit-03-hub-chat-search.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-05-13-page-audit-03-hub-chat-search.md) F1/F2/F8 — перший кластер порушень, що породив правило
- [`docs/work/specs/audits/2026-05-13-page-audit-09-routine-strategy.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/audits/archive/2026-05-13-page-audit-09-routine-strategy.md) F3 — кластер `setHours(12,…)` у Routine
