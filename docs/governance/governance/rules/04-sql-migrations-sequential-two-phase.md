...
Authoring walkthrough + failure-mode catalog: [`docs/start/instructions/operations-runbook.md § 8.2`](../../../start/instructions/operations-runbook.md#82-two-phase-drop-authoring).
