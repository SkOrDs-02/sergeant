...
- `docs/governance/governance/rules/**` (Hard Rules)
...
| `docs/governance/governance/rules/<N>-*.md`        | `major` | Hard Rule changed; can break prior agent reasoning    |
...
| `docs/governance/governance/harness-versioning.md` | `patch` | this doc's own typos/links                            |
