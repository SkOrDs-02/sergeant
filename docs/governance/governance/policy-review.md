...
1. На початку кожного місяця копіюємо цей файл як
   `docs/governance/governance/reviews/YYYY-MM-policy-review.md`.
...
- `docs/governance/security/audit-exceptions.md` — активні винятки `audit-exception`.
- `docs/work/specs/tech-debt/frontend.md`, `docs/work/specs/tech-debt/backend.md` — burn-down trend.
...
Джерело: `docs/governance/security/audit-exceptions.md`.
