...
2. Rotate impacted credentials.
   - use [rotate-secrets.md](../../start/instructions/rotate-secrets.md) when secret rotation is involved
3. Capture evidence.
   - vendor audit logs
   - timestamps
...
- [access-governance.md § Suspected account compromise](../../start/instructions/access-governance.md#4-suspected-account-compromise)
- [rotate-secrets.md](../../start/instructions/rotate-secrets.md)
- [write-postmortem.md](../../start/instructions/write-postmortem.md)
