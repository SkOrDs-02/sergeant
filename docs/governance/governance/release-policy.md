...
1. Identify the primary surface in [service-catalog.md](../../engineering/architecture/service-catalog.md).
...
- [release.md](../../start/instructions/release.md) — canonical merged playbook (web + API, Capacitor shell, Expo) with decision tree.
