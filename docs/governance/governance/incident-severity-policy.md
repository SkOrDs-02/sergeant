...
If none of those are true yet, start with [investigate-alert.md](../../start/instructions/investigate-alert.md).
...
- affected surface from [service-catalog.md](../../engineering/architecture/service-catalog.md)
- severity
- current impact
...
Use [write-postmortem.md](../../start/instructions/write-postmortem.md) and file the record through [postmortems/INDEX.md](../../operations/postmortems/INDEX.md).
