...
`docs/architecture/domain-invariants.md` declares **Europe/Kyiv** as the
...
- [`docs/architecture/domain-invariants.md`](../../architecture/domain-invariants.md) — Europe/Kyiv invariant
