...
> **Pointer.** Implementation: [`apps/server/src/http/rateLimit.ts`](../../apps/server/src/http/rateLimit.ts). Failure-mode rules: [`docs/security/rate-limit-failure-mode.md`](../security/rate-limit-failure-mode.md). Diagnostic that triggered the cost-multiplier: [`docs/diagnostics/2026-05-03-web-deep-dive/03-backend-and-performance.md`](../diagnostics/2026-05-03-web-deep-dive/03-backend-and-performance.md) §4.5.
