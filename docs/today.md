...
> **Last validated:** 2026-05-29 by docs:gen-today. **Next review:** 2026-05-29.
> **Status:** Reference
...
- [`security/hardening/sprint-1.md`](./security/hardening/sprint-1.md) — Sprint 1 — Critical + найгірші High → **Phase 2 — pending** _(Security hardening)_
