...
| `streak_milestone_reached`       | [`dashboardCards.tsx`](../../apps/web/src/core/hub/dashboard/dashboardCards.tsx) `<StreakIndicator/>` crossing detector (toast-only path; dedicated celebration modal не існує — `StreakCelebration` був deleted у PR #2998 як unused orphan, see [alignment-audit-2026-05-18.md §Q8](../design/redesign-v2/alignment-audit-2026-05-18.md)) | `days: number`, `type: "toast"` (contract reserves `"modal"` if a future celebration surface is wired)                                                                                                                                                |
