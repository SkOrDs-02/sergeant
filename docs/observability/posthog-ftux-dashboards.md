...
| `celebration_shown`              | [`CelebrationModal.tsx`](../../apps/web/src/core/onboarding/CelebrationModal.tsx) open                                                                                                                     | `ttvMs: number \| null`, `source: "first_entry"` (contract reserves `"streak" \| "milestone"`), `moduleId: DashboardModuleId \| null`, `tipVariant: string` (`nextStepTip` фактично-рендеру), `ctaLabel: string` (`primaryCtaLabel` фактично-рендеру) |
