...
| **Rate-limit Telegram Bot API**    | 30 msg/sec по бота, 20 msg/min на чат. На сьогодні ми ~0.5 msg/min на supergroup, але DDoS-pattern alert-storm (наприклад, Sentry викидає 1000 алертів за хвилину) уперся б у quota → втрата подій. | Ще не виникало; коли виникне — буфер у WF-98 + dedupe.                                                                                                              |
