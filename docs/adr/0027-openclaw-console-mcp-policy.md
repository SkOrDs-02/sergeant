...
OpenClaw починався як launch-проза, а `tools/console` зараз існує як внутрішній адмін-інструмент у Telegram. Без політики кожен AI- або MCP-PR має наново вирішувати, чи console — це продуктовий surface, які інструменти можуть мутувати дані та як версіонувати зміни промптів.

## Рішення

Phase 1 випускає `tools/console` як внутрішній адмін-інструмент, не як user-facing продукт.
