...
(див. [`docs/02-engineering/architecture/platforms.md#2-native-rn--appsmobile`](../02-engineering/architecture/platforms.md)).
...
### Exit dashboard (читається з [`docs/02-engineering/architecture/platforms.md`](../02-engineering/architecture/platforms.md#0-feature-parity-матриця-web-shell-rn))
...
2. **Тільки RN.** Чистий shot, але RN-порт — фіз 3–6 місяців роботи одного
   мейнтейнера (див. [`docs/02-engineering/mobile/react-native-migration.md`](../02-engineering/mobile/react-native-migration.md)).
...
`/api/v1/*`, див. [`docs/02-engineering/mobile/overview.md`](../02-engineering/mobile/overview.md)).
...
- Shell релізиться в store **зараз** без чекання RN-парiтету (див.
  [`docs/02-engineering/architecture/platforms.md`](../02-engineering/architecture/platforms.md) — Android shell уже має release-build
  pipeline, iOS — scaffolded).
- RN-порт іде **без deadline-паніки** — можна рефакторити модулі по одному
  (spec у [`react-native-migration.md`](../02-engineering/mobile/react-native-migration.md)).
...
- **QA ширше** — треба тестувати і shell, і RN. Ми зменшили це через feature-parity
  table у [`docs/02-engineering/architecture/platforms.md`](../02-engineering/architecture/platforms.md) — список, що зроблено де.
...
1. RN покриває 100% Харчування (parsePantry, photo-AI, day-plan, recipes —
   див. [`docs/02-engineering/architecture/platforms.md#2-native-rn`](../02-engineering/architecture/platforms.md)).
...
[`docs/02-engineering/mobile/shell.md`](../02-engineering/mobile/shell.md)).
...
4. **iOS TestFlight release automation.** Pipeline scaffolded, потребує
   Apple-секретів (див. [`docs/02-engineering/architecture/platforms.md`](../02-engineering/architecture/platforms.md#3-capacitor-shell--appsmobile-shell)).
