...
- **Related:**
  ...
  - [`docs/adr/0062-openapi-source-of-truth.md`](./0062-openapi-source-of-truth.md) — пізніший ADR, що підтверджує code-first (Zod→OpenAPI) як канонічне source-of-truth (доповнює, не суперечить).
