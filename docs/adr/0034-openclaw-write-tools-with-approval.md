# ADR-0034: OpenClaw write-tools with founder-approval flow
...
1. **Sprint 1 (this PR):** server endpoints + approval-store + executor интерцепція + handler callback-логіка + persona-allowlist update + ADR-0034 + roadmap update + tests.
