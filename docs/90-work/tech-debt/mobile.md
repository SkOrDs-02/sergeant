...
> **Last validated:** 2026-07-10 by @cursoragent (TS 6 aligned; `tools/openclaw` removed). **Next review:** 2026-10-08.
> **Status:** Active
...
| TypeScript-version drift                 | ~~Середній~~ → **OK**   | `apps/mobile`: `typescript ~6.0.3` — aligned з web/server (ADR-0063 / Expo SDK 52). Historical `tools/openclaw` removed. Залишок: Expo SDK 53 bump — окремий track (ADR-0063), не TS drift.                                                                                                                                                                                                                                                                                                                                                          |
