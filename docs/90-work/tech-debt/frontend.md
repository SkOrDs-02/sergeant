...
**Ціль.** ≤450 kB. Очікувану цифру «~398 kB» із попередньої редакції НЕ
приймай на віру — вона виводилась із хибної моделі; міряй після зміни.
Орієнтир індустрії — ≤170 kB до інтерактиву на мобільному.

**Стан на 2026-08-06: 469.5 kB із 470.0.** Запасу пів кілобайта, тож
наступний PR із будь-яким новим eager-імпортом завалить гейт незалежно від
змісту. Це вже не борг «колись», а блокер.
