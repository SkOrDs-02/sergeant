...
### Драбина ступенів зв'язку схлопнулась на щільних рядах
...
`observations >= STABLE_N (30) || absR >= STRONG_R (0.7)`.
...
**Запропонований фікс** (потребує рішення власника — слова ступенів і пороги
він затверджував окремо): вести градацію за `|r|`, а `n` лишити гейтом мовчання.
...
**Тест уже фіксує дефект** з поміткою `AI-DANGER`. Коли драбину полагодять, він
закономірно впаде — це сигнал оновити його під нову семантику, а не привід
послабити assert.
