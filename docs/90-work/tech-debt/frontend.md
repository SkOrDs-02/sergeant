...
**Окремо на рішенні власника:** трекінг `text-style-display` −0.03em → −0.012em
(калібрування під кирилицю). Вийнято з PR #652, мокап —
[`mockups/product/display-tracking.html`](../../../mockups/product/display-tracking.html).
З 19 місць із роллю `display` лише 4 містять слова, решта — числа, тож
глобальність зміни менша, ніж здається з формулювання.
