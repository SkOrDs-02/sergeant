...
- **Пороги ступенів (`MIN_N`, `REPEATING_N`, `STABLE_N`) калібрувались на
  розрідженому режимі.** Тепер спільних днів у пари помітно більше, тож картки
  доходитимуть до «Тримається стабільно» швидше. Це не завищення (45 порівняних
  днів справді сильніший доказ за 6), але при підйомі `MIN_N` 5 → 10 варто
  перевірити й два інші пороги на живих даних.
