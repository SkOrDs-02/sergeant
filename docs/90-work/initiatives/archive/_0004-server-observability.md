...
> **Owner:** `@Skords-01`
> **ETA:** 1 week
> **Sources:** Design Review 2026-05-03 §11, [`docs/90-work/tech-debt/backend.md`](../../tech-debt/backend.md)
...
- [`docs/90-work/tech-debt/backend.md`](../../tech-debt/backend.md) — запис «No server-side Sentry / no traces»
