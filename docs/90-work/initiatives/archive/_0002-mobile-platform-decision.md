...
- Mobile e2e на CI — окрема ініціатива (буде додана), see [`docs/90-work/planning/mobile-e2e-testing.md`](../../planning/archive/mobile-e2e-testing.md).
...
| Маркетингові кампанії, що ведуть на shell-листинг        | Координувати з marketing console (`tools/openclaw/`): після T₁ всі shell-deeplinks redirect на RN-app store-page (через App Links / Universal Links).                                                                         |
...
- [`docs/90-work/planning/mobile-e2e-testing.md`](../../planning/archive/mobile-e2e-testing.md) — e2e roadmap
...
PR-10 з [`docs/90-work/planning/pr-plan-mobile-reliability-2026-05.md`](../../planning/archive/pr-plan-mobile-reliability-2026-05.md)
