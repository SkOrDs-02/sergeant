...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/90-work/initiatives/0017-hub-tabs-mount-perf.md`.
> **Agent-ready:** blocked
> **Priority:** P1 (Sprint 1 candidate after [0016](./_0016-changelog-release-cut.md))
> **Owner:** `@Skords-01`
