...
> **Owner:** `@Skords-01`
> **ETA:** 3 working days
> **Sources:** Design Review 2026-05-03 §8 (AI integration), [`docs/90-work/tech-debt/backend.md`](../../tech-debt/backend.md)
...
- [`docs/90-work/tech-debt/backend.md`](../../tech-debt/backend.md) — запис про AI cost (раніше «not measured»; зараз закритий, prompt-caching активний з [#864](https://github.com/Skords-01/Sergeant/pull/864), per-endpoint cost-метрики з [#1247](https://github.com/Skords-01/Sergeant/pull/1247)).
