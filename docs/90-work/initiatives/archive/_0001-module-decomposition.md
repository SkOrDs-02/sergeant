...
> **Sources:** Design Review 2026-05-03 §2.1, §3.1, §12; [`docs/90-work/tech-debt/frontend.md`](../../tech-debt/frontend.md)
...
- Оновлення [`docs/90-work/tech-debt/frontend.md`](../../tech-debt/frontend.md) — переніс `LARGE_FILES` з «watching» в «in progress», з посиланням сюди.
...
- Тести й сторібуки до декомпонованих кусків (буде в [0007 — Design-system tooling](./_0007-design-system-tooling.md)).
...
- Оновити `docs/90-work/tech-debt/frontend.md` — `LARGE_FILES` перевести у статус **In progress**, додати посилання на цю ініціативу.
...
- [`docs/90-work/tech-debt/frontend.md`](../../tech-debt/frontend.md) — секція **LARGE_FILES**
...
- **`docs/90-work/tech-debt/frontend.md` § LARGE_FILES** перенесено зі стану _Watching_ у
...
- **Документація.** Цей файл оновлено зі Phase 2 + Phase 3 outcomes; [`docs/90-work/initiatives/README.md`](../README.md) — статус 0001 → Done; [`docs/90-work/tech-debt/frontend.md`](../../tech-debt/frontend.md) `LARGE_FILES` секція — посилання на цю ініціативу як завершену, з carry-over списком (нижче) для подальшої роботи.
