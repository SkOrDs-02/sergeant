...
> **Last touched:** 2026-07-20 by @cursoragent (PR-25 closed). **Next review:** 2026-10-18.
> **Status:** Active

> **Попередження:** Ручний знімок; source of truth — самі картки. Оновлено 2026-07-20 (PR-25 Closed; M9 → archive).
...
Зріз стеку від 2026-05-03. Джерело: [`stack-pulse-2026-05/00-overview.md`](./stack-pulse-2026-05/archive/00-overview.md). Кожна картка має окремий `pr-NN-*.md` файл.

### Critical (C1–C6)

| ID  | Назва                                                               | Source-файл                                                                                                          | Статус | GitHub PR                                                          |
| --- | ------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------------ |
| C1  | Подвійна env-система (`env.ts` + `env/env.ts` + `betterAuthEnv.ts`) | [`pr-01-unify-env-modules.md`](./stack-pulse-2026-05/archive/pr-01-unify-env-modules.md)                             | Closed | [#2122](https://github.com/Skords-01/Sergeant/pull/2122)           |
| C2  | Rate-limit in-memory fallback при відмові Redis                     | [`pr-02-rate-limit-fail-closed.md`](./stack-pulse-2026-05/archive/pr-02-rate-limit-fail-closed.md)                   | Merged | [#1552](https://github.com/Skords-01/Sergeant/pull/1552)           |
| C3  | bcrypt + `MAX_PASSWORD_LENGTH=128` (silent 72-byte cap)             | [`pr-03-bcrypt-password-limit.md`](./stack-pulse-2026-05/archive/pr-03-bcrypt-password-limit.md)                     | Merged | [#1550](https://github.com/Skords-01/Sergeant/pull/1550)           |
| C4  | Bus factor = 1 (єдиний `@Skords-01` owner усього)                   | [`pr-04-bus-factor-secondary-owners.md`](./stack-pulse-2026-05/archive/pr-04-bus-factor-secondary-owners.md)         | Closed | —                                                                  |
| C5  | TypeScript 6.0.3 + `@types/node@25.6` на Node 20                    | [`pr-05-typescript-types-node-downgrade.md`](./stack-pulse-2026-05/archive/pr-05-typescript-types-node-downgrade.md) | Closed | —                                                                  |
| C6  | OpenClaw plain `Git_PAT` з `contents:write`                         | [`pr-06-openclaw-github-app.md`](./stack-pulse-2026-05/archive/pr-06-openclaw-github-app.md)                         | Closed | [#1816](https://github.com/Skords-01/Sergeant/pull/1816) (Phase 1) |

### High (H1–H10)

| ID  | Назва                                            | Source-файл                                                                                                    | Статус | GitHub PR                                                |
| --- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------- | ------ | -------------------------------------------------------- |
| H1  | Body-size policy order-dependent                 | [`pr-07-body-size-declarative-policy.md`](./stack-pulse-2026-05/archive/pr-07-body-size-declarative-policy.md) | Closed | [#2081](https://github.com/Skords-01/Sergeant/pull/2081) |
| H2  | API-version rewrite committed to v1 forever      | [`pr-08-api-versioning-consolidation.md`](./stack-pulse-2026-05/archive/pr-08-api-versioning-consolidation.md) | Closed | —                                                        |
| H3  | `@parse/node-apn` non-canonical maintainer       | [`pr-09-apns-library-adr.md`](./stack-pulse-2026-05/archive/pr-09-apns-library-adr.md)                         | Closed | —                                                        |
| H4  | Better Auth security review (own-crypto adapter) | [`pr-10-better-auth-security-review.md`](./stack-pulse-2026-05/archive/pr-10-better-auth-security-review.md)   | Closed | —                                                        |
| H5  | Drizzle schema ↔ SQL drift untracked             | [`pr-11-drizzle-schema-drift-ci.md`](./stack-pulse-2026-05/archive/pr-11-drizzle-schema-drift-ci.md)           | Closed | [#2089](https://github.com/Skords-01/Sergeant/pull/2089) |
| H6  | Sentry tracesSampleRate static 0.1               | [`pr-12-sentry-traces-sampler.md`](./stack-pulse-2026-05/archive/pr-12-sentry-traces-sampler.md)               | Closed | [#2086](https://github.com/Skords-01/Sergeant/pull/2086) |
| H7  | PG pool size 10 — undersized для AI ingestion    | [`pr-13-postgres-pool-sizing.md`](./stack-pulse-2026-05/archive/pr-13-postgres-pool-sizing.md)                 | Closed | —                                                        |
| H8  | Vercel COEP `require-corp` — broad blast radius  | [`pr-14-vercel-coep-review.md`](./stack-pulse-2026-05/archive/pr-14-vercel-coep-review.md)                     | Closed | —                                                        |
| H9  | `AI_QUOTA_DISABLED=1` ризик у production         | [`pr-15-ai-quota-disabled-hardblock.md`](./stack-pulse-2026-05/archive/pr-15-ai-quota-disabled-hardblock.md)   | Closed | [#1567](https://github.com/Skords-01/Sergeant/pull/1567) |
| H10 | Pino без enforced redaction policy               | [`pr-16-pino-redaction-policy.md`](./stack-pulse-2026-05/archive/pr-16-pino-redaction-policy.md)               | Closed | [#2125](https://github.com/Skords-01/Sergeant/pull/2125) |

### Medium (M1–M12)

| ID  | Назва                                                                | Source-файл                                                                                                    | Статус     | GitHub PR                                                                                                       |
| --- | -------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------- |
| M1  | 80+ env-vars — мігрувати feature-flag-toggle у DB-таблицю            | [`pr-17-env-vars-feature-flag-toggle.md`](./stack-pulse-2026-05/archive/pr-17-env-vars-feature-flag-toggle.md) | Reference  | —                                                                                                               |
| M2  | Detox path-trigger пропускає server-shape changes                    | [`pr-18-detox-server-shape-trigger.md`](./stack-pulse-2026-05/archive/pr-18-detox-server-shape-trigger.md)     | Closed     | —                                                                                                               |
| M3  | Workers без централізованого health-registry                         | [`pr-19-workers-health-registry.md`](./stack-pulse-2026-05/archive/pr-19-workers-health-registry.md)           | Reference  | —                                                                                                               |
| M4  | `patches/` — patch debt без README                                   | [`pr-20-patches-readme.md`](./stack-pulse-2026-05/archive/pr-20-patches-readme.md)                             | Closed     | [#2193](https://github.com/Skords-01/Sergeant/pull/2193)                                                        |
| M5  | Service Worker `prompt`-mode без auto-update on inactivity           | [`pr-21-sw-prompt-mode-auto-update.md`](./stack-pulse-2026-05/archive/pr-21-sw-prompt-mode-auto-update.md)     | Closed     | [#2309](https://github.com/Skords-01/Sergeant/pull/2309)                                                        |
| M6  | Mobile зашитий Expo SDK 52 (RN 0.76)                                 | [`pr-22-mobile-expo-sdk-53.md`](./stack-pulse-2026-05/archive/pr-22-mobile-expo-sdk-53.md)                     | Deprecated | —                                                                                                               |
| M7  | OpenAPI-spec не contract-tested vs runtime                           | [`pr-23-openapi-contract-tests.md`](./stack-pulse-2026-05/archive/pr-23-openapi-contract-tests.md)             | Reference  | —                                                                                                               |
| M8  | Embedding-vendor lock-in (`voyage-3.5-lite`)                         | [`pr-24-embedding-vendor-abstraction.md`](./stack-pulse-2026-05/archive/pr-24-embedding-vendor-abstraction.md) | Closed     | —                                                                                                               |
| M9  | `fizruk.vercel.app` + `sergeant.vercel.app` — два production origins | [`pr-25-two-production-origins.md`](./stack-pulse-2026-05/archive/pr-25-two-production-origins.md)             | Closed     | [#3392](https://github.com/Skords-01/Sergeant/pull/3392) [#327](https://github.com/Skords-01/Sergeant/pull/327) |
| M10 | DR runbook documented                                                | [`00-overview.md`](./stack-pulse-2026-05/archive/00-overview.md)                                               | Closed     | —                                                                                                               |
| M11 | CSP без `report-uri` / `report-to`                                   | [`pr-26-csp-report-uri.md`](./stack-pulse-2026-05/archive/pr-26-csp-report-uri.md)                             | Closed     | —                                                                                                               |
| M12 | `INTERNAL_API_KEY` без rotation-механізму                            | [`pr-27-internal-api-key-rotation.md`](./stack-pulse-2026-05/archive/pr-27-internal-api-key-rotation.md)       | Reference  | —                                                                                                               |
...
| PR                                                       | Title                                                                             | Merged     |
| -------------------------------------------------------- | --------------------------------------------------------------------------------- | ---------- |
| [#346](https://github.com/Skords-01/Sergeant/pull/346)   | feat(mobile-shell): close stack-pulse — PR-25 archive + PR-29 global shim removal | 2026-07-20 |
