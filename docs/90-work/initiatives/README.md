...
| 0017 | [Hub Settings & Reports mount perf](./0017-hub-tabs-mount-perf.md)                                   | P1        | `@Skords-01` | —                           | **Closed** (2026-06-08 — Sprint 0 + Sprint 1 + Sprint 2 merged). Sprint 3 (Web Worker) is a discrete conditional follow-up — re-opens only if PostHog `aggregateReport` P95 > 50 ms in the next 30-day RUM cut.                                                                                                                                                                                                                                                                                                                                                                                                             |
| 0018 | [Agent semantic retrieval (`agent:find`)](./0018-agent-semantic-retrieval.md)                        | P2        | `@Skords-01` | —                                 | In progress (2026-06-08) — Phases 1–4 code-complete: lexical+semantic `agent:find` поверх committed retrieval-index, HR#24 `agent:check-index` gate + golden-eval (recall@5=1.0 / MRR=0.92), zero-dep `agent_find` MCP-tool + промоція у start-here. Залишок: live-mode acceptance (одноразовий `pnpm agent:embed` + before/after заміри). [ADR-0066](../../04-governance/adr/0066-agent-semantic-retrieval-over-knowledge-graph.md).                                                                                                                                                                                                                                                                                                                               |
...
| 0020 | [Agent decisions log](./0020-agent-decisions-log.md)                                                 | P3        | `@Skords-01` | —                                 | In progress (2026-06-08) — code-complete: курований `docs/00-start/agents/decisions.md` (усталені рішення/вподобання, щоб агент не перепитував), промоція у start-here + agents/README; тонкий покажчик на канон, не паралельний SoT (HR#15). Залишок: live usage між сесіями. [Initiative 0019](./0019-agent-routing.md) (Tier 2 sibling).                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 0021 | [React-hooks v7 ESLint cleanup](./0021-react-hooks-v7-cleanup.md)                                    | P3        | TBD          | 2026-09-09                        | Proposed (2026-06-09) — ~152 вимкнених `react-hooks/*` правил у `eslint.baseline.js:146-178` без власника чи тикету. Потрібна категоризація (свідомі vs. tech-debt) + поетапне виправлення або документування. Починати не раніше Sprint 9 (2026-07-07).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
