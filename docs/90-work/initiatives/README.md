...
| ---- | ---------------------------------------------------------------------------------------------------- | --------- | ------------ | -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0003 | [Sync v2 rollout & v1 sunset](./0003-sync-v2-rollout-and-v1-sunset.md)                               | P0        | `@Skords-01` | Sprint 1–2                             | Closed (2026-07-20) — Phases 1–7 shipped; Phase 7 sunset-routes removal early-landed у [#326](https://github.com/Skords-01/Sergeant/pull/326). Historical rollout checklist лишається в файлі як архів.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| 0021 | [React-hooks v7 ESLint cleanup](./0021-react-hooks-v7-cleanup.md)                                    | P3        | `@Skords-01` | Sprint 9 (2026-07-07) → 2026-09-09     | **Done** (2026-07-10) — PR [#177](https://github.com/Skords-01/Sergeant/pull/177): all six react-hooks v7 rules at `"error"` monorepo-wide (web/mobile per-surface configs + baseline for server/mobile-shell/openclaw). Baseline scoreboard comment replaced with closure note; 5 `"off"` suppressions removed. Source: [`docs/90-work/audits/2026-06-11-fable5-independent-audit.md`](../audits/2026-06-11-fable5-independent-audit.md) (вимір 3).                                                                                                                                                                                                                                                                                                           |
