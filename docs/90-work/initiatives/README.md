...
> **Last touched:** 2026-08-25 by @claude (рядок 0025 в активній таблиці). **Next review:** 2027-02-07.
> **Status:** Active
...
├── 0022-import-from-external-trackers.md     # Superseded
...
| 0022 | [Import from external trackers (CSV-onboarding)](./0022-import-from-external-trackers.md)              | P2        | `@SkOrDs-02` | Phase 1 ≈ 1 sprint; full ≈ 3–4 sprints  | Superseded (2026-09-01) — план виконання переїхав у спеку [`specs/import-external-trackers.md`](../planning/specs/import-external-trackers.md); ініціатива лишається джерелом рішень №1-7                                                                                                                                                                                                                                                                                                                          |
| 0023 | [Розбивка фотоаналізу на позиції (correction UX)](./0023-photo-analysis-multi-item.md)                 | P2        | `@SkOrDs-02` | Phase 1 ≈ 1 sprint; full ≈ 2–3 sprints  | Proposed (2026-08-17) — фотоаналіз повертає ОДНУ страву на кадр, тож помилку в одній позиції з трьох виправити нічим. План: `items[]` із КБЖВ і `confidence` на позицію + точкове видалення/додавання без повторного прогону моделі. Фаза 0 (вільне зауваження в `qna`) уже в проді. Чекає founder-рішення по гранулярності позиції та стелі кількості позицій. Source: тестова група 2026-08-12.                                                                                                                  |
