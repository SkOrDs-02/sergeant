...
| 0023 | [Розбивка фото-аналізу на позиції (correction UX)](./0023-photo-analysis-multi-item.md)                | P2        | `@SkOrDs-02` | Phase 1 ≈ 1 sprint; full ≈ 2–3 sprints | Proposed (2026-08-17) — фото-аналіз повертає ОДНУ страву на кадр, тож помилку в одній позиції з трьох виправити нічим. План: `items[]` із КБЖВ і `confidence` на позицію + точкове видалення/додавання без повторного прогону моделі. Фаза 0 (вільне зауваження в `qna`) уже в проді. Чекає founder-рішення по гранулярності позиції та стелі кількості позицій. Source: тестова група 2026-08-12.                                                                                                                |
