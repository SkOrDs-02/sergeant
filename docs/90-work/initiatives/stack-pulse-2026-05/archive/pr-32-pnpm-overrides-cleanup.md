...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/90-work/initiatives/stack-pulse-2026-05/pr-32-pnpm-overrides-cleanup.md`.
...
`docs/04-governance/governance/pnpm-overrides-policy.md`:
...
- `docs/04-governance/governance/pnpm-overrides-policy.md` — new
