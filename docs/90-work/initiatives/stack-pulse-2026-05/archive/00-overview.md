...
| L2  | `window.__sergeantShellNavigate` global → BroadcastChannel    | [PR-29](./pr-29-shell-navigate-broadcast-channel.md) | **Closed** — [#2526](https://github.com/Skords-01/Sergeant/pull/2526) + PR-2 (2026-07-20)                                                                                                                    |
