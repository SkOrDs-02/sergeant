...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/90-work/initiatives/stack-pulse-2026-05/pr-05-typescript-types-node-downgrade.md`.
...
- `tools/openclaw/package.json` → ↑ до 6.x **або** root → 5.9 (узгодити з mobile).
...
| TS 6 у `tools/openclaw` потребує @anthropic-ai update | окремий PR на bump SDK у console, дочекатися перед мерджем                                              |
