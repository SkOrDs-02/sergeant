...
- `docs/00-start/agents/decisions.md` — ledger з lifecycle-маркером, формат `| Дата | Рішення | Скоуп | Канон |`, засіяний рішеннями цієї сесії.
- Промоція у `sergeant-start-here` + `docs/00-start/agents/README.md` (крок орієнтації + рядок таблиці).
...
| -------- | ----------------------------------------- | ------------------------------------------------------------------------------- | ---- |
| **PR-1** | `decisions.md` ledger + seed рішень сесії | `docs/00-start/agents/decisions.md`                                             | ✅   |
| **PR-2** | Промоція у start-here + agents/README     | `.agents/skills/sergeant-start-here/SKILL.md`, `docs/00-start/agents/README.md` | ✅   |

## Критерії DONE

- [x] `docs/00-start/agents/decisions.md` існує з lifecycle-маркером, форматом і seed-рішеннями
- [x] `sergeant-start-here` і `docs/00-start/agents/README.md` вказують читати його на старті
