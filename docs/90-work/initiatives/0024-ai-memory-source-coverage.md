...
9. ✅ Доки: [`ai-memory.md`](../../02-engineering/architecture/ai-memory.md) (діаграма ingest-потоку — `mono webhook (source=finyk)` і клієнт-driven гілка прибрані, sources matrix звужена до живих + legacy-рядків), [`ai-memory-activation.md`](../../01-product/launch/tech/ai-memory-activation.md) (обіцянка «finyk-ingest стартує автоматично» прибрана).
