...
> **Status:** Planned — фінансова гілка відвантажена 18–25.08.2026; чинний скоуп ініціативи звужено до одного рефактора (§ План змін). Адаптери фітнесу й харчування відкладені до попиту.
> **Agent-ready:** yes
