...
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- | --------------------------------------------------------- |
| [`plans/2026-05-06-sync-engine-writer-wiring.md`](plans/archive/2026-05-06-sync-engine-writer-wiring.md) | Web runtime wiring для Stage 5 sync v2 writer engine (outbox + scheduler) | Active — task list відкритий; виконують агенти або людина |
...
- Cross-link на трекери (`docs/90-work/initiatives/*` або `docs/90-work/planning/*`), якщо план — це шматок ширшої ініціативи.
