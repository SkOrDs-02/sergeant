...
- **Один умисний placeholder.** `docs/01-product/launch/product-os/sprint-retros/s6-cleanup-batch.md` згадується як «буде створений по завершенню» — конвертовано з markdown-link у code-mention, щоб не ламати лінкер.
...
| ----------------------------------------------------------------- | ------------------------------------------------ | -------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| `docs/04-governance/adr/0009-hosting-split-railway-vercel.md`     | `../../vercel.json` (×4)                         | `../../apps/web/vercel.json`                                   | Vercel SSOT перенесено з root у `apps/web/` (commit `61196120`).              |
| `docs/90-work/initiatives/0006-frontend-routing-...md`            | ../../scripts/bundle-size-guard.ts (×2)          | `../../scripts/check-bundle-size.mjs`                          | Bundle-gate переписано з TS на ESM `.mjs`.                                    |
| `docs/90-work/initiatives/0006-frontend-routing-...md`            | ../../apps/web/src/shared/hooks/useHashRouter.ts | `../../apps/web/src/modules/finyk/hooks/useHashRouter.ts`      | Hook переїхав в Finyk-module за planом самої ініціативи.                      |
| `docs/90-work/initiatives/0006-frontend-routing-...md`            | `../../vite.config.js`                           | `../../apps/web/vite.config.js`                                | Vite-конфіг живе тільки у `apps/web/`.                                        |
| `docs/90-work/initiatives/archive/_0007-design-system-tooling.md` | `../design-system/` (×2)                         | `../design/`                                                   | Дизайн-доки переїхали у `docs/05-design/design/` (doc-hygiene PR 2026-05-02). |
| `docs/90-work/initiatives/archive/_0008-platform-hardening.md`    | `../../apps/server/src/__tests__/`               | `../../apps/server/src/http/` + іменовані `rateLimit*.test.ts` | `__tests__/` стало per-module (`http/`, `migrations/__tests__/`).             |
| `docs/90-work/initiatives/archive/_0008-platform-hardening.md`    | `../../apps/server/src/middleware/`              | `../../apps/server/src/http/`                                  | Middleware рефакторнули у `http/`.                                            |
...
| `packages/shared/src/lib/kvStore.ts`                             | `@deprecated` | Backwards-compatibility re-export, видалиться у LS-burndown PR #013 (`docs/90-work/planning/storage-roadmap.md`).       |
...
- **Tech-debt registry** (`docs/90-work/tech-debt/{frontend,backend,mobile}.md`) — `pnpm lint:tech-debt-freshness` повертає всі позиції < 60 днів, нема stale записів.
...
- [`docs/90-work/audits/2026-05-02-doc-hygiene-audit.md`](./2026-05-02-doc-hygiene-audit.md) — попередній doc-hygiene прохід (звідки розпочаті `scripts/codemods/` каталог + thin-pointer формат `CLAUDE.md`/`DEVIN.md`).
...
- [`docs/90-work/tech-debt/frontend.md`](../../tech-debt/frontend.md) — outstanding tech-debt по `apps/web`, на яке посилаються initiatives 0006/0007.
