...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/90-work/audits/2026-05-03-web-deep-dive/round-13-burndown-sprint.md`.
>
...
> [`docs/01-product/launch/product-os/ftux-sprint-plan.md`](../../../../01-product/launch/archive/product-os/ftux-sprint-plan.md):
...
> Item #18 organic roadmap · `docs/02-engineering/testing/mutation.md` (видалений у PR #052b
...
- `docs/02-engineering/testing/mutation.md` — Item #17 organic roadmap (файл видалений у PR #052b разом з cloudSync v1 Stryker infra; mutation testing для retired cloudSync engine більше не релевантний).
- [`docs/01-product/launch/product-os/ftux-sprint-plan.md` §7a](../../../../01-product/launch/archive/product-os/ftux-sprint-plan.md) — еталонний pattern «Sprint cleanup batch».
