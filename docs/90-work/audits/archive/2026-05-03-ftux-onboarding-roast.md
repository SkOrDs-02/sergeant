...
> **Status:** Frozen reference — see [`docs/01-product/launch/product-os/ftux-master-tracker.md`](../../../01-product/launch/product-os/ftux-master-tracker.md) for current state.

> ### 📦 Consolidated 2026-05-05
>
> Цей файл переміщено у режим **frozen reference**. Поточний стан FTUX (закриті/відкриті проблеми, sprint registry, PR plan, hero copy variants, outcome-card sketch, SLO, decisions log) живе в **[`docs/01-product/launch/product-os/ftux-master-tracker.md`](../../../01-product/launch/product-os/ftux-master-tracker.md)**.
>
...
>
> **Cross-refs:**
> [`docs/01-product/launch/product-os/ftux-sprint-plan.md`](../../../01-product/launch/product-os/ftux-sprint-plan.md) — план реалізації рекомендацій ·
...
> - **`onboarding_skipped`** окремо: у поточному one-screen wizard-і (v3) skip-шляху немає, тож emiter не доданий. Якщо у S1 з'явиться явна «Skip» affordance — повертаємось до події; контракт `{ step: string }` уже зафіксовано у [`posthog-ftux-dashboards.md` §2](../../../03-operations/observability/posthog-ftux-dashboards.md#2-canonical-events-consumed).
>
...
- **Insights розкриваються запізно.** Раніше від користувача очікують зробити запис, потім ще через 7 днів той collapsible auto-розкривається. Документ про «aha-moment» (`docs/01-product/launch/business/01-monetization-and-pricing.md:280-330`) каже, що **перший AI-insight — найсильніший корелят retention**. Зараз він захований за collapsible-у-collapsibl'i.
...
- Документ `docs/01-product/launch/business/01-monetization-and-pricing.md` визначає activation як «≥1 запис у ≥2 модулі за 72 години» і називає aha-moment hypotheses.
...
> **План реалізації:** [`docs/01-product/launch/product-os/ftux-sprint-plan.md`](../../../01-product/launch/product-os/ftux-sprint-plan.md) — кожна рекомендація розписана як user-story + PR з AC і метриками.
...
7. **PostHog (або еквівалент).** Без funnel-метрик усе вищезазначене — це гіпотези. Це **передумова** до будь-якого A/B. _Web-частина закрита станом на 2026-05-03 — див. errata v2 угорі та [`ftux-sprint-plan.md` §2](../../../01-product/launch/product-os/ftux-sprint-plan.md#2-sprint-0--analytics-live-1-тиждень) (S0.4 + S0.5 shipped). Mobile parity (S0.3) лишається._
...
> **Що далі:** [`docs/01-product/launch/product-os/ftux-sprint-plan.md`](../../../01-product/launch/product-os/ftux-sprint-plan.md) розкладає всі 22 рекомендації по 5 спринтах із PR-розбивкою, AC, метриками і ризиками.
