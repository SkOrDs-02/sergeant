...
> `packages/eslint-plugin-sergeant-design/**`, `docs/90-work/audits/archive/**`,
...
2. **`pnpm docs:check-links` — exit 1**: 53 broken internal links. **49 з них** — у `docs/90-work/audits/archive/**`: класичний archive-move bug (файли переїхали на один рівень глибше, але `../X` / `./X` посилання не бампнули depth). Решта 4 — у активних доках (`apps/web/AGENTS.md`, `docs/90-work/initiatives/0006-…md`, `docs/90-work/planning/sprint-roadmap-q2q3-2026.md`) — посилаються на ще-не-існуючий `.github/workflows/lighthouse-ci.yml` і на видалений `apps/web/src/shared/hooks/useHashRoute.ts`.
...
`scripts/docs/check-markdown-links.mjs` (введений у [`docs/90-work/audits/2026-05-05-dead-code-and-stale-links-audit.md`](./2026-05-05-dead-code-and-stale-links-audit.md)) ловить будь-який `[text](./path)`-link, де файл не існує. Між 2026-05-05 і 2026-05-13 зламалось **53 internal links**:

#### 49 archive-move depth-drift (`docs/90-work/audits/archive/**`)

Коли аудити переїхали `docs/90-work/audits/X.md → docs/90-work/audits/archive/X.md`, їхні `../initiatives/`, `../security/`, `../tech-debt/`, `../adr/`, `../launch/`, `../design/`, `../../apps/` посилання залишились зі **старим** depth — і тепер резолвляться у `docs/90-work/audits/initiatives/`, `docs/90-work/audits/security/`, etc., яких не існує.

Виправлено систематично (per-file sed-style substitution; не масово на всі `../`, бо деякі links валідно ходять усередині `archive/`):

| Файл                                                                     | Замін | Pattern                                                                                                     |
| ------------------------------------------------------------------------ | ----: | ----------------------------------------------------------------------------------------------------------- |
| `docs/90-work/audits/archive/2026-04-26-sergeant-audit-devin.md`         |     1 | `../adr/` → `../../adr/`                                                                                    |
| `docs/90-work/audits/archive/2026-04-28-sergeant-comprehensive-audit.md` |     2 | `./2026-04-28-implementation-roadmap.md` → `../2026-04-28-implementation-roadmap.md`                        |
| `docs/90-work/audits/archive/2026-04-28-ux-ui-audit.md`                  |     4 | `./X.md` → `../X.md`; `../design/` → `../../design/`                                                        |
| `docs/90-work/audits/archive/2026-05-03-ftux-onboarding-roast.md`        |    21 | `../launch/`, `../design/`, `../observability/`, `./2026-04-28-X.md`, `../../apps/` → bump one level deeper |
| `docs/90-work/audits/archive/2026-05-04-csp-disable-retrospective.md`    |    17 | `../initiatives/`, `../security/`, `../tech-debt/`, `../playbooks/`, `../governance/` → `../../X`           |
| `docs/90-work/audits/archive/2026-05-11-docs-audit-summary.md`           |     4 | `../adr/`, `../initiatives/archive/` → `../../X`                                                            |
...
| `docs/90-work/initiatives/0006-frontend-routing-and-code-split.md:160` | **Change** | Link на видалений `apps/web/src/shared/hooks/useHashRoute.ts` → один рядок про те, що hook був видалений після Phase 2 migration.                     |
| `docs/90-work/planning/sprint-roadmap-q2q3-2026.md:38`                 | **Change** | Те саме `.github/workflows/lighthouse-ci.yml` link → code-mention з marker «planned».                                                                 |
| `docs/90-work/planning/sprint-roadmap-q2q3-2026.md:374`                | **Change** | Те саме `.github/workflows/lighthouse-ci.yml` link → code-mention.                                                                                    |
...
> - **Design-system / barrel public surface** — `Card*` sub-компоненти, `Animated*`, `Skeleton*`, `KeyboardAccessory`+chip-консти, `useHaptic` тощо: живуть під `@shared/*` barrel-ами, які ще мають `@scaffolded` (per 2026-05-05 § 3.3 п.2 — зникнуть автоматично, коли barrel «прокинеться»).
...
- [`docs/90-work/audits/2026-05-05-dead-code-and-stale-links-audit.md`](./2026-05-05-dead-code-and-stale-links-audit.md) — попередня dead-code прожарка.
- [`docs/90-work/audits/archive/2026-05-07-app-audit.md`](./2026-05-07-app-audit.md) — повний app-audit (web-blocker, mobile tests, hard-rule violations).
