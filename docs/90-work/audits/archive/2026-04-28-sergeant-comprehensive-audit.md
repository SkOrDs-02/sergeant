...
**Резолвед (2026-05-03):** Phase 4 final flip + Phase 5 cleanup — `apps/web/tsconfig.json` тепер `strict: true` без `allowJs`, `noImplicitOverride: true` у base. `pnpm strict:coverage` рапортує 13/13 пакетів (100%). Деталі — `docs/90-work/tech-debt/frontend.md` §11.
...
| **P2-3** | Mobile debt tracker missing        | Hidden accumulation | Create `docs/90-work/tech-debt/mobile.md` |
