...
- ✅ `docs/90-work/planning/README.md`
- ✅ `docs/90-work/tech-debt/README.md` (та 3 sub-files)
- ✅ `docs/90-work/initiatives/README.md` (та 15+ sub-files)
...
- `docs/90-work/initiatives/archive/2026-08-02-batch-archival-plan.md`
- `docs/90-work/audits/archive/2026-05-11-docs-audit-summary.md` (цей файл)
