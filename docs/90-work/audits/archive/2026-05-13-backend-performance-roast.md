...
4. **Багато `process.env[...]` reads у `obs/metrics.ts`,
   ...
   ([`docs/90-work/audits/2026-05-07-app-audit.md:396`](./2026-05-07-app-audit.md#L396),
...
7. **`@sergeant/db-schema/migrate` umbrella export видалено**
   ([`docs/90-work/audits/2026-05-07-app-audit.md:389`](./2026-05-07-app-audit.md#L389),
...
див. [`docs/90-work/tech-debt/backend.md`](../../tech-debt/backend.md) summary table).
...
- **File:** `apps/server/src/obs/tracing.ts:55,386` _(файл згодом видалено — OTel dormant)_.
...
`docs/03-operations/observability/metrics.md`, `docs/90-work/audits/README.md` + цей файл).
...
- Не модифікував `docs/90-work/audits/README.md` поза одним рядком про цей roast (правило з task spec).
