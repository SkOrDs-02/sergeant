...
| 1.3 | **Дублікат «next review» дат**                                                                                                        | README.md, AGENTS.md, docs/README.md, docs/03-operations/postmortems/README.md, docs/governance/README.md, docs/00-start/playbooks/README.md мають один і той самий `Last validated: 2026-05-02 by @claude` — не баг, але видно що це bulk-bump, не реальна ревалідація.                            |
...
- Шлях `docs/90-work/audits/ux-audit-2025.md` → `docs/90-work/audits/archive/ux-audit-2025.md` оновлено в `scripts/docs/freshness-config.json` і у прикладі в `docs/governance/doc-freshness.md`.
