...
- `CSP_DISABLE=1` runtime kill-switch жив у `apps/server/src/http/security.ts` **16 днів** (2026-04-18 → 2026-05-04). Видалений у [PR #1631](https://github.com/Skords-01/Sergeant/pull/1631) разом з [M1 hardening card](../../../04-governance/security/hardening/M1-csp-disable-runtime-flag.md).
...
| 2026-05-03              | Deep security review зафіксував M1: «`CSP_DISABLE=1` runtime fault-injection vector», CVSS 6.1.                                               | [`docs/04-governance/security/hardening/M1-csp-disable-runtime-flag.md`](../../../04-governance/security/hardening/M1-csp-disable-runtime-flag.md)                                  |
...
- [M1 hardening card](../../../04-governance/security/hardening/M1-csp-disable-runtime-flag.md) — original closed card with technical detail, code-snippets, and tests.
