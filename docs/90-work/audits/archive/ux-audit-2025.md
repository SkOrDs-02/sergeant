...
> `docs/90-work/audits/archive/` 2026-05-02 під час doc-hygiene-аудиту. Усі покращення,
> описані тут, уже впроваджені; для актуальних дизайн-правил дивись
> [`docs/05-design/design/design-system.md`](../../../05-design/design/design-system.md), а для поточного
> UX-tracker-у — [`2026-04-28-ux-improvement-plan.md`](./2026-04-28-ux-improvement-plan.md).
...
- `src/core/hub/hubSearchEngine.ts`
- `docs/05-design/design/ux-audit-2025.md`
