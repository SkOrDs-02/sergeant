...
**Why it matters.**
"Loading…" never moves; users assume the app is frozen. Errors are invisible. New onboarding-friendliness post-mortem (see `docs/90-work/audits/2026-04-28-ux-improvement-plan.md`) flagged this exact pattern across the app.
