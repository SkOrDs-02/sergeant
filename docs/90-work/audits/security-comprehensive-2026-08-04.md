...
неіснуючий шлях — scripts/agent/mcp-server.mjs (без backtick-ів навмисно: у backtick-ах
`lint:governance-sync` читає його як посилання на реальний файл і падає на знахідці, суть
якої саме в тому, що файла немає).
