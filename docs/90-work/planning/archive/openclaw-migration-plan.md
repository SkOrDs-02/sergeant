...
SDK reality-check spike закрився 2026-05-12 — деталі у `docs/02-engineering/notes/spikes/openclaw-sdk-5.7-real-api.md`. TL;DR результатів:
...
| ✅ 🔬         | SDK reality-check spike (hook / approval / allowlist / scheduler API)                                                                                                                                                                                                                                                            | merged (`openclaw-sdk-5.7-real-api.md`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | n/a                                     |
...
| ✅ 7          | Phase 7 cutover executed 2026-05-12 22:30 UTC (`cutover-openclaw-gateway.md`): `OPENCLAW_BOT_TOKEN` cleared, grammy webhook deleted, Gateway live (long-poll). Deletion (Locked Decision #17): **CLOSED without deletion 2026-06-08 — grammy tree retained (still imported by `tools/openclaw/src/index.ts`); deadline lifted.** | Stage 6b                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | високий — deletion міркувань rollback-у |
