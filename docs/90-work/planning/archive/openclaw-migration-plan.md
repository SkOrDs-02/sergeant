...
> **Status:** Archived (2026-06-15) — migration complete (Stage 7 cutover 2026-05-12; grammy bot + tools/openclaw deleted in PR #3470). Canonical home: ADR-0056 + packages/openclaw-plugin + sergeant-openclaw specialist. Post-cutover follow-ups (digest cron confirm, reminders poller, voice/Canvas) tracked via sergeant-openclaw notes.
