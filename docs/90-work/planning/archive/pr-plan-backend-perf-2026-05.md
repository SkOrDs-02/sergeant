...
> із власним rollback-планом, як того вимагає культура `docs/90-work/initiatives/`.
...
- [`docs/90-work/initiatives/stack-pulse-2026-05/`](../../initiatives/archive/stack-pulse-2026-05/README.md) — паралельна 16-PR серія; PR-01 (env-уніфікація), PR-12 (Sentry tracesSampler), PR-13 (pg-pool sizing), PR-16 (Pino redaction) — найближчі за поверхнею.
...
| PR-12 | `chore(audits): scope syncV2.ts + routes/internal/openclaw.ts deep-roasts`        | S    | P3                            | `docs/90-work/audits/` (нові stub-и `2026-08-…-sync-engine.md`, `…-openclaw-internal.md`)                                                                                   |
...
- Оновити `docs/90-work/audits/archive/2026-05-07-app-audit.md` (рядок про umbrella → DONE) + цей PR-план.
...
- [ ] `pnpm api:check-openapi-types` зелений (ApiError schema у registry.ts уже match-ить errorHandler canonical emission після prerequisite-фіксу — див. блок rollout).
...
- **Status:** ✅ Виконано — обидва stub-файли створено (51 + 53 рядки, ≤ 100 критерій ✓), повний frontmatter (`Last validated`, `Next review: 2026-08-11`, `Status: Draft`, `Owner: TBD (backend-engineer)`), `docs/90-work/audits/README.md:66-67` реєструє обидва. Real deep-roast сесії — окремий 3-month cycle, серпень 2026 (наступний backend-roast window).

**Surface**

- `docs/90-work/audits/2026-08-XX-sync-engine-roast.md` (stub-файл).
- `docs/90-work/audits/2026-08-XX-openclaw-internal-roast.md` (stub-файл).
- `docs/90-work/audits/README.md` — реєстрація.
...
- [ ] Два stub-файли у `docs/90-work/audits/` із валідними frontmatter (`Last validated`, `Next review`, `Status: Draft`).
- [ ] `docs/90-work/audits/README.md` має посилання на обидва.
