...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/90-work/planning/storage-roadmap/02-stages-0-3.md`.
...
> SPIKE-нотатник архівовано: [`docs/02-engineering/notes/spikes/routine-sqlite-v2.md`](../../../../02-engineering/notes/spikes/routine-sqlite-v2.md)
