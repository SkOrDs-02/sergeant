...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/90-work/planning/storage-roadmap/07-stage-13.md`.
...
- **A6 — Initiative 0003 Phase 6 stale.**
  [`docs/90-work/initiatives/0003-sync-v2-rollout-and-v1-sunset.md:237-244`](../../../initiatives/archive/_0003-sync-v2-rollout-and-v1-sunset.md)
