...
> **Created:** 2026-05-03.
> **Owner:** @Skords-01.
> **Source:** [`../dev-stack-roadmap.md`](dev-stack-roadmap-ff-2026-07-20.md) — рядок «Drizzle» у таблиці Database / Migration tooling.
...
Цей файл — read-only. Для нових ORM/migration рішень редагуй [`../dev-stack-roadmap.md`](dev-stack-roadmap-ff-2026-07-20.md) або заводь нову ADR у `docs/04-governance/adr/`.
