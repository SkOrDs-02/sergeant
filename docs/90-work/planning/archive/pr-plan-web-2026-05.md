...
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/90-work/planning/pr-plan-web-2026-05.md`.
...
- [`docs/90-work/initiatives/0006-frontend-routing-and-code-split.md`](../../initiatives/archive/_0006-frontend-routing-and-code-split.md) — react-router migration, Phase 3-5 закриваються картами A1–A3.
...
- **Acceptance:**
  ...
  - LHCI baselines (LCP / FCP / TBT) для 5 routes зафіксовані як `assertions.error` (tightening з `warn` → `error`) — як заплановано у [`apps/web/AGENTS.md § Lighthouse CI`](../../../../apps/web/AGENTS.md).
