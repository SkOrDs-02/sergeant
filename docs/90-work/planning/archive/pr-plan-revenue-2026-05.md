...
> **Last validated:** 2026-07-10 by @cursoragent (ADR-0068 pricing canon; shipped billing inventory). **Next review:** ніколи (read-only архів).
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/90-work/planning/pr-plan-revenue-2026-05.md`.
...
- **P2-5** (Referral / promo code) — окрема ініціатива у [ADR-0001 §Open questions](../../../04-governance/adr/0001-monetization-architecture.md). Відкладено.
