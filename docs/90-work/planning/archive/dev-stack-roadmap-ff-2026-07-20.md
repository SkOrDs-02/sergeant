...
- Беклог: PR #12 `sentry-traces-sampler.md` у [`stack-pulse-2026-05/`](../../initiatives/stack-pulse-2026-05/archive/pr-12-sentry-traces-sampler.md) — dynamic traces sample-rate по route-pattern.
...
| **pgBouncer**          | Connection pooling              | $0             | ⏳ pending — PR #13 `postgres-pool-sizing.md` у [stack-pulse-2026-05](../../initiatives/stack-pulse-2026-05/archive/pr-13-postgres-pool-sizing.md) (`pg.Pool.max` поки дефолт) |
