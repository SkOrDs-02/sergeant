...
> **Created:** 2026-05-13.
> **Source:** [`docs/90-work/audits/2026-05-13-security-observability-roast.md`](../../audits/archive/2026-05-13-security-observability-roast.md) — прожарка, з якої цей execution-план виник. Жив як `docs/90-work/planning/pr-plan-security-obs-2026-05.md` до fast-forward архівації.
