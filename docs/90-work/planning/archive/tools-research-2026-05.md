...
> **Last validated:** 2026-07-10 by @cursoragent (OpenClaw row → external gateway). **Next review:** ніколи (read-only архів).
> **Status:** Archived (read-only). Fast-forward archived 2026-07-20 (90-day gate skipped за рішенням founder-а). Source: `docs/90-work/planning/tools-research-2026-05.md`.
...
| **Чому Sergeant** | Historical: `tools/openclaw` (removed) — Telegram bot на grammy. **Prod today:** external OpenClaw Gateway + `packages/openclaw-plugin` (ADR-0055). Плагіни grammy досі релевантні для gateway-side UX.                                                                                      |
| **Effort**        | S per plugin                                                                                                                                                                                                                                                                                 |
