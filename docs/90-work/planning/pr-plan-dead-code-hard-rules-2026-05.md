...
- **Scope-файли:**
  ...
  - `docs/governance/hard-rules.json` — додати rule id `23`, title `Archive-move depth integrity — no broken ../X links in docs/90-work/audits/archive/**`, `category: "lint-enforced-convention"`, `enforced_by: [{kind: "ci", ref: "pnpm lint:archive-move-depth"}]`.
  - `docs/governance/rules/23-archive-move-depth.md` — canonical body з BAD (`../initiatives/foo.md` у `docs/90-work/audits/archive/X.md`) / GOOD (`../../initiatives/foo.md`) прикладами.
