...
> **Status:** Active — rollout v1 shipped (2026-06-29); harness `1.0.0` + skill-trigger evals done; open follow-ups: golden-task suite, freshness-janitor, playbook-routing evals.
> **Last touched:** 2026-07-20 by @cursoragent (code-reconcile). **Next review:** 2026-10-18.
> **Owner:** @SkOrDs-02
> **Supersedes:** —
...
- **Golden-task suite для A/B harness benchmark.** ADR-0072 §Open Questions
  ...
  `.github/workflows/harness-a-b.yml` bench-step досі `if: false`.
...
- **`lint:harness-version-freshness` janitor** (ADR-0072 §Open Q).
  Трекнуто у `docs/90-work/tech-debt/agents.md`; скрипта в `package.json` ще немає.
