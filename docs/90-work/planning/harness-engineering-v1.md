...
> **Status:** Active — rollout v1 shipped (2026-06-29); follow-ups (golden-task suite, 0.1→1.0) лишаються відкритими.
...
`.kilo/harness-versions.json` (schemaVersion 1, поточна `0.1.7` —
...
- **Promote `0.1.7` → `1.0.0` after remaining minor bumps** (ADR-0072 §Open Q; current harness `0.1.7`).
