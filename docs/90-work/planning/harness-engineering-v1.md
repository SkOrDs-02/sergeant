...
> **Status:** Active
> **Last touched:** 2026-06-29 by @SkOrDs-02. **Next review:** 2026-09-29.
> **Owner:** @SkOrDs-02
> **Supersedes:** —
> **Related:** `E:\Temp\kilo\harness-plan.md` (тимчасовий план, видаляється після merge цієї сторінки), [NxCode "Harness-инженерия: Полное руководство"](https://example.invalid/nxcode-harness) (2026-03-01)
...
| 2   | **Dynamic Snapshot**   | `tools/agent-snapshot/snapshot.mjs`, `tools/agent-snapshot/README.md`, §0.1 у `sergeant-start-here`                                                              | [0067](docs/04-governance/adr/0067-dynamic-agent-snapshot.md) | [#73](https://github.com/Skords-01/Sergeant/pull/73) | `03601c59b` |
| 3   | **Harness Versioning** | `.kilo/harness-versions.json`, `scripts/ci-bump-harness-version.mjs`, `.github/workflows/harness-a-b.yml`, `docs/04-governance/governance/harness-versioning.md` | [0068](docs/04-governance/adr/0068-harness-versioning.md)     | [#75](https://github.com/Skords-01/Sergeant/pull/75) | `a8b656320` |
| 4   | **Entropy Janitors**   | `tools/entropy-janitors/**` (package), `.github/workflows/entropy-janitors.yml`, `docs/04-governance/governance/entropy-janitors/README.md`                      | [0066](docs/04-governance/adr/0066-entropy-janitors.md)       | [#74](https://github.com/Skords-01/Sergeant/pull/74) | `60aa46057` |
...
**Dynamic Snapshot (PR #73, ADR-0067).** Один zero-dep Node-скрипт
...
**Harness Versioning (PR #75, ADR-0068).** Append-only registry
...
**Entropy Janitors (PR #74, ADR-0066).** Workspace package
...
| ----------------------------- | ----------------------- | -------------------------------------------------------------------------- | ----------------------------------------------------------- |
| `apps/web` JS bundle (brotli) | ≤ 1.2 MB budget         | 1.14 MB (95%)                                                              | ADR-0067 §Rationale; perf budgets таблиця                   |
| `apps/web` CSS bundle         | ≤ 36 kB budget          | 34.2 kB (95%)                                                              | ADR-0067 §Rationale                                         |
...
> Примітка: bundle numbers у ADR-0067 наводяться як pre-rollout baseline
...
- **Golden-task suite для A/B harness benchmark.** ADR-0068 §Open Questions
...
- **Janitor performance baselines.** ADR-0066 §Follow-ups: track
...
- **Promote `0.1.0` → `1.0.0` after 3 minor bumps** (ADR-0068 §Open Q).
- **`lint:harness-version-freshness` janitor** (ADR-0068 §Open Q).
  Трекнуто у `docs/90-work/tech-debt/agents.md`.
- **Wire janitor issue labels у agent snapshot** (ADR-0066 §Follow-up).
...
- **NxCode стаття:** "Harness-инженерия: Полное руководство" (2026-03-01) —
  джерело методології; цитується у ADR-0066, 0067, 0068, 0069.
- **ADRs:**
  - [0066 — Scheduled Entropy Janitors](docs/04-governance/adr/0066-entropy-janitors.md)
  - [0067 — Dynamic agent snapshot for harness context](docs/04-governance/adr/0067-dynamic-agent-snapshot.md)
  - [0068 — Harness versioning and A/B evaluation](docs/04-governance/adr/0068-harness-versioning.md)
