...
### LiqPay ([checkout](https://www.liqpay.ua/en/doc), [callback](https://www.liqpay.ua/en/doc/api/callback), [API reference](https://www.liqpay.ua/en/doc) — `action:"unsubscribe"` via `POST https://www.liqpay.ua/api/request`)
