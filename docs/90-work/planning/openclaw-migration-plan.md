...
> **Canonical current status (2026-05-19):** Stage 6b is closed, Stage 7 cutover executed on 2026-05-12 22:30 UTC, and the active follow-up is legacy deletion by 2026-06-09 per Locked Decision #17. Any older "next step: Stage 6b/manual parallel run or Stage 7 draft" wording in historical validation notes should be read as superseded evidence, not active work.
...
| ✅ 7          | Phase 7 cutover executed 2026-05-12 22:30 UTC ([`cutover-openclaw-gateway.md`](../../00-start/playbooks/cutover-openclaw-gateway.md)): `OPENCLAW_BOT_TOKEN` cleared, grammy webhook deleted, Gateway live (long-poll). Deletion (Locked Decision #17): cutover-day + 28 = 2026-06-09 | Stage 6b                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | високий — deletion міркувань rollback-у |
...
| 17  | Grammy deletion         | Видалення `tools/openclaw/src/openclaw/` + `agents/{openclaw,personas,strategic-modes,dispatcher}.ts` — `set_reminder` на `cutover-day + 28 днів` (auto-PR через `/Артем`).                                                                                                                                                                                                                   |
