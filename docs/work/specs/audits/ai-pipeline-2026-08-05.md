...
[`runbook.md:283-285`](../../../operations/observability/runbook.md) — інструкція
...
[`env-vars.md:114`](../../../engineering/integrations/env-vars.md) («`=120`
(default)»), `.env.example:31`, [ADR-0022](../../../governance/adr/0022-atomic-sql-quotas.md)
і runbook.
...
Плюс розбіжність документації: [`env-vars.md:126`](../../../engineering/integrations/env-vars.md)
...
`docs/work/specs/launch/tech/ai-memory-activation.md`). Саме тому знахідка тут,
а не в Пріоритеті 1.
