...
> валідації web-продукту ([`docs/work/specs/tech-debt/mobile.md`](../tech-debt/mobile.md),
...
> [`domain-invariants.md`](../../../engineering/architecture/domain-invariants.md)) → синтез.
...
| 2   | Підключити непідключені Playwright-лейни  | 🟡 **Частково**                                                        | 44px touch-target аудит промоутнуто в блокуючий гейт `ci.yml` :: `mobile-ui-audit`. `tests/ledger` підключено в nightly (2026-08-25). Visual/Argos — прибрано [ADR-0082](../../../governance/adr/0082-private-storage-repo-posture.md) §4. |
