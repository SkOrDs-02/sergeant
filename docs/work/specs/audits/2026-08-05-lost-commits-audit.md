...
| `claude/spec-fab-manual-income`                  | 2026-07-24 | спека `docs/work/specs/fab-and-manual-income.md` — у `main` відсутня                                                                                                                                                                           |
...
закрито без мерджу. `docs/product/whats-new/2026-07-20-phone-polish.md` (+53) і 29 рядків у
...
Наслідок: оновлення `docs/governance/pr-ledger/index.json` і `PR-BACKLINKS`-блоків
...
- **`codex/work-portfolio-audit` (#308) і `codex/july-execution-batch` (#309)** — по одному
