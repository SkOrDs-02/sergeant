...
> **Status:** Closed (2026-09-01) — план виконання переїхав у спеку
> [`specs/import-external-trackers.md`](../import-external-trackers.md).
...
- **Живі OAuth/API-інтеграції** (Plaid, Strava API, YNAB API) — окрема ініціатива. Strava має власну спеку: [`specs/strava-integration.md`](../strava-integration.md).
...
- Фінансова гілка (виписки, скріни банкінгу, чеки пачкою): [`specs/receipt-scan.md`](../receipt-scan.md) § «Фаза 2 — Масове ведення» — власник поверхні, тут відвантажено.
- Кардіо через Strava: [`specs/strava-integration.md`](../strava-integration.md) — API-шлях, не файловий імпорт.
...
- Плейбук: [`docs/start/instructions/onboard-external-api.md`](../../../start/instructions/onboard-external-api.md) — для майбутніх API-інтеграцій.
