...
| **PR-1.2** | `pnpm docs:check-wip-limits` — soft warn + hard fail на violation          | `scripts/docs/check-wip-limits.mjs`, `docs/governance/governance/wip-limits.json` |
...
| **PR-2.2** | `agent-ready: yes / needs-decision / blocked` field у initiative frontmatter + сорtування в `open-work.md` | усі `docs/work/specs/initiatives/*.md` (1-рядковий додаток frontmatter), generator update |
