...
> **Last touched:** 2026-09-11 by @claude. **Next review:** 2027-09-20.
> **Status:** Active

| Field          | Value                                                                                                                                                                                                                                                                                                                                                              |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Initiative     | [`0011`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/_0011-foundation-adoption-and-process-discipline.md) Phase 3 PR 3.4                                                                                                                                                                  |
...
| Cards          | [H6](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H6-email-verification.md), [I8](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/I8-periodic-external-pentest.md) (engagement preparation) |
...
[H6](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H6-email-verification.md) було закрито 2026-05-04 у статусі `Closed (partial)`:
...
Residual risk, що фіксували pen-test sweep 2026-05-06 ([§ H6 — Residual risk](../../../governance/security/pen-tests/2026-05-hardening-sweep.md#residual-risk-1)):
...
| `REQUIRE_EMAIL_VERIFICATION` в prod (Railway)              | `false` (підтверджено A1 audit 2026-05-06 — `docs/work/specs/audits/archive/2026-05-04-csp-disable-retrospective.md` § Resolution log)                                                    |

## Threat model recap

Атака, від якої захищаємось — той же scenario, що й H6 ([H6 § Impact](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H6-email-verification.md#impact)):
...
- **Roll-back trigger після Phase D:**
  ...
  - АБО drop у DAU > 10% з [PostHog FTUX dashboards](../../../operations/observability/posthog-ftux-dashboards.md) activation-cohort.
...
- **External pen-test engagement (I8).** Sweep — internal hardening, не engagement з зовнішнім pen-tester-ом. Engagement має власний tracker у [`docs/work/specs/security-hardening/I8-periodic-external-pentest.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/I8-periodic-external-pentest.md).

## Cross-references

- H6 card: [`docs/work/specs/security-hardening/H6-email-verification.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H6-email-verification.md)
- Pen-test sweep transcript (2026-05): [`docs/governance/security/pen-tests/2026-05-hardening-sweep.md`](../../../governance/security/pen-tests/2026-05-hardening-sweep.md)
- Pen-test playbook: [`docs/start/instructions/security-pen-test-checklist.md`](../../../start/instructions/security-pen-test-checklist.md)
- Better Auth wiring: [`apps/server/src/auth.ts`](../../../../apps/server/src/auth.ts)
- Initiative 0011: [`docs/work/specs/initiatives/archive/_0011-foundation-adoption-and-process-discipline.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/initiatives/archive/_0011-foundation-adoption-and-process-discipline.md)
- Initiative 0010 (revenue-first launch, sets the launch-window): [`docs/work/specs/initiatives/0010-revenue-first-launch.md`](https://github.com/SkOrDs-02/sergeant/blob/625921e85c7e961883d4cca64d9f6a177dbba823/docs/90-work/initiatives/0010-revenue-first-launch.md)
- Deploy-config-change playbook (для Phase E env flip): [`docs/start/instructions/deploy-config-change.md`](../../../start/instructions/deploy-config-change.md)
- Launch readiness checklist (sweep — evidence для readiness gate): [`docs/work/specs/launch/business/04-launch-readiness.md`](./business/04-launch-readiness.md)
