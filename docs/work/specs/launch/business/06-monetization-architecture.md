...
> Canonical delivery owner: [`docs/work/specs/planning/pr-plan-revenue-2026-05.md`](https://github.com/Skords-01/Sergeant/blob/d068c73a2f21881d5c1305544fe99f3ea8be81f4/docs/90-work/planning/archive/pr-plan-revenue-2026-05.md). PR tables below are architecture context, not the live execution tracker.
...
> Перший PR серії — **`docs/governance/adr/0001-monetization-architecture.md`**. Без цього ADR не починаємо код. ADR прописує:
