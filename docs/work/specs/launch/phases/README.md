...
> **Last touched:** 2026-09-11 by @claude. **Next review:** 2027-10-26.
...
| ------------------------------- | ----------------------------------------------------------------- | ----------------------------------------------------------- | ------------------------------------- | -------------------------------------------------------------------------------------------------- | -------------------------- | ----------------------------------------------------------------------------------------- |
| `apps/web`                      | ✅ prod Vercel                                                    | 🟡 email+password live; Apple/Google UI shipped (env-gated) | ✅ Sentry+PostHog+CSP-RO              | ✅ [release.md § Web + API](../../../../start/instructions/release.md#1-web--api)                  | 🟡 internal+demo only      | Legal publish; live Stripe env; cookie banner                                             |
| `apps/server`                   | ✅ prod Hetzner/Coolify (`Dockerfile.api`)                        | ✅ Better Auth bearer/cookie                                | ✅ Pino+Prom+Sentry+alert-bot         | ✅ [release.md § Web + API](../../../../start/instructions/release.md#1-web--api)                  | 🟡 internal only           | Live payment prod keys + webhook endpoint verification                                    |
| `apps/mobile-shell` (Capacitor) | 🟡 Android AAB/APK CI ready, iOS CI scaffold (no Apple secrets)   | ✅ bearer reuses web                                        | ✅ Sentry WebView                     | ✅ [release.md § Mobile shell](../../../../start/instructions/release.md#2-mobile-shell-capacitor) | ❌ no external testers yet | Apple Developer enrollment ($99 + D-U-N-S); store metadata + assets                       |
| `apps/mobile` (Expo)            | ❌ internal dev-client only                                       | ✅ bearer                                                   | 🟡 Sentry+PostHog wired, no prod DSN  | ✅ [release.md § Expo](../../../../start/instructions/release.md#3-expo)                           | ❌ no external testers     | EAS prod profile lock; Apple/Google accounts; Nutrition Phase 7 (recipes AI, photo-AI) 🟥 |
...
- [ ] **DB backup restore-тест** ([playbooks/test-backup-restore.md](../../../../start/instructions/test-backup-restore.md))
- [ ] **`feature.invite_only_signup` flag** додати в [feature-flags.md registry](../../../../governance/governance/feature-flags.md)
...
- Phase 3 (Native Expo) — conditional decision gate, описаний inline у [§ Phase 3 вище](#phase-3--native-expo--conditional); рішення per [ADR-0052](../../../../governance/adr/0052-mobile-strategy-capacitor-primary.md)

### Існуючий контекст (parent of this work)

- [`docs/work/specs/launch/README.md`](../README.md) — launch hub (business + tech + product-os subtrees)
- [`docs/work/specs/launch/business/01-monetization-and-pricing.md`](../business/01-monetization-and-pricing.md)
- [`docs/work/specs/launch/business/02-go-to-market.md`](../business/02-go-to-market.md)
- [`docs/work/specs/launch/business/04-launch-readiness.md`](../business/04-launch-readiness.md)
- [`docs/work/specs/launch/product-os/ftux-master-tracker.md`](../product-os/ftux-master-tracker.md)
- [`docs/work/specs/launch/product-os/paywall-implementation-plan.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/01-product/launch/archive/product-os/paywall-implementation-plan.md)

### Architecture / ADRs

- [`docs/engineering/architecture/platforms.md`](../../../../engineering/architecture/platforms.md) — feature parity матриця (SSOT)
- [`docs/engineering/architecture/apps-status-matrix.md`](../../../../engineering/architecture/apps-status-matrix.md)
- [`docs/engineering/architecture/hosting-evolution.md`](../../../../engineering/architecture/hosting-evolution.md)
- [ADR-0068](../../../../governance/adr/0068-pricing-v4-uah-reverse-trial.md) — Free + Pro ₴199/міс / ₴1490/рік (Supersedes ADR-0051)
- [ADR-0052 — Mobile strategy: Capacitor primary](../../../../governance/adr/0052-mobile-strategy-capacitor-primary.md)
...
- [`docs/start/instructions/release.md`](../../../../start/instructions/release.md) — canonical release flow
- [`docs/start/instructions/release.md`](../../../../start/instructions/release.md) — web + API, Capacitor shell, Expo
- [`docs/start/instructions/test-backup-restore.md`](../../../../start/instructions/test-backup-restore.md)
- [`docs/start/instructions/hotfix-prod-regression.md`](../../../../start/instructions/hotfix-prod-regression.md)
