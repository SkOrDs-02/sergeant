...
- Прийнято рішення по §12: чи стартувати Phase 3 (Native Expo) як паралельний трек, чи відкласти до Expo feature-parity (Exit dashboard у [`docs/engineering/architecture/platforms.md`](../../../../engineering/architecture/platforms.md)).
...
| HTTPS Universal Links (iOS) / App Links (Android)        | `assetlinks.json` + `apple-app-site-association` у `apps/web/public/.well-known/`, Vercel headers + rewrite                                                                                                                                                                                       | [`capacitor-deep-links.md`](../../../../engineering/mobile/capacitor-deep-links.md) |
| Deep-link dispatch у web                                 | `BroadcastChannel("sergeant-shell-deeplink")` + pre-mount queue (PR-29 [#2526](https://github.com/Skords-01/Sergeant/pull/2526); PR-2 global shim removed 2026-07-20)                                                                                                                             | core                                                                                |
...
Джерело: [`apps/mobile-shell/README.md`](../../../../../apps/mobile-shell/README.md) § «Що НЕ зроблено», [`docs/engineering/architecture/platforms.md` § 3 Capacitor shell](../../../../engineering/architecture/platforms.md#-3-capacitor-shell--appsmobile-shell), [`docs/engineering/mobile/shell.md`](../../../../engineering/mobile/shell.md).
...
Джерело: [`docs/engineering/mobile/shell.md` § Передумови](../../../../engineering/mobile/shell.md#передумови) + [`apps/mobile-shell/package.json`](../../../../../apps/mobile-shell/package.json).
...
Джерело правди — [`docs/engineering/mobile/shell.md` § Release — iOS](../../../../engineering/mobile/shell.md#release--ios). Сім обов'язкових secrets для [`mobile-shell-ios-release.yml`](../../../../../.github/workflows/mobile-shell-ios-release.yml):
...
Одноразовий локальний крок (НЕ в CI, не в репо!). Джерело — [`docs/engineering/mobile/shell.md` § Release — Android](../../../../engineering/mobile/shell.md#release--android).
...
- [ ] **Native push send-pipeline** — щось на серверну сторону, навіть мінімальне (за `docs/engineering/mobile/overview.md` § Push notifications).
...
**Якщо щось ламається** — пауза rollout-у через ASC (iOS) або Play Console (Android), rollback до попереднього версії через [`docs/start/instructions/release.md § 2.4 Post-release`](../../../../start/instructions/release.md#24-post-release-верифікація).
...
- **Sprint retrospective** — раз на 2 тижні, як з web (див. [`docs/work/specs/launch/product-os/sprint-retros/`](../product-os)).
...
Джерело: [`docs/work/specs/launch/business/04-launch-readiness.md` §1](../business/04-launch-readiness.md#1-юридичне-та-compliance) — повний legal checklist.
...
4. **Cost-benefit Expo migration** — повний RN-порт Nutrition + Voice + Detox e2e — це 4–6 PR-ів. Vs підтримка Capacitor — 34 shell-commits/30 днів (з shell-tax baseline, [`ADR-0052` § Consequences](../../../../governance/adr/0052-mobile-strategy-capacitor-primary.md#consequences)).

### 12.2 ADR-0052 Exit gate

За [ADR-0052](../../../../governance/adr/0052-mobile-strategy-capacitor-primary.md): тригер для наступного ADR («Expo becomes primary») = Expo `apps/mobile/` досягає feature parity (≥ 18/22 ✅ у [feature-parity матриці `platforms.md` §0](../../../../engineering/architecture/platforms.md#-0-feature-parity-матриця-web--shell--rn)).
...
Для RN досягти 18/22 — це закрити: **RN-Nutrition full parity** (recipe/[id], photo-AI) + **RN-Voice (STT/TTS)** — обидва Phase 7 у [`docs/engineering/mobile/react-native-migration.md`](../../../../engineering/mobile/react-native-migration.md).
...
- [`docs/governance/adr/0052-mobile-strategy-capacitor-primary.md`](../../../../governance/adr/0052-mobile-strategy-capacitor-primary.md) — стратегічне рішення.
- [`docs/governance/adr/0010-mobile-dual-track-capacitor-expo.md`](../../../../governance/adr/0010-mobile-dual-track-capacitor-expo.md) — original dual-track decision.
- [`docs/engineering/architecture/platforms.md`](../../../../engineering/architecture/platforms.md) — feature parity матриця, Exit dashboard.
- [`docs/engineering/mobile/shell.md`](../../../../engineering/mobile/shell.md) — operator cheat-sheet (Android/iOS release secrets, build commands).
- [`docs/engineering/mobile/capacitor-deep-links.md`](../../../../engineering/mobile/capacitor-deep-links.md) — Universal Links / App Links setup.
- [`docs/engineering/mobile/overview.md`](../../../../engineering/mobile/overview.md) — API контракт + push notifications spec.
- [`docs/start/instructions/release.md` § 2 Mobile shell (Capacitor)](../../../../start/instructions/release.md#2-mobile-shell-capacitor) — canonical release loop.
- [`docs/work/specs/launch/business/01-monetization-and-pricing.md`](../business/01-monetization-and-pricing.md) — pricing tiers + paywall placement + IAP vs Stripe.
- [`docs/work/specs/launch/business/02-go-to-market.md`](../business/02-go-to-market.md) — GTM phases, beta metrics, PH playbook.
- [`docs/work/specs/launch/business/04-launch-readiness.md`](../business/04-launch-readiness.md) — legal + privacy + alerts + checklists.
- [`docs/work/specs/initiatives/0010-revenue-first-launch.md`](https://github.com/SkOrDs-02/sergeant/blob/625921e85c7e961883d4cca64d9f6a177dbba823/docs/90-work/initiatives/0010-revenue-first-launch.md) — overarching launch ініціатива.
