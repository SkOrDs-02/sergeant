...
> **⚠️ Хостинг оновлено [ADR-0074](../../../../governance/adr/0074-hosting-hetzner-coolify.md) (2026-07-11):** бекенд, Postgres і Redis живуть на Hetzner CX23 під Coolify; Railway виведено з експлуатації. Нижче кроки описані для Coolify; історичні Railway-деталі (id сервісів, GraphQL-мутації) лишені там, де вони пояснюють, як дійшли до поточної конфігурації.
...
Canonical behavior/ownership — [`docs/engineering/architecture/ai-memory.md`](../../../../engineering/architecture/ai-memory.md).
ADR — [`docs/governance/adr/0028-pgvector-ai-memory.md`](../../../../governance/adr/0028-pgvector-ai-memory.md).
Інтеграційний doc — [`docs/engineering/integrations/voyage-pgvector.md`](../../../../engineering/integrations/voyage-pgvector.md).
...
- [ADR-0028: pgvector + Voyage embeddings](../../../../governance/adr/0028-pgvector-ai-memory.md)
- [Voyage AI + pgvector integration doc](../../../../engineering/integrations/voyage-pgvector.md)
- [Feature flags registry](../../../../governance/governance/feature-flags.md)
