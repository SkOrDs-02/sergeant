...
2. Document **Manual E2E Runbook** — canonical copy: [`docs/start/instructions/sync-client-e2e.md`](../../../start/instructions/sync-client-e2e.md) (summary §8 below).
...
> **Canonical runbook:** [`docs/start/instructions/sync-client-e2e.md`](../../../start/instructions/sync-client-e2e.md) — копіюй у PR description або on-call triage.
...
- [`run-squad-deliver.md`](../../../start/instructions/run-squad-deliver.md) — deliver-squad recipe
- [`write-e2e-test.md`](../../../start/instructions/write-e2e-test.md) — Playwright
- [`data-exchange-storage-audit.md`](../../../engineering/architecture/data-exchange-storage-audit.md)
