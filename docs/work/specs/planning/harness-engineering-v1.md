...
| --- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | ----------- |
| 1   | **AI-PR Checklist**    | `.github/PULL_REQUEST_TEMPLATE.md`, `.github/workflows/ai-pr-checklist.yml`, `docs/governance/governance/ai-pr-checklist.md`                                  | [0069](../../../governance/adr/0069-ai-pr-checklist.md)                                                                     | [#72](https://github.com/Skords-01/Sergeant/pull/72) | `61c88579c` |
| 2   | **Dynamic Snapshot**   | `tools/agent-snapshot/snapshot.mjs`, `tools/agent-snapshot/README.md`, §0.1 у `sergeant-start-here`                                                           | [0067](../../../governance/adr/0071-dynamic-agent-snapshot.md)                                                              | [#73](https://github.com/Skords-01/Sergeant/pull/73) | `03601c59b` |
| 3   | **Harness Versioning** | `.kilo/harness-versions.json`, `scripts/ci-bump-harness-version.mjs`, `.github/workflows/harness-a-b.yml`, `docs/governance/governance/harness-versioning.md` | [0068](../../../governance/adr/0072-harness-versioning.md)                                                                  | [#75](https://github.com/Skords-01/Sergeant/pull/75) | `a8b656320` |
| 4   | **Entropy Janitors**   | Retired 2026-07-29; прямі Knip/docs/ESLint checks + standalone dual-write residue                                                                             | [0070](../../../governance/adr/0070-entropy-janitors.md), [0081](../../../governance/adr/0081-repository-simplification.md) | [#74](https://github.com/Skords-01/Sergeant/pull/74) | `60aa46057` |
...
- **Skill-trigger evals** — `docs/start/agents/skill-trigger-evals.json` + `pnpm eval:skills` (wired у `pnpm lint:skills`).
...
- **Playbook routing evals.** `docs/start/agents/playbook-routing-evals.json`
...
- **ADRs:**
  - [0066 — Scheduled Entropy Janitors](../../../governance/adr/0070-entropy-janitors.md)
  - [0067 — Dynamic agent snapshot for harness context](../../../governance/adr/0071-dynamic-agent-snapshot.md)
  - [0068 — Harness versioning and A/B evaluation](../../../governance/adr/0072-harness-versioning.md)
  - [0069 — AI-PR Checklist and validation workflow](../../../governance/adr/0069-ai-pr-checklist.md)
- **PRs:**
...
- **Governance docs:**
  - [docs/governance/governance/ai-pr-checklist.md](../../../governance/governance/ai-pr-checklist.md)
  - [docs/governance/governance/harness-versioning.md](../../../governance/governance/harness-versioning.md)
- **Tooling:**
