...
**Гейт:** manual E2E за [`sync-client-e2e.md`](../../../start/instructions/sync-client-e2e.md) (локальне середовище).
...
- [`data-exchange-storage-audit.md`](../../../engineering/architecture/data-exchange-storage-audit.md) — audit (§4.1 оновлено 2026-07-10)
- [ADR-0004](../../../governance/adr/0004-cloudsync-lww-conflict-resolution.md) — LWW
- [ADR-0065](../../../governance/adr/0065-sync-op-log-retention-and-multi-instance-fanout.md) — retention + NOTIFY
- [ADR-0073](../../../governance/adr/0073-dualwrite-generic-framework.md) — sqliteWriter framework
