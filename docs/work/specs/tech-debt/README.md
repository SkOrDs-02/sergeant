...
закриті плани прибираються з active checkout із Git permalink-ом, без додавання
до локального архіву:

| Документ                                                                                                                                                                                          | Опис                                           |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| [`priority-1-executive.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/90-work/tech-debt/archive/priority-1-executive.md)                           | Зведення P1-спринту (критичний борг)           |
| [`syncV2-engineering-ticket.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/90-work/tech-debt/archive/syncV2-engineering-ticket.md)                 | Тікет: поділ `syncV2.ts`                       |
| [`syncV2-refactor-plan.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/90-work/tech-debt/archive/syncV2-refactor-plan.md)                           | План рефакторингу Stage 2                      |
| [`syncV2-refactor-execution.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/90-work/tech-debt/archive/syncV2-refactor-execution.md)                 | Звіт виконання рефакторингу                    |
| [`technical-assessment-2026-06-05.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/90-work/tech-debt/archive/technical-assessment-2026-06-05.md)     | Історичний аудит 2026-06-05                    |
| [`technical-assessment-2026-06-05.json`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/90-work/tech-debt/archive/technical-assessment-2026-06-05.json) | Машиночитабельний зріз того ж аудиту           |
| [`express-5-migration-plan.md`](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/90-work/tech-debt/archive/express-5-migration-plan.md)                   | Express 4→5 план (виконано; asyncHandler done) |
...
```bash
grep -rn "Blocked-reason" docs/work/specs/tech-debt/
```
...
- **⚠️ Уточнено 2026-08-07 — тут була помилкова передумова.** Виміру немає взагалі: CI-джоб `Test coverage (vitest)` запускає `test:coverage:ci`, а це `turbo run test:coverage --filter=!@sergeant/mobile` — mobile **виключений** із coverage-лейна (web-focus фаза). Тобто питання не «чи є headroom», а «жоден CI-прогін не рахує mobile-покриття». Перший крок — завести mobile у coverage (окремим job-ом, бо це jest, не vitest), і лише потім говорити про ратчет.
- **Чому не blocked:** не треба Apple/Sentry/Coolify — треба дотягнути тести й тоді змінити цифру в json.
- **Що треба / варіанти:**
  1. Спочатку **під'єднати** mobile до coverage-виміру в CI, далі заміряти актуальний %.
