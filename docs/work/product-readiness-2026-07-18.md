...
> **Last validated:** 2026-07-29 by Codex (fresh `pnpm snapshot --refresh`). **Next review:** 2027-02-27.
> **Status:** Reference — ручний зріз на 2026-07-18; актуальний стан бета-підготовки живе в `docs/work/specs/audits/2026-08-04-global-qa-*` і `docs/open-work.md`.
...
| ----- | ----------------------------------------------------------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| P0    | [`sync-client-wiring.md`](./specs/planning/sync-client-wiring.md) | Ready після локального verification handoff | Testcontainers, два профілі/device E2E, `pnpm check`; потім Phase 3 SSE/ops                                         |
...
| ------------------------------- | -------------------------------------------------------------- | ---------------------------------------------------------------- |
| Initiative 0003 Phase 7         | Closed у коді (PR #326, 2026-07-20) — tracker Closed           | —                                                                |
...
## Що було застарілим або мертвим у `docs/work`
