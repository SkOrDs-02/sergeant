...
**Статус:** in progress. Створено 2026-04-25. Останнє оновлення: 2026-05-02 (13 з топ-15 закриті — PostHog інтегрований у web + server, Strict TS web rollout у Phase 4 — фази 1–3.1 виконані, PR1 #1388 ✅ + PR2 #1391 ✅ + PR3 (fizruk pages + insights) змерджені/в роботі (419 → 194 помилок, −225, ~54 % від стартового скоупу); залишилось PR4 (flip `strict: true` + зняти `allowJs`); Sentry DSN-gated; деталі у колонці Статус нижче).
...
| 3b  | **Strict TS — web (incremental)**                 | 1-2 тижні | $0               | 🔥🔥🔥 | 🟡 in progress (Phases 1–3.1 ✅; Phase 4 PR1 [#1388](https://github.com/Skords-01/Sergeant/pull/1388) ✅ + PR2 [#1391](https://github.com/Skords-01/Sergeant/pull/1391) ✅ + PR3 (fizruk pages + insights, −55) у роботі: `419 → 194` помилок; залишилось PR4 (решта + flip `strict: true` + зняти `allowJs`); див. tech-debt/frontend.md §11) |
