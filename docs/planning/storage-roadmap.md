...
- **PR #057r-flag** ✅ LANDED — drop the now-redundant
  ...
  Stage 10 PR #070r-dualwrite (✅ LANDED у [#2279](https://github.com/Skords-01/Sergeant/pull/2279)
  схема + [#2281](https://github.com/Skords-01/Sergeant/pull/2281) dual-write diff/apply +
  parity + reader); тепер unblocked, чекає 14d canary вікна на `#056r`/`#057r-flag`.
...
і LS-read drop, residual-import boot helpers). Routine — Stage 10
schema + dual-write extension ✅ COMPLETE у
[#2279](https://github.com/Skords-01/Sergeant/pull/2279) +
[#2281](https://github.com/Skords-01/Sergeant/pull/2281); LS-write
removal тепер unblocked у `#057r-tombstone` (14d canary вікно на
`#056r`/`#057r-flag`). Наступний rollout-крок: Routine
`#057r-tombstone` — drop legacy readers + tombstone
`STORAGE_KEYS.ROUTINE` після canary вікна.
