...
> **Last validated:** 2026-05-07 by @Skords-01 (Stage 9 COMPLETE 7/7 — PRs #060–#066 landed; PR #066 moved `createMemoryKVStore` to `@sergeant/shared/test-utils` and kept the web SSR/private-mode memory fallback app-local. Stage 7 9/9 — COMPLETE. Stage 8 PR #058 mobile sync-engine writer-runtime boot path landed in [#2118](https://github.com/Skords-01/Sergeant/pull/2118) alongside CloudSync v1 client cleanup. **Outstanding:** Stage 8 (SQLite cut-over rollout — 16 module rollout PR-ів: 4 модулі × 4 кроки). Stage 9 KV store swap is complete. #045 Redis — opt-in optional Stage-6 follow-up. **Next review:** 2026-08-04.
> **Status:** Active
>
...
> | 8 — SQLite cut-over rollout    | 🚧 IN PROGRESS (5/17) | [#2118](https://github.com/Skords-01/Sergeant/pull/2118) (PR #058 mobile sync-engine writer-runtime boot path + CloudSync v1 client cleanup); Stage 8 default-on dual-write slice for Routine, Fizruk, Nutrition, and Finyk/Finyk Mono mirror; read_sqlite default-on slices paused after PWA canary regression                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | LS-write safety-net removal and LS-reader removal remain gated by canary windows. Detail у §3 Stage 8 нижче. Calendar: ~3 тижні coding + 2-3 місяці canary. |
...
> **Status:** 🚧 IN PROGRESS (5/17). Stage 7 закрив **boundary** (eslint
...
##### **PR #055r2 — `feat(routine): default-on feature.routine.sqlite_v2.read_sqlite`** PAUSED
...
- **PR #055f2** PAUSED - default-on `feature.fizruk.sqlite_v2.read_sqlite`.
...
Наступні rollout-кроки лишаються gated на canary: `read_sqlite`
default-on, потім removal LS/MMKV write safety net і legacy readers.
