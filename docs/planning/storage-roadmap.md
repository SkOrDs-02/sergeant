...
> | 8 — SQLite cut-over rollout    | 🚧 IN PROGRESS (9/17) | [#2118](https://github.com/Skords-01/Sergeant/pull/2118) (PR #058 mobile sync-engine writer-runtime boot path + CloudSync v1 client cleanup); Stage 8 default-on dual-write slice for Routine, Fizruk, Nutrition, and Finyk/Finyk Mono mirror; Routine, Fizruk, Nutrition, and Finyk read_sqlite default-on slices                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | LS-write safety-net removal and LS-reader removal remain gated by canary windows. Detail у §3 Stage 8 нижче. Calendar: ~3 тижні coding + 2-3 місяці canary. |
...
> **Status:** 🚧 IN PROGRESS (9/17). Stage 7 закрив **boundary** (eslint
...
##### **PR #055r2 — `feat(routine): default-on feature.routine.sqlite_v2.read_sqlite`** 🚧 ACTIVE
...
- **PR #055f2** 🚧 ACTIVE — default-on `feature.fizruk.sqlite_v2.read_sqlite`.
...
- **PR #055n2** 🚧 ACTIVE — default-on `feature.nutrition.sqlite_v2.read_sqlite`.
...
- **PR #055k2** 🚧 ACTIVE — default-on `feature.finyk.sqlite_v2.read_sqlite`
