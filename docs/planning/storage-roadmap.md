...
> | 11 — Nutrition SQLite full-state | 🚧 IN PROGRESS (3/4)                                           | [#2290](https://github.com/Skords-01/Sergeant/pull/2290) (PR #070n-schema), [#2291](https://github.com/Skords-01/Sergeant/pull/2291) (PR #070n-dualwrite), [#2292](https://github.com/Skords-01/Sergeant/pull/2292) (PR #070n-mobile-dualwrite). Remaining: #057n-tombstone-mobile (drop MMKV writes for water-log + shopping-list + residual import).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Stage 11 web → mobile mirror landed (3/4). New Nutrition SQLite tables `nutrition_water_log` + `nutrition_shopping_list` populated на обох платформах через dual-write. Mobile MMKV-write для water-log + shopping-list залишається active (LS-primary) — drop через `#057n-tombstone-mobile`.                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
##### **Stage 11 — extend Nutrition SQLite schema to full LS coverage** 🚧 IN PROGRESS (3/4)
...
> web + mobile після [#2291] + [#2292]. Web `#057n-tombstone` ([#2274])
> не зачепив water-log + shopping-list — вони лишаються LS-primary
> без MMKV-write drop до `#057n-tombstone-mobile`. 2 нові entity
> classes — найменший залишковий schema gap у tail; пріоритет вище
> за Stage 12.
