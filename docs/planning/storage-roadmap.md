...
PR #055n3), Finyk ([#2260](https://github.com/Skords-01/Sergeant/pull/2260),
PR #055k3) — `<m>.sqlite.dualwrite.parity` decision-gate metric
тепер populated на всіх 4 модулях. PR #056r landed with revised
scope (drop dual-write feature-flag gating only; Routine SQLite
schema gap blocks LS-write removal — див. footnote) у commit
`ff852475`. Наступні rollout-кроки лишаються gated на canary:
drop LS/MMKV write safety net (PR #056f / #056n / #056k —
