...
> **Status:** 🔄 IN PROGRESS (4/9 LANDED, 5 PROPOSED) — last updated 2026-05-10.
>
> **Landed (4/9):** PR #071 ✅ ([#2322](https://github.com/Skords-01/Sergeant/pull/2322)
...
>
> **Still proposed (5/9):** PR #073 (mobile `NUTRITION_SAVED_RECIPES`
...
#### **PR #079 — `docs: refresh Initiative 0003 Phase 6 status + add ADR-0047 sunset exit-criteria`** 📋 PROPOSED — doc-only
