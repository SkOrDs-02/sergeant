...
are documented у `docs/audits/archive/2026-05-07-app-audit.md` §A1.
...
6. **Тиждень 10-11:** SPIKE. Hard decision gate. ← **ЗАКРИВАЄТЬСЯ ЗАРАЗ.**
   ...
   [`docs/02-engineering/notes/spikes/routine-sqlite-v2.md`](../02-engineering/notes/spikes/routine-sqlite-v2.md#decision-gate-metrics).
