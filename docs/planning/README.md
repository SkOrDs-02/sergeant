...
| [`pr-plan-testing-devx-2026-05.md`](./pr-plan-testing-devx-2026-05.md)       | PR-план виконання прожарки `2026-05-13-testing-devx-roast` — 12 PR-карток (Testing + DevX) + 3 quick-wins                                                     | Active                                                         |
