...
| PR-B | `open`    | [#2385](https://github.com/Skords-01/Sergeant/pull/2385) | `devin/1778445962-openclaw-poc-spike`             | 2026-05-10        | Phase 0.5 PoC: 1 read tool (`recall_memory`) + 1 write tool (`create_github_issue` × A/B/C) + budget hook + audit hooks + parity харнес (3+ golden conversations) + міграції 054/055. Spike note: `docs/notes/spikes/openclaw-poc.md` (go decision). 64 unit tests pass. |
