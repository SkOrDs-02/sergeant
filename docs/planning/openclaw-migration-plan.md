...
| 🚧 5b/plan    | `/plan <topic>` strategic mode (`before_agent_start` hook + PLAN_PRIMER injection + drift gate з legacy console primer)                              | Stage 5a — **PR open** (Stage 5b PR-1)                                                                                                                                     | низький                                   |
| ⬜ 5b/analyze | `/analyze <anomaly>` strategic mode                                                                                                                  | Stage 5b/plan                                                                                                                                                              | низький                                   |
