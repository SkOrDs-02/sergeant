...
| PR-D   | `open`    | [#TBD](https://github.com/Skords-01/Sergeant/pull/TBD)   | `devin/1778488623-openclaw-pr-d-write-tools`       | 2026-05-10        | Phase 4: 4 нові write-tools (commit_to_strategy_doc, post_to_topic, pause_workflow, mute_alert) + Variant B approval factory + n8n Tier C audit gate + write-audit integration через /write-audit/log. 5 write-tools total. Server endpoints вже існують (ADR-0036).                                                                                                                               |
