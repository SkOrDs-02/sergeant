...
| PR-C1c | `pending` | —                                                        | —                                                 | —                 | Phase 1 — 4 n8n delegation з tier-aware approval + `refresh_business_snapshot` meta-tool + 5 нових server endpoints (`/n8n/*`, `/snapshot/refresh`). Залежить від PR-C1b.                                                                                                                                      |
