...
> **Last validated:** 2026-05-11 by Devin. **Next review:** після Phase 6.5 parity-window gate (перед Phase 7 cutover).
> **Status:** Active (v3.1 — team-shape, cost-aware routing, n8n tiers, **18 locked decisions**). Phase 0.5 PoC complete (PR-B [#2385](https://github.com/Skords-01/Sergeant/pull/2385) merged 2026-05-10), Phase 1 split-PRs (C1a–C1d) merged, Phase 2 (C2 [#2394](https://github.com/Skords-01/Sergeant/pull/2394)) merged, Phase 3 (C3 [#2408](https://github.com/Skords-01/Sergeant/pull/2408)) merged 2026-05-11, Phase 4 (D [#2411](https://github.com/Skords-01/Sergeant/pull/2411)) merged 2026-05-11, Phase 5 (E [#2413](https://github.com/Skords-01/Sergeant/pull/2413)) merged 2026-05-11, Phase 0 Gateway infra + Phase 7 cutover docs (PR-F [#2420](https://github.com/Skords-01/Sergeant/pull/2420)) merged 2026-05-11. Phase 6.5 parallel run + Phase 7 cutover — pending (manual / operational). **Cutover-підхід уточнено 2026-05-11:** окрема нова Telegram bot-identity для Gateway; існуючий grammy-бот `@OpenClaw_sergeant_bot` лишається працювати undisturbed як fallback (без feature-flag flip у `tools/console`).
