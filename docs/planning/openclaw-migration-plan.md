...
| PR-C1a | `pending` | —                                                        | —                                                 | —                 | Phase 1 — Foundation + 11 read-only HTTP-proxy tools поверх існуючих server endpoints + plugin governance (CODEOWNERS, turbo, ESLint, plop). 0 нових server endpoints. Розщеплено з PR-C1 2026-05-10 (4-PR Phase 1 split).                                                                                     |
