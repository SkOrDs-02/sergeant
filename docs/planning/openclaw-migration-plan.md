...
| 🚧 5d         | Morning-digest cron (native `cron.*` config + idempotent `provision-cron.mjs`)                                                                               | Stage 4a + spike (4)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | низький — по спайку native scheduler API підтверджений |
...
| Stage 5d  | `🚧 open` | —                                                                                                                                                                | Morning-digest cron (`0 9 * * *` Europe/Kyiv) — native `cron.*` config-block + idempotent `~/.openclaw/cron/jobs.json` provisioning у `docker-entrypoint.sh` (via `ops/openclaw/provision-cron.mjs`). Payload `/digest day` — Layer 0 shortcut router рендерить canned Markdown ($0 LLM cost), Gateway announce-ить у Telegram DM founder-а. 18 нових `node --test` unit-тестів + golden snapshot drift-gate.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Stage 4a + Spike     |
