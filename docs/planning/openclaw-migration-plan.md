...
| PR-C1d | `open`    | —                                                        | `devin/1778452267-openclaw-c1d-routers`           | 2026-05-10        | Phase 1 — Layer 0 shortcut router + Layer 1 cheap router + 17 shortcuts + canned templates + integration tests над повним 24-tool registry. 0 нових server endpoints. Залежить від PR-C1c.                                                                                                                     |
