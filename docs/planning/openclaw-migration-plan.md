...
| ⏭️ 6b         | ≥1 тиждень manual parallel run (grammy vs Gateway) — **SKIPPED (fast-forward)**: заміщений Stage 4c live-verification (production smoke 12/12 PASS) + Stage 6a CI parity-harness під real SDK. Founder підтвердив паритет і прийняв рішення 2026-05-12.                                           | Stage 6a                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | низький — fast-forward, rollback через restore `OPENCLAW_BOT_TOKEN` ≤2026-06-09 |
| ✅ 7          | Stage 7 cutover EXECUTED 2026-05-12 22:30 UTC ([`cutover-openclaw-gateway.md`](../playbooks/cutover-openclaw-gateway.md)): `OPENCLAW_BOT_TOKEN` cleared, grammy webhook deleted, Gateway live (long-poll). Deletion (Locked Decision #17): cutover-day + 28 = **2026-06-09** — окремий cleanup-PR | Stage 6a (6b skipped)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | високий — deletion міркувань rollback-у                                         |
