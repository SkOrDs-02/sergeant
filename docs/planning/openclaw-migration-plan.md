...
| 🚧 7          | Phase 7 cutover playbook ([`cutover-openclaw-gateway.md`](../playbooks/cutover-openclaw-gateway.md)) + deletion checklist (Locked Decision #17)               | Stage 6b                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | високий — deletion міркувань rollback-у |
