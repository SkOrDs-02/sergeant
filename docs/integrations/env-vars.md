...
> **Last validated:** 2026-05-06 by @dimastahov16012003. **Next review:** 2026-08-04.
> **Status:** Active
...
Дивись [`docs/observability/metrics.md` §16 Cost monitoring](../observability/metrics.md#16-cost-monitoring-pr-33) для PromQL-запитів і [`docs/observability/dashboards/cost-monitoring.json`](../observability/dashboards/cost-monitoring.json) для імпорту в Grafana.
