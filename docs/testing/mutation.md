...
Coverage показує лише, **які рядки** виконалися в тестах, але не показує, **чи реально assertions ловлять регресії**. Можна мати 100% coverage і нульовий sense — тести просто прокликують функції без перевірок (див. [diagnostic 04 §7.3](../audits/2026-05-03-web-deep-dive/04-security-observability-testing-devx.md#73-bad-mutation-testing-не-використовується)).
