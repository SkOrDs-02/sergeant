...
> **Status:** In progress (Phase 1 — 4/5 PR merged 2026-05-04: [#1659](https://github.com/Skords-01/Sergeant/pull/1659) skills-lint, [#1660](https://github.com/Skords-01/Sergeant/pull/1660) Hard Rules categorization, [#1670](https://github.com/Skords-01/Sergeant/pull/1670) playbook-schema extension, [#1672](https://github.com/Skords-01/Sergeant/pull/1672) playbook-language warn-only linter. PR 1.2b — backfill EN-only playbook'ів (1-й batch: `add-hard-rule.md`) — відкрито [#1772](https://github.com/Skords-01/Sergeant/pull/1772). PR 1.3 (Husky `tsc-files` pre-commit gate) — `hold` → `ready` після зникнення pre-existing TS-помилок (`#1572`-fallout). Phase 2 — 2/4 merged 2026-05-04: [#1684](https://github.com/Skords-01/Sergeant/pull/1684) `docs/superpowers/` → `docs/agents/` rename, [#1705](https://github.com/Skords-01/Sergeant/pull/1705) PR 2.3 release-\* консолідація. PR 2.1 — specialists ↔ skills mapping — відкрито [#1687](https://github.com/Skords-01/Sergeant/pull/1687). PR 2.4 — access-\* консолідація — відкрито [#1707](https://github.com/Skords-01/Sergeant/pull/1707) (rebased on `main` after PR 2.3 merge). Phase 3 — PR 3.1 (demote design rules) — відкрито [#1725](https://github.com/Skords-01/Sergeant/pull/1725); PR 3.3 (slim `.env.example` + `docs/integrations/env-vars.md` reference) — відкрито [#1775](https://github.com/Skords-01/Sergeant/pull/1775). Phase 4 — 1/3 merged 2026-05-04: [#1785](https://github.com/Skords-01/Sergeant/pull/1785) PR 4.1 Renovate maintainer runbook (`docs/ops/renovate.md`) — пост-ADR-0044 scope узгоджено з Option 3 (Renovate primary + Dependabot security-only). PR 4.3 — workflow audit + Owner block у 26 workflow-файлах — відкрито [#1788](https://github.com/Skords-01/Sergeant/pull/1788). Phase 5 — PR 5.2 (`docs/agents/onboarding.md`) — відкрито [#1728](https://github.com/Skords-01/Sergeant/pull/1728).)
...
| Dead-code інструменти                                                        | 3 (knip + ts-prune + depcheck) | 3 (без змін; PR 4.2 не розпочато)                                                                | 1 (knip)                                                      |
