...
> **Status:** In progress (Phase 1 — 4/5 PR merged 2026-05-04: [#1659](https://github.com/Skords-01/Sergeant/pull/1659) skills-lint, [#1660](https://github.com/Skords-01/Sergeant/pull/1660) Hard Rules categorization, [#1670](https://github.com/Skords-01/Sergeant/pull/1670) playbook-schema extension, [#1672](https://github.com/Skords-01/Sergeant/pull/1672) playbook-language warn-only linter. Phase 2 — 1/4 merged 2026-05-04: [#1684](https://github.com/Skords-01/Sergeant/pull/1684) `docs/superpowers/` → `docs/agents/` rename. PR 2.1 — specialists ↔ skills mapping — відкрито [#1687](https://github.com/Skords-01/Sergeant/pull/1687). PR 2.3 — release-\* консолідація — відкрито [#1705](https://github.com/Skords-01/Sergeant/pull/1705). PR 2.4 — access-\* консолідація — відкрито [#1707](https://github.com/Skords-01/Sergeant/pull/1707).)
...
| 4.x  | TBD    | Operational cleanup                            | —                                                                                                                       | PR 4.2 (knip-only) на pause: `pnpm knip` на main має 13 unused files / 79 unused exports / 6 types — pre-existing. Acceptance вимагає clean-baseline; передвиборна cleanup-PR робиться окремо.                                                                                                                                                                                                                                                                                                     |
