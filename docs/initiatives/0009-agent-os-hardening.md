...
> **Status:** In progress (Phase 1 — 5/5 core PR merged: [#1659](https://github.com/Skords-01/Sergeant/pull/1659) skills-lint, [#1660](https://github.com/Skords-01/Sergeant/pull/1660) Hard Rules categorization, [#1670](https://github.com/Skords-01/Sergeant/pull/1670) playbook-schema extension, [#1672](https://github.com/Skords-01/Sergeant/pull/1672) playbook-language warn-only linter, [#1821](https://github.com/Skords-01/Sergeant/pull/1821) PR 1.3 Husky `tsc-files` pre-commit gate (мерджнуто 2026-05-05, commit `7c80774f`). PR 1.2b — backfill EN-only playbook'ів — **8 batches merged**: [#1772](https://github.com/Skords-01/Sergeant/pull/1772) `add-hard-rule.md`, [#1799](https://github.com/Skords-01/Sergeant/pull/1799) `write-postmortem.md`, [#1825](https://github.com/Skords-01/Sergeant/pull/1825) `add-feature-flag.md`, [#1826](https://github.com/Skords-01/Sergeant/pull/1826) `cleanup-dead-code.md`, [#1830](https://github.com/Skords-01/Sergeant/pull/1830) `declare-incident.md`, [#1832](https://github.com/Skords-01/Sergeant/pull/1832) `retire-feature-flag.md`, [#1833](https://github.com/Skords-01/Sergeant/pull/1833) `run-weekly-operator-digest.md`, [#1835](https://github.com/Skords-01/Sergeant/pull/1835) `restore-from-backup.md`, [#1844](https://github.com/Skords-01/Sergeant/pull/1844) `lang: en` allow-list для 7 deprecated `release-*`/`access-*` stub-ів (мерджнуто 2026-05-05). PR 1.2b — open batches: [#1845](https://github.com/Skords-01/Sergeant/pull/1845) `test-backup-restore.md` (UA), [#1846](https://github.com/Skords-01/Sergeant/pull/1846) `add-hubchat-tool.md` (UA, ratio 0.36 → 0.74), [#1848](https://github.com/Skords-01/Sergeant/pull/1848) UA trigger phrase у `description:` для всіх 12 SKILL.md (acceptance criterion PR 1.2). PR 1.2b — round-11 batch: `run-weekly-operator-digest.md` дотягнуто з ratio 0.38 → ≥ 0.4 (видавалось на margin після #1833 first-pass; round-11 finalize). PR 1.2b — **round-12 closeout** (відкрито 2026-05-05): `lang: en` allowlist для 3 активних operational-reference playbook-ів (`access-governance.md`, `deploy-config-change.md`, `release.md`) + 12 SKILL.md body. Rationale: усі 3 playbook-и — операційні reference-доки, що cross-reference vendor-CLI / vendor docs (Vercel, Railway, Fly, EAS, GitHub) і читаються cross-team / external on-call shadowers; терминологія English-native, тому EN = ціль, не баг. SKILL.md body — agent-runtime контракт; UA trigger phrase у `description:` (shipped via #1848) розв'язує UA-only chat routing, body EN тримає tool-calling stability на Anthropic / OpenAI (їхня attention bias на English у tool-routing). `pnpm lint:playbook-language` warn-list після round-12: 16 → 1 (тільки `modify-n8n-workflow.md` лишається, його закриває open #1871). Після #1871 merge → 0; PR 1.2c (gate-ON `--warn-only` → blocker) тоді можна шипити. Phase 2 — 2/4 merged 2026-05-04: [#1684](https://github.com/Skords-01/Sergeant/pull/1684) `docs/superpowers/` → `docs/agents/` rename, [#1705](https://github.com/Skords-01/Sergeant/pull/1705) PR 2.3 release-\* консолідація. PR 2.1 — specialists ↔ skills mapping — відкрито [#1687](https://github.com/Skords-01/Sergeant/pull/1687). PR 2.4 — access-\* консолідація — відкрито [#1707](https://github.com/Skords-01/Sergeant/pull/1707) (rebased on `main` after PR 2.3 merge). Phase 3 — PR 3.1 (demote design rules) — відкрито [#1725](https://github.com/Skords-01/Sergeant/pull/1725); PR 3.3 (slim `.env.example` + `docs/integrations/env-vars.md` reference) — відкрито [#1775](https://github.com/Skords-01/Sergeant/pull/1775). Phase 4 — 3/3 merged 2026-05-04: [#1785](https://github.com/Skords-01/Sergeant/pull/1785) PR 4.1 Renovate maintainer runbook (`docs/ops/renovate.md`), [#1788](https://github.com/Skords-01/Sergeant/pull/1788) PR 4.3 workflow audit + Owner block у 26 workflow-файлах (мерджнуто `67ba6b0b`), [#1795](https://github.com/Skords-01/Sergeant/pull/1795) PR 4.2 knip-only dead-code (мерджнуто `e7592f71`). Phase 5 — 2/3 merged: [#1796](https://github.com/Skords-01/Sergeant/pull/1796) PR 5.1 Plop `new-skill` + `new-playbook` generators (мерджнуто 2026-05-04, commit `0a9dff6a`); [#1828](https://github.com/Skords-01/Sergeant/pull/1828) PR 5.1b Plop `new-package` generator (мерджнуто 2026-05-05, commit `15e1089f`). PR 5.2 (`docs/agents/onboarding.md`) — відкрито [#1728](https://github.com/Skords-01/Sergeant/pull/1728).)
...
| 1.2b | open   | Backfill EN-only playbook'ів і SKILL.md        | [#1772](https://github.com/Skords-01/Sergeant/pull/1772) + [#1799](https://github.com/Skords-01/Sergeant/pull/1799) + [#1825](https://github.com/Skords-01/Sergeant/pull/1825) + [#1826](https://github.com/Skords-01/Sergeant/pull/1826) + [#1830](https://github.com/Skords-01/Sergeant/pull/1830) + [#1832](https://github.com/Skords-01/Sergeant/pull/1832) + [#1833](https://github.com/Skords-01/Sergeant/pull/1833) + [#1835](https://github.com/Skords-01/Sergeant/pull/1835) + [#1844](https://github.com/Skords-01/Sergeant/pull/1844) + [#1845](https://github.com/Skords-01/Sergeant/pull/1845) + [#1846](https://github.com/Skords-01/Sergeant/pull/1846) + [#1848](https://github.com/Skords-01/Sergeant/pull/1848) | Відкрито 2026-05-04. **9 batches merged, 3 open.** Batches 1–4 (#1772 `add-hard-rule.md`, #1799 `write-postmortem.md`, #1825 `add-feature-flag.md`, #1826 `cleanup-dead-code.md`) — повні UA-переклади з збереженням technical tokens, code examples і structural identifiers. Batches 5–8 (#1830 `declare-incident.md`, #1832 `retire-feature-flag.md`, #1833 `run-weekly-operator-digest.md`, #1835 `restore-from-backup.md`) — той самий патерн. **9-й batch [#1844]** (мерджнуто 2026-05-05): `lang: en` + `lang-reason` allow-list для 7 deprecated `release-*` / `access-*` stub-ів (`Status: Deprecated`, `Superseded by:` redirect) — переклад stub-ів безсенсовний; усі редиректять на canonical `release.md` / `access-governance.md`. `pnpm lint:playbook-language` warn-list = 28 → 21. **Open**: [#1845](https://github.com/Skords-01/Sergeant/pull/1845) `test-backup-restore.md` (UA, останній active EN-only playbook з appendix); [#1846](https://github.com/Skords-01/Sergeant/pull/1846) `add-hubchat-tool.md` (UA, ratio 0.36 → 0.74; transition-state файл з попереднього rewrite); [#1848](https://github.com/Skords-01/Sergeant/pull/1848) UA-тригерна фраза в `description:` для всіх 12 SKILL.md (acceptance criterion PR 1.2 — body translation залишається для PR 1.2c). Після всіх 3 merge: warn-list ≈ 19 (`access-governance.md`, `release.md`, `deploy-config-change.md`, `modify-console-agent.md` ratio=0.40, `modify-n8n-workflow.md`, `rotate-openclaw-credentials.md`, `run-weekly-operator-digest.md` ratio=0.38, всі 12 SKILL.md body). Залишок (~7 active playbooks з low ratio + 12 SKILL.md body) — наступні batch'і; deprecated stub-список вичерпано #1844. Може йти паралельно з фазою 2. |
