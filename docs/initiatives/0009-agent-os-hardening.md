...
- Уніфікація іменування й структури: канонічна мапа specialists ↔ skills; `docs/superpowers/` → `docs/agents/`; обʼєднання дубльованих playbook'ів (release-_, access-_).
...
- [ ] Жодне внутрішнє посилання на `docs/superpowers/` не лишилося.
...
- [ ] `docs/superpowers/` → `docs/agents/` мейгрейцію завершено.
...
- [`docs/superpowers/agent-skills-catalog.md`](../superpowers/agent-skills-catalog.md) (mіграє в `docs/agents/` у фазі 2.2).
- [`docs/superpowers/agent-workflows.md`](../superpowers/agent-workflows.md) (те саме).
