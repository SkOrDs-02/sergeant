...
> **Status:** In progress (Phase 1 — 4/5 PR merged 2026-05-04: [#1659](https://github.com/Skords-01/Sergeant/pull/1659) skills-lint, [#1660](https://github.com/Skords-01/Sergeant/pull/1660) Hard Rules categorization, [#1670](https://github.com/Skords-01/Sergeant/pull/1670) playbook-schema extension, [#1672](https://github.com/Skords-01/Sergeant/pull/1672) playbook-language warn-only linter. PR 1.3 (Husky `tsc-files` pre-commit gate) — `hold` → `ready` після зникнення pre-existing TS-помилок (`#1572`-fallout). Phase 2 — 2/4 merged 2026-05-04: [#1684](https://github.com/Skords-01/Sergeant/pull/1684) `docs/superpowers/` → `docs/agents/` rename, [#1705](https://github.com/Skords-01/Sergeant/pull/1705) PR 2.3 release-\* консолідація. PR 2.1 — specialists ↔ skills mapping — відкрито [#1687](https://github.com/Skords-01/Sergeant/pull/1687). PR 2.4 — access-\* консолідація — відкрито [#1707](https://github.com/Skords-01/Sergeant/pull/1707) (rebased on `main` after PR 2.3 merge).)
...
| 3.3  | TBD    | Slim `.env.example` + повний reference         | —                                                                                                                       | Не розпочато                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
