...
| H7  | PG pool size 10 — undersized для AI ingestion    | [PR-13](./pr-13-postgres-pool-sizing.md)         | **Closed** — `PG_POOL_SIZE` default 10→20, slow-connect Sentry breadcrumb + `db_slow_pool_connects_total`, [`docs/observability/pg-pool-sizing.md`](../../observability/pg-pool-sizing.md) |
