...
**Acceptance:** ADR-0047 з `Status: Accepted`, `apps/mobile/README.md` і `apps/mobile-shell/README.md` мають freshness-header з рішенням.

> **Зняте з фази 1:** ADR-0046 (OpenClaw park) — owner ухвалив працювати паралельно. Якщо в майбутньому стане очевидним, що OpenClaw блокує revenue, переоцінимо окремою ініціативою.
...
- [ ] Mobile-strategy ADR-0047 із `Status: Accepted` (Capacitor primary, Expo paralleled, обидва підтримуються).
