...
| 0016 | [CHANGELOG release-cut automation](./0016-changelog-release-cut.md)                                 | 2026-05-29 | Done   | `changelog:cut` script shipped; first cut `v2026.05.29` executed. Fixed latent commit-scope bug (`release` → `root`). Phase 2/3 proposed-only.                                                                     |
