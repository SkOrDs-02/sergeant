...
| 0017 | [Hub Settings & Reports mount perf](./0017-hub-tabs-mount-perf.md)                                   | P1        | `@Skords-01` | Sprint 3 (conditional) + Finalize | In progress (2026-05-24) — **Sprint 0 + Sprint 1 + Sprint 2 shipped**. Sprint 0 RUM instrumentation live; Sprint 1 per-section lazy + Suspense for 4 heavy module sections + `useInView` gate on Finyk Monobank query ([#3102](https://github.com/Skords-01/Sergeant/pull/3102)); **Sprint 2 HubReports per-card lazy merged 2026-05-24 via [#3094](https://github.com/Skords-01/Sergeant/pull/3094) (`5c98b41e`).** Remaining: **Sprint 3** (Web Worker for aggregate) — conditional on post-merge PostHog `aggregateReport` P95 > 50 ms; **Finalize** PR — bundle gate update + `docs/tech-debt/frontend.md` watchlist drain + Outcome. Target: Settings P50 10 s → ≤ 1 s. Source: [`docs/tech-debt/frontend.md` §2.5](../tech-debt/frontend.md). |
| 0018 | [Agent semantic retrieval (`agent:find`)](./0018-agent-semantic-retrieval.md)                        | P2        | `@Skords-01` | —                                 | In progress (2026-06-08) — Phases 1–4 code-complete: lexical+semantic `agent:find` поверх committed retrieval-index, HR#24 `agent:check-index` gate + golden-eval (recall@5=1.0 / MRR=0.92), zero-dep `agent_find` MCP-tool + промоція у start-here. Залишок: live-mode acceptance (одноразовий `pnpm agent:embed` + before/after заміри). [ADR-0066](../adr/0066-agent-semantic-retrieval-over-knowledge-graph.md).                                                                                                                                                                                                                                                                                                                                |
| 0019 | [Agent routing (`agent:route`)](./0019-agent-routing.md)                                             | P2        | `@Skords-01` | —                                 | In progress (2026-06-08) — code-complete: tool-agnostic `pnpm agent:route` (git-diff → specialist-skill + active hard-rules зі scope-глобів + suggested `agent:find`), reuse `skill-mapping.json` + `hard-rules.json`, без committed harness-хука. Промоція у start-here. Залишок: live-mode acceptance + опційна harness-wiring поза репо. [Initiative 0018](./0018-agent-semantic-retrieval.md) (Tier 1 sibling).                                                                                                                                                                                                                                                                                                                                 |
| 0020 | [Agent decisions log](./0020-agent-decisions-log.md)                                                 | P3        | `@Skords-01` | —                                 | In progress (2026-06-08) — code-complete: курований `docs/agents/decisions.md` (усталені рішення/вподобання, щоб агент не перепитував), промоція у start-here + agents/README; тонкий покажчик на канон, не паралельний SoT (HR#15). Залишок: live usage між сесіями. [Initiative 0019](./0019-agent-routing.md) (Tier 2 sibling).                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
- [archive/\_0002-mobile-platform-decision.md](./archive/_0002-mobile-platform-decision.md) — archived 2026-06-01 (Closed); canonical home: [`../adr/0052-mobile-strategy-capacitor-primary.md`](./../adr/0052-mobile-strategy-capacitor-primary.md) + [`./0010-revenue-first-launch.md`](./0010-revenue-first-launch.md).
- [archive/\_0011-foundation-adoption-and-process-discipline.md](./archive/_0011-foundation-adoption-and-process-discipline.md) — archived 2026-06-01 (Done); canonical home: Hard Rule #15 (`validate-pr-body.mjs`) + [`../launch/email-verification-sweep.md`](./../launch/email-verification-sweep.md).
...
- [archive/\_0014-knowledge-graph-and-catalogs.md](./archive/_0014-knowledge-graph-and-catalogs.md) — archived 2026-06-01 (Done); canonical home: [`../adr/0058-knowledge-graph-schema.md`](./../adr/0058-knowledge-graph-schema.md) + `docs/architecture/` generated catalogs.
