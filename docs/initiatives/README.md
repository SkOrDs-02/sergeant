...
| ---- | -------------------------------------------------------------------------- | --------- | ------------ | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0001 | [Module decomposition + `max-lines` guard](./0001-module-decomposition.md) | P0        | `@Skords-01` | Sprint 1 (2 wk)  | In progress (Phase 1 [#1555](https://github.com/Skords-01/Sergeant/pull/1555) merged; Phase 2 — 4 of 5 PRs відкрито: [#1593](https://github.com/Skords-01/Sergeant/pull/1593), [#1594](https://github.com/Skords-01/Sergeant/pull/1594), [#1596](https://github.com/Skords-01/Sergeant/pull/1596), [#1597](https://github.com/Skords-01/Sergeant/pull/1597) — лишився `decomp-routine-app`) |
