...
| 15  | `tsconfig.strict: true` для `apps/web` поетапно    | 5      | 4    | 1.25  | [02 §1.0](./02-architecture-and-state.md) — done (foundation: `noUncheckedIndexedAccess` для `@sergeant/shared`, 28 errors, 485 tests зеленi) [#1635](https://github.com/Skords-01/Sergeant/pull/1635) |
| 16  | Storybook для top 20 компонентів                   | 3      | 3    | 1.00  | [04 §8.6](./04-security-observability-testing-devx.md) — done (foundation: Storybook 10 + Button/Badge/Card stories у `apps/web`) [#1647](https://github.com/Skords-01/Sergeant/pull/1647)             |
