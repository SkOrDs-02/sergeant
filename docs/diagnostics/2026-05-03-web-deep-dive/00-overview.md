...
| 6   | `localStorage` allowlist burndown CI metric        | 4      | 2    | 2.00  | [02 §2.2](./02-architecture-and-state.md) — done (`pnpm lint:localstorage-allowlist`); follow-up done (production count 19 → 16: `perf.ts` + `useDarkMode.ts` migrated to `safeReadStringLS` / `safeReadLS` / `safeWriteLS`) [#1674](https://github.com/Skords-01/Sergeant/pull/1674)                                                                                    |
...
| 8   | Form-engine unification                            | 5      | 3    | 1.67  | [01 §3.1](./01-frontend-ergonomics.md) — done (foundation: `useApiForm` + 12 tests) [#1614](https://github.com/Skords-01/Sergeant/pull/1614); follow-up done (rollout: AuthPage `LoginForm` + `RegisterForm` + zod schemas + 8 нових RTL-тестів) [#1671](https://github.com/Skords-01/Sergeant/pull/1671)                                                                |
...
| 15  | `tsconfig.strict: true` для `apps/web` поетапно    | 5      | 4    | 1.25  | [02 §1.0](./02-architecture-and-state.md) — done (foundation: `noUncheckedIndexedAccess` для `@sergeant/shared`, 28 errors, 485 tests зеленi) [#1635](https://github.com/Skords-01/Sergeant/pull/1635); follow-up done (`@sergeant/nutrition-domain` enabled, 10 errors в 4 файлах закрито, 21/21 tests зелені) [#1681](https://github.com/Skords-01/Sergeant/pull/1681) |
| 16  | Storybook для top 20 компонентів                   | 3      | 3    | 1.00  | [04 §8.6](./04-security-observability-testing-devx.md) — done (foundation: Storybook 10 + Button/Badge/Card stories у `apps/web`) [#1647](https://github.com/Skords-01/Sergeant/pull/1647); follow-up done (3 → 8 компонентів: +Banner / Skeleton / Tooltip / DataState / Modal) [#1678](https://github.com/Skords-01/Sergeant/pull/1678)                                |
