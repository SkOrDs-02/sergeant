...
| `product.md`                | `product-tracking-model-product`                 | Product model (value flows, entities, group hierarchy).                 |
| `tracking-plan.yaml`        | `product-tracking-design-tracking-plan`          | Target tracking plan (designed, not necessarily implemented).           |
| `delta.md`                  | `product-tracking-design-tracking-plan`          | Diff between current state and target.                                  |
| `instrument.md`             | `product-tracking-generate-implementation-guide` | SDK-specific implementation guide.                                      |
