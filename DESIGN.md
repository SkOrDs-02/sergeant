...
Акценти — tier-400 модуля (emerald/cyan/coral/lime-400); текст поверх акцент-філу — завжди ink `#14100e`, ніколи білий.
...
**Значення vs система.** Диференціатор — це те, що **не можна записати як значення токена**. Палітра, радіус, шрифт, spacing — конфіг: копіюється за п'ять хвилин і саме це видає генератор. Крем-база, teal/coral/lime і Manrope — гігієна, не відмінність: крем + іржавий акцент — це підпис AI-індустрії 2025–2026 (Anthropic, Cohere, xAI, Mistral). Відмінність тримають системи: module-accent containment, спосіб вираження глибини, типографічна дисципліна, UA-голос і — найсильніше — **форма, що виражає крос-модульні зв'язки** (причина існування продукту за [`product-overview.md §1`](./docs/01-product/model/product-overview.md); її неможливо ні згенерувати, ні скопіювати). Ніколи не відповідай на слоп перефарбуванням.
