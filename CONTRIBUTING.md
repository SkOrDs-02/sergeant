...
2. Знайди playbook для свого сценарію в [docs/start/instructions/playbook-catalog.md](./docs/start/instructions/playbook-catalog.md).
...
Кожен override у `pnpm.overrides` (root `package.json`) трекається окремо — `pnpm lint:pnpm-overrides` падає, якщо range уже не resolves до одного major-а ([L1](https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/L1-uuid-override.md)).
...
5. Онови docs/governance/governance/playbooks у тому ж PR, якщо поведінка або процес змінилися.
...
- Каталог: [docs/start/instructions/playbook-catalog.md](./docs/start/instructions/playbook-catalog.md)
- Trigger index: [docs/start/instructions/INDEX.md](./docs/start/instructions/INDEX.md)
- Overview і taxonomy: [docs/start/instructions/README.md](./docs/start/instructions/README.md)
...
| `docs/governance/pr-ledger/index.json`          | `node scripts/pre-commit-derived-artifacts.mjs --ledger`                                                                  |
...
Reviewer checklist живе в [docs/governance/governance/review-checklist.md](./docs/governance/governance/review-checklist.md).

### Hard rules (з `AGENTS.md`)

Нумерація — канонічна, з розривами: правила #8, #9, #11–#14, #16, #17 і #24
retired рішенням [ADR-0081](./docs/governance/adr/0081-repository-simplification.md).
...
| 23  | Documentation history — no local archive trees                                        |
| 25  | Auto-generated docs must start with `<!-- AUTO-GENERATED -->` marker                  |
| 26  | Merged PRs touching canonical docs must update `docs/governance/pr-ledger/index.json` |

Джерела істини:

- Human-readable contract: [AGENTS.md](./AGENTS.md)
- Machine-readable registry: [docs/governance/governance/hard-rules.json](./docs/governance/governance/hard-rules.json)
- Generated matrix: [docs/governance/governance/hard-rules-matrix.md](./docs/governance/governance/hard-rules-matrix.md)
...
pnpm gen new-playbook   # docs/start/instructions/<slug>.md з валідним schema + freshness
pnpm gen:adr            # docs/governance/adr/<NNNN>-<title>.md (auto-numbered)
...
- Agent operating system: [docs/start/agents/README.md](./docs/start/agents/README.md)
- Planning/roadmaps: [docs/work/specs/planning/README.md](./docs/work/specs/planning/README.md)
