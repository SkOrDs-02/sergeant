...
export const webBlocks = [
  ...
  },
  {
    ...
    rules: {
      ...
      // апостроф `ʼ`, без довгого тире, звертання на «ти». `error`, а не
      // `warn`, бо аудит 2026-08-26 показав: правила існували роками
      // тільки як документ, і саме тому дрейф зібрався в НАЙНОВІШОМУ
      // коді (чек-скан, bulk-імпорт, Сільпо). Попередження тут нічого
      // не змінило б — його просто не читають.
