...
export default [
  ...
  //
  // Scoped to `apps/server/**` only — the web app never queries
  // pg directly.
  {
  ...
  // Server module-size discipline — max-lines: 600 for server TS files.
  // Per Hard Rule #18 extended to server side.
  {
    files: ["apps/server/src/**/*.{js,ts}"],
    ignores: [
      "apps/server/src/**/*.test.{js,ts}",
