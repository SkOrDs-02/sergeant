...
//
// See docs/work/specs/audits/2026-05-13-consolidated-page-audit.md § Theme 4.
// Burn-down target: 2026-Q3. See docs/governance/governance/rules/10-lifecycle-markers.md.
...
if (JSON_OUTPUT) {
  ...
  if (violationCount > 0) {
    ...
    process.stdout.write(
      `  to each file's top-level JSDoc. See docs/governance/governance/rules/10-lifecycle-markers.md.\n\n`,
    );
    if (!JSON_OUTPUT) {
