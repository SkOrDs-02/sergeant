...
const DEFAULT_OUTPUT = resolve(
  REPO_ROOT,
  "docs/governance/governance/freshness-dashboard.html",
);
...
export function gatherEntries(
  ...
  for (const item of tracked) {
    ...
    // GitHub-хендл складається лише з літер, цифр і дефісів — крапки в ньому
    // бути НЕ може. Раніше клас символів містив `.`, тому регекс з'їдав крапку
    // кінця речення й рендерив власника як `@Skords-01.` (з крапкою) у кожному
    // рядку дашборда, де хедер закінчувався на хендлі.
    const ownerMatch =
...
export function renderHtml(entries, { today = todayISO() } = {}) {
  ...
  // Hard Rule #25: маркер `<!-- AUTO-GENERATED -->` має бути ПЕРШИМ рядком
  // файлу, дослівно. Lifecycle-статус (Rule #10) — окремим коментарем нижче.
  return `<!-- AUTO-GENERATED -->
<!-- **Status:** Active — generated by scripts/docs/generate-freshness-dashboard.mjs. Do not edit by hand. -->
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
