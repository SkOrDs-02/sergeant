...
// initiative under `docs/work/specs/initiatives/` MUST carry an `> **Agent-ready:**`
...
//
// Active = top-level `docs/work/specs/initiatives/[0-9]*.md` files. Excluded:
...
function main() {
  ...
  if (missing.length > 0) {
    ...
    for (const row of missing) {
      lines.push(`   • docs/work/specs/initiatives/${row.file}`);
    }
    lines.push(
