...
//
// Linked roadmap: docs/start/agents/skills-evolution-roadmap.md (PR 5).
// Linked rule: docs/governance/governance/rules/22-skill-body-security-scan.md.
  ...
  if (allHits.length > 0) {
    ...
    console.error(
      "SKILL.md body contains patterns that could instruct an agent to " +
        ...
        "See docs/governance/governance/rules/22-skill-body-security-scan.md.",
    );
    process.exit(1);
  }
