...
// cron). Linked to `docs/work/specs/planning/pr-plan-2026-05.md` § PR-20 / PR-22
// і § Day 60 decision-point (kill module якщо recall@4 < 0.4).
//
// Документація: docs/engineering/architecture/rag-eval.md (curation, formulas, baseline).
//
// Що робить:
