...
| `kvStore deep-import cleanup`        | до 2026-05-02         | Deprecated storage deep-import paths migrated to adapter/bootstrap modules. The old codemod is no longer needed as a runnable migration.                                                                                                                                                                                | ✅ enforced by `pnpm lint:kvstore-deep-imports` (`scripts/check-kvstore-deep-imports.mjs`)                                                                           |

> Removed: `strip-js-extensions/` (2026-09-03 — `@removeBy 2026-09-01` настав; одноразовий codemod прибрано, long-term enforcement — `import/extensions: never`, PR #1411; сам скрипт лишається в Git history).
