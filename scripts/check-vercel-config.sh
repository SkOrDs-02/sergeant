...
# (картка архівована, локального файлу немає — https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H7-vercel-config-drift.md).
#
...
#
# Оновлюй `docs/operations/deploy/vercel.md` разом із цим списком.
set -euo pipefail
...
if [[ ${#extras[@]} -gt 0 ]]; then
  ...
  echo "https://github.com/Skords-01/Sergeant/blob/d1a37e0bed4e403477376eae9ee9a078e4179da8/docs/04-governance/security/hardening/archive/H7-vercel-config-drift.md"
  echo "and docs/operations/deploy/vercel.md."
  exit 1
fi
...
if [[ ${#missing[@]} -gt 0 ]]; then
  ...
  echo "docs/operations/deploy/vercel.md."
  exit 1
fi
