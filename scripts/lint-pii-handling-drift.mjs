...
// machine-readable mirror in `docs/governance/security/pii-handling.md`
...
// Information disclosure). See docs/work/specs/planning/pr-plan-security-obs-2026-05.md S10.
//
// Modes:
...
export const DOC_PATH = "docs/governance/security/pii-handling.md";
