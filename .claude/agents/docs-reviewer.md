...
When a PR modifies canonical docs — files in `docs/governance/`, `docs/architecture/`, `docs/adr/`, `AGENTS.md`, `CLAUDE.md`, or `docs/agents/` — it must also update `docs/pr-ledger/index.json` with an entry for this PR.
