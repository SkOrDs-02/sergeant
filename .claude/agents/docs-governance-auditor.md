...
- Agent skills: `docs/start/agents/agent-skills-catalog.md`
- Playbooks: `docs/start/instructions/playbook-catalog.md` + generated `INDEX.md`
- Open work: `docs/open-work.md`; merged-PR ground truth: `docs/governance/pr-ledger/index.json`
