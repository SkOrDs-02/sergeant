export const meta = {
  ...
  whenToUse:
    'When the user wants a prioritized action plan across docs/work/specs/audits/* or wants to fan out execution. Pass args={mode:"triage"|"execute", limit?:N, filter?:"substring"}.',
  phases: [
    {
      title: "Parse",
    ...
    {
      title: "Synthesize",
      detail: "rank, write report to docs/work/specs/audits/_runner-report.md",
    },
  ],
};
...
Write the report to \`docs/work/specs/audits/_runner-report.md\` with a proper lifecycle header:
\`\`\`
# Audit runner report
...
return {
  ...
  reportPath: "docs/work/specs/audits/_runner-report.md",
  reportPreview:
