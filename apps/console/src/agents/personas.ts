...
> = {
  ...
  ops: new Set([
    ...
    "get_stripe_metrics",
    "recall_memory",
    // ADR-0034 (Phase 4): write-tools relevant for ops persona — pause
  ...
  growth: new Set([
    ...
    "read_strategy_docs",
    "recall_memory",
    // ADR-0034: growth can propose strategy-doc updates, file follow-up
  ...
  eng: new Set([
    ...
    "get_github_releases",
    "recall_memory",
    // ADR-0034: eng can file tech-debt issues and post engineering
  ...
  finance: new Set([
    ...
    "record_decision",
    "query_app_db",
    // ADR-0034: finance can commit budget / runway updates to a
