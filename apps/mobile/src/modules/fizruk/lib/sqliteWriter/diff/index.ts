 ...
 * `apps/web/src/modules/fizruk/lib/sqliteWriter/diff.ts` — kept
 ...
 * (`from "./sqliteWriter/diff"`) continue to resolve unchanged.
 */
...
// Public re-exports ------------------------------------------------------
// Preserves the historical surface of `from "./sqliteWriter/diff"`. Internal
