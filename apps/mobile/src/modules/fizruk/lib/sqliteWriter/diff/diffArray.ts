 ...
 * daily-log entries, workout templates, wellbeing rows).
 *
 * Extracted from the monolithic `diff.ts` during the P2.2a
 ...
 * emitted op order stays deterministic across hosts.
 */
