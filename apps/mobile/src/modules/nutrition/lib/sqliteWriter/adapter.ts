 ...
 * Двійник цього ж дефекту у web виправлено 2026-08-24; спільний
 * `deviceWallClockToInstant` лишає настінну частину недоторканою (день-ключ
 * і показаний час читаються назад без змін) і дописує фактичний зсув
 * пристрою.
 */
