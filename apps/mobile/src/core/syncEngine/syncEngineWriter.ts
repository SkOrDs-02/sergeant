/**
 * Mobile sync v2 writer runtime.
 *
 * Mirrors `apps/web/src/core/syncEngine/syncEngineWriter.ts` — same
 * factory, same DI shape, same public surface. Lives here (not in a
 * shared package) so the platform-specific singleton wiring stays
