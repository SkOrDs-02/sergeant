 ...
 * Status: Active
 *
 * Реєстр системних промптів і те, чи зобов'язані вони нести межу порад.
 *
...
/**
 * Промпти, що спілкуються з користувачем порадами — межа обов'язкова.
  ...
  return walk(MODULES_DIR)
    .filter((full) => {
      ...
      return (
        ...
        // `export ` тут обов'язковий у патерні: промпти винесені в
