 ...
 *
 * Читає incoming W3C `traceparent` (або `x-trace-id` fallback), кладе traceId
 * у ALS store і echo-їть назад у `X-Trace-Id`. Якщо нічого валідного не
 * прийшло — генерує новий 32-hex ID.
 */
