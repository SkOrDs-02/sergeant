...
export function registerRitualsRoutes(r: Router, pool: Pool): void {
  ...
  r.post("/api/internal/openclaw/briefing/morning", async (req, res) => {
  ...
  r.post("/api/internal/openclaw/ritual/weekly", async (req, res) => {
  ...
  r.post("/api/internal/openclaw/ritual/monthly", async (req, res) => {
