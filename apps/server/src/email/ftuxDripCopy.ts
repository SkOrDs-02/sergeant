...
function buildDay0(input: FtuxDripTemplateInput): FtuxDripTemplate {
  ...
  const text = [
    hello,
    "",
    "Sergeant це це твій помічник для трекінгу витрат, звичок, тренувань і харчування. Чотири модулі в одному додатку, без зайвого галасу.",
    "",
  ...
  const html = wrapHtml(
    [
      ...
      `<p>Sergeant це це твій помічник для трекінгу витрат, звичок, тренувань і харчування. Чотири модулі в одному додатку, без зайвого галасу.</p>`,
