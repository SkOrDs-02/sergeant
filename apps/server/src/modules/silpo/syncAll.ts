 ...
 *
 * Чому не BullMQ. `bullmq` лежить у залежностях сервера, але жодного
 * воркера в кодовій базі немає — заводити воркер-процес, Redis-чергу і
 * власний деплой-юніт заради одного періодичного джоба дорожче, ніж один
 * HTTP-роут за наявним `INTERNAL_API_KEY`-гардом, який смикає n8n. Коли
 * фонових задач стане більше однієї — це буде правильний момент завести
 * чергу, не раніше.
 *
