 ...
 *
 * Підтримується рівно те, що реально трапляється в банківських
 * XLSX-експортах: не-Zip64 архів, метод 0 (stored) і 8 (deflate). Zip64 і
 ...
 * `sharedStrings.xml` річної виписки — одиниці мегабайт, 64 МБ це межа з
 * великим запасом, за якою вхід уже не схожий на банківський експорт. */
