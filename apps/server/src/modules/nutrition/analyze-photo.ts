...
"macros" — усі null, "ingredients" і "questions" — порожні масиви. Не вигадуй
страву і не питай про порцію того, чого не їдять.
...
Спершу скажи, чи на фото їжа. Якщо ні — поверни "isFood": false і напиши, що
там насправді. Якщо так — опиши страву і порахуй приблизне КБЖВ, а за потреби
задай уточнення.`,
  };
}
