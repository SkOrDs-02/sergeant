...
- таблиці немає — усе одно ОЦІНИ КБЖВ за назвою страви і типовим складом
  такої страви, а першим питанням постав пропозицію сфотографувати таблицю
  харчової цінності, щоб порахувати точно.

Нуль і «не знаю» — різні речі. 0 став лише тоді, коли значення справді
нульове (вода, чай без цукру). Якщо оцінити не вдається — став null. Ніколи
не віддавай нулі замість невідомого: нуль у журналі означає «страва без
калорій», а не «не порахував».
