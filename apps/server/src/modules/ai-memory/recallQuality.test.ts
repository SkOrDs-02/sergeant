/**
 * Метрики якості retrieval-у AI-пам'яті.
 *
 ...
 *   2. У логи доїде вміст пам'яті. Це персональні дані (Hard Rule #21), і
...
const hit = (score: number, content = "секретний вміст пам'яті") => ({
  id: 1,
...
describe("якість recall — метрики", () => {
  ...
  it("у лог не доїжджає ні вміст пам'яті, ні текст запиту", async () => {
