  ...
  const rules = [
    {
      ...
      text: "Пропуск із причиною не ламає серію. Без причини стрік чесно перерветься, але історія і висновки лишаться.",
      link: null,
    },
    {
      n: "02",
      title: "Мовчить, коли не впевнений",
      text: "Кожен звʼязок підписаний рівнем впевненості: від «поки що збіг» до «тримається стабільно». Нижче порогу – тиша.",
      link: null,
    },
    {
      n: "03",
    ...
    },
    {
      ...
      text: "Модулі, ручний трекінг і підключення банку платними не стануть. Платні – надбудови поверх ядра: безлімітний AI, фото їжі, автосинк у фоні.",
      link: null,
    },
  ];
