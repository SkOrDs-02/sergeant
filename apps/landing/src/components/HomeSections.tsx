      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex min-h-[280px] flex-col gap-1 bg-finyk px-6 py-7 text-ink-text">
          ...
          <p className={`${body} text-ink-text/90`}>
            Синк із Monobank і сканер чеків: фото або QR. Бюджети в гривні,
            борги під контролем. Без ручного вводу.
          </p>
...
export function StatusSection() {
  const now = [
    ...
    "Сканер чеків: фото або QR, поодинці й пачкою",
  ...
  const soon = [
    "Синк ПриватБанку: вже тестується в беті",
...
export const FAQ_ITEMS = [
  {
    ...
    a: "Ні. Картки синкаються з Monobank автоматично, готівку закриває сканер чеків: фото або QR. Руками – хіба те, на що чека немає.",
  },
  {
