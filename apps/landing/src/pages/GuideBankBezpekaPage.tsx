...
const QA: { q: string; why: string; sergeant: ReactNode }[] = [
  ...
  },
  {
    ...
    why: "Має бути перелік полів, а не загальна фраза про шифрування.",
    sergeant: (
      <>
        ...
        <article className="mx-auto flex w-full max-w-3xl flex-col gap-10 px-5 pb-20 pt-12 sm:px-8 sm:pt-16">
          ...
          <section>
            ...
            <p className="mt-5 max-w-2xl leading-relaxed text-foreground">
              ...
              аудиту й сертифікатів на кшталт ISO у Sergeant зараз немає:
              ...
              можна перевірити самому: рівень доступу, кнопку відкликання на
              сайті банку і наявність експорту.
            </p>
          </section>
          ...
          <div className="flex flex-col gap-2.5 border-t border-cardline pt-6">
            <p className="text-sm leading-relaxed text-muted">
              Фінік тягне виписку одним токеном Monobank і веде бюджети в
              гривні, тож ручного вводу сум там немає. Решта деталей приходить
              із чеків: сканер фото і чеки Сільпо з програми лояльності. Усе, що
              застосунок бачить і чого не бачить, зібрано на сторінці{" "}
              <a href="/data" className={link}>
                Твої дані
              </a>{" "}
