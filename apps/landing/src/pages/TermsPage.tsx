...
export default function TermsPage() {
  ...
  const h2 = "mt-8 font-display text-xl font-bold text-foreground-strong";
  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-3xl px-5 pb-24 pt-12 sm:px-8 sm:pt-16">
        <h1 className="font-display text-4xl font-bold tracking-tight text-foreground-strong">
          Умови використання
        </h1>
        ...
        <p className={p}>
          ...
          без попередження. Чесний стан – у розділі «Що вже працює, а що ще ні»
          на головній. Сервіс надається «як є», без гарантій безперервної
          роботи.
        </p>
