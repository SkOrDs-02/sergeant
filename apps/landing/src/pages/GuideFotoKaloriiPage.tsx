      ...
      <article className="mx-auto flex w-full max-w-3xl flex-col gap-10 px-5 pb-20 pt-12 sm:px-8 sm:pt-16">
        ...
        <section>
          ...
          <p className="mt-4 max-w-2xl leading-relaxed text-foreground">
            Закономірність одна на всю таблицю. Фото сильне у питанні «що це» і
            слабке у питанні «скільки цього».
          </p>
          <p className="mt-4 max-w-2xl leading-relaxed text-foreground">
            Саме тому Sergeant не зупиняється на кадрі. Оцінку він дає одразу, а
            коли непевний – ставить одне-три короткі питання: скільки грамів у
            порції, чи була олія, який соус. Відповідаєш одним рядком, і цифри
            перераховуються. Це закриває рівно ті рядки таблиці, де фото сліпе.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-4 max-w-2xl leading-relaxed text-foreground">
            ...
            порівнюється з тижнем і тренд лишається чесним. Псує картину
            похибка, що стрибає: три дні ти зважував, чотири оцінював з фото, і
            ці два числа поруч уже про різні речі.
          </p>
          <p className="mt-4 max-w-2xl leading-relaxed text-foreground">
            ...
            дивись на середнє за тиждень: один обід нічого не означає, а звична
            структура тижня видно вже за кілька тижнів записів.
          </p>
        </section>
        ...
        <div className="flex flex-col gap-2.5 border-t border-cardline pt-6">
          <p className="text-sm leading-relaxed text-muted">
            ...
            чернетку запису з КБЖВ і, коли моделі бракує даних, кілька коротких
            питань. Відповів – цифри перерахувались, підтвердив – запис у
            журналі. Поруч живуть сканер штрихкодів, українська база продуктів,
            рецепти й комора – саме ті три верхні рівні точності, до яких фото
            веде. Скажу прямо: AI-розпізнавання фото входить у платний план.
            Ядро обліку, штрихкод, ручний запис і підключення Monobank лишаються
