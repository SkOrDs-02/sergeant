...
const STEPS = [
  "Поклади в кадр знайомий предмет: виделку або столову ложку. Модель міряє розмір відносно чогось знайомого, і коли такої опори в кадрі немає, вона просто вгадує.",
  "Знімай згори під кутом, а не строго вертикально. Вид рівно зверху ховає висоту гірки, тобто половину обʼєму.",
...
export default function GuideFotoKaloriiPage() {
  usePageMeta({
    ...
    jsonLd: {
      ...
      "@type": "Article",
      headline:
        "Чи можна порахувати калорії страви по фото – і наскільки це точно",
      inLanguage: "uk",
        ...
        <article className="mx-auto flex w-full max-w-3xl flex-col gap-10 px-5 pb-20 pt-12 sm:px-8 sm:pt-16">
          ...
          <section>
            ...
            <p className="mt-4 max-w-2xl leading-relaxed text-foreground">
              ...
              про це є{" "}
              <a href="/guides/kbzhu" className={link}>
                гайд про КБЖУ
              </a>
              .
            </p>
          ...
          <section>
            ...
            <p className="mt-4 max-w-2xl leading-relaxed text-foreground">
              ...
              похибка, що стрибає: три дні ти зважував, чотири оцінював по фото,
          ...
          <div className="flex flex-col gap-2.5 border-t border-cardline pt-6">
            <p className="text-sm leading-relaxed text-muted">
              ...
              чернетку запису з КБЖУ і, коли моделі бракує даних, кілька
              ...
              платний план. Ядро обліку, штрихкод, ручний запис і синк Monobank
              лишаються безкоштовними назавжди.
            </p>
