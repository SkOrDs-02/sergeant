...
const SITUATIONS = [
  ...
  },
  {
    ...
    what: "Брати базовий продукт («сир кисломолочний 9%») замість пошуку конкретної ферми.",
  },
  {
...
const STEPS = [
  ...
  "Перший тиждень зважуй. Око систематично занижує порцію крупи і завищує порцію овочів, і свій особистий зсув краще дізнатися на старті, ніж на другому місяці.",
  "Домашні страви записуй збереженим рецептом. Борщ, який ти вариш кожні десять днів, має бути одним записом: кожне повторне перебирання буряка з квасолею наближає той день, коли ти закинеш облік.",
        ...
        <article className="mx-auto flex w-full max-w-3xl flex-col gap-10 px-5 pb-20 pt-12 sm:px-8 sm:pt-16">
          ...
          <div className="flex flex-col gap-2.5 border-t border-cardline pt-6">
            <p className="text-sm leading-relaxed text-muted">
              ...
              спостереження там підписане рівнем впевненості, а поки даних
              замало, підсумок чесно мовчить.
            </p>
            <a
              href="/beta"
