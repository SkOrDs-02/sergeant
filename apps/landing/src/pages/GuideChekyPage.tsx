      ...
      <article className="mx-auto flex w-full max-w-3xl flex-col gap-10 px-5 pb-20 pt-12 sm:px-8 sm:pt-16">
        ...
        <div className="flex flex-col gap-2.5 border-t border-cardline pt-6">
          <p className="text-sm leading-relaxed text-muted">
            ...
            лягають у витрати, а продуктові рядки можна віддати в Харчування,
            щоб не вводити ту саму покупку двічі. Банківські транзакції тим
            часом тягне синк Monobank, тож чек лишається тим, чим і має бути:
            джерелом деталей. Суму банк знає і без нього.
          </p>
          <a
            href="/beta"
