 ...
 * оновлювало КБЖВ-цілі. Тепер усі п'ять писачів ваги ходять сюди.
 *
 * ЩО ЦЕ НЕ РОБИТЬ: не обирає канонічну таблицю ваги і не переносить дані.
 * Куди саме лягає сам fizruk-запис (`fizruk_daily_log` чи
 * `fizruk_measurements`), вирішує викликач — як і раніше. Ця функція лише
 * тримає похідний профільний знімок у синхроні. Вибір SoT — окремий ADR
 * (стадії 3-4).
 */
 ...
 *
 * Ідемпотентна щодо сміттєвого вводу: не-число, `NaN`, `0` чи від'ємне
