...
const COPY = {
  ...
  // лишається `pro`. Тут стояло «Pro», через що один тариф звався по-різному
  // на `/pricing`, у налаштуваннях і тут (browser-QA 2026-09-02).
  body: "Оформи Premium, щоб не втратити доступ до AI-чату й автосинку Mono.",
