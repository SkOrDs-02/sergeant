    ...
    >
      {forgotState === "sent" ? (
        <div className="space-y-3">
          <p>
            Якщо такий email зареєстровано, ми відправили лист із посиланням для
            скидання пароля. Перевір вхідні та папку «Спам». Локальні дані на
            пристрої залишаються без змін.
          </p>
          <Button
            type="button"
            variant="secondary"
        ...
        <>
          ...
          <Input
            ...
            autoComplete="email"
            // eslint-disable-next-line jsx-a11y/no-autofocus -- after user explicitly opens the forgot-panel, focus the single input
            autoFocus
            disabled={forgotState === "sending"}
            aria-describedby={authError ? "auth-forgot-email-error" : undefined}
          />
          {authError && (
            <p
