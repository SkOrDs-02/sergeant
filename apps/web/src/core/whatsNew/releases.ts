...
export const RELEASES: readonly WhatsNewRelease[] = [
  {
    ...
    summary:
      "Багато всього з твого минулого візиту: з'явився план Premium зі сторінкою тарифів і вхід через Apple, AI-асистент тепер працює з твоїми реальними даними та розуміє голос, а застосунок отримав свіжий вигляд і спокійніший головний екран. Плюс — чіткий демо-режим, кращий контраст і читабельність та правильний підрахунок днів за київським часом.",
    items: [
      {
        kind: "feature",
        text: "З'явився план Premium і сторінка тарифів, а ще вхід через Apple — апґрейд за кілька тапів.",
      },
      {
        kind: "feature",
      ...
      {
        kind: "improvement",
        text: "Свіжий вигляд застосунку, спокійніший головний екран і нова інтерактивна мапа м'язів у Фізруку.",
      },
      {
        kind: "improvement",
