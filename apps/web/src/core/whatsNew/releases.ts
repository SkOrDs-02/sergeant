...
export const RELEASES: readonly WhatsNewRelease[] = [
  {
    id: "2026-08-10-beta-wave",
    date: "2026-08-10",
    title: "Літнє оновлення: гроші, тренування і розумніший асистент",
    summary:
      "З твого минулого візиту застосунок помітно підріс. Фінік навчився банкам Monobank і власним коштам кредитки, Фізрук отримав редизайн активного тренування й травма-модель, яка справді виключає вправи з порад, а AI-асистент — пам'ять, якою ти керуєш, і підтвердження перед незворотними діями. Плюс новий вигляд «Чорнило», гнучкі стріки із запланованою паузою і перенесення твоїх даних в акаунт при першому вході.",
    items: [
      {
        kind: "feature",
        text: "Фінік бачить банки Monobank і власні кошти кредитки, дає нотатку до транзакції та дрил-даун з кільця категорій.",
      },
      {
        kind: "feature",
        text: "Фізрук: редизайн активного тренування, чесний 1RM і травми, які реально виключають вправи з порад.",
      },
      {
        kind: "feature",
        text: "AI-асистент пам'ятає твій профіль — факти можна переглянути й видалити, а перед незворотними діями він перепитає.",
      },
      {
        kind: "improvement",
        text: "Їжа і Рутина: комора з обліком, історія води, гнучкий стрік із запланованою паузою та таймлайн звичок.",
      },
      {
        kind: "improvement",
        text: "Новий вигляд «Чорнило»: темна база, світла тема «Папір» і акуратніша типографіка чисел та підписів.",
      },
      {
        kind: "fix",
        text: "Банка Monobank більше не дублюється карткою й не рахується двічі, а кома тепер працює як роздільник.",
      },
    ],
    cta: { label: "Подивитись Фізрук", href: "/fizruk" },
  },
  {
