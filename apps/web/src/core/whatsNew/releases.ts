...
export const RELEASES: readonly WhatsNewRelease[] = [
  {
    id: "2026-07-20-phone-polish",
    date: "2026-07-20",
    title: "Застосунок на телефоні: чистіше й розумніше",
    summary:
      "Багато роботи над тим, як застосунок почувається на телефоні: правильні відступи й безпечні зони на iOS, стабільна навігація та прокрутка, причесані форми й картки у всіх модулях. А ще звіти стали кориснішими — PDF з реальними інсайтами й хронологічна мапа звичок — і у Фізруку з'явилася об'ємна 3D-мапа тіла.",
    items: [
      {
        kind: "improvement",
        text: "На телефоні застосунок тримається екрана: правильні відступи, плавна навігація, прокрутка й безпечні зони на iOS.",
      },
      {
        kind: "fix",
        text: "Причесали форми, картки й таблиці у Фінику, Фізруку, Раціоні та Рутині — менше збоїв на дотик.",
      },
      {
        kind: "feature",
        text: "Експорт у PDF тепер містить твої справжні інсайти, а мапа звичок стала хронологічною стрічкою.",
      },
      {
        kind: "feature",
        text: "У Фізруку з'явилася об'ємна 3D-мапа тіла — рельєфніша й наочніша.",
      },
      {
        kind: "improvement",
        text: "Ручні транзакції тепер зв'язуються між собою, меню налаштувань стало чистішим, а чат прокручується рівно.",
      },
    ],
  },
  {
