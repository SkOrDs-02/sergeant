...
export const RELEASES: readonly WhatsNewRelease[] = [
  {
    id: "2026-07-27-money-and-privacy",
    date: "2026-07-27",
    title: "Гроші на автопілоті й контроль над своїми даними",
    summary:
      "Гроші стали менш ручними: фінансові цілі самі підтягують прогрес із банок Monobank, а транзакції отримали власні нотатки, вибір категорії списком і фільтри. Окремо — більше контролю над тим, що про тебе знає застосунок: пам'ять AI тепер можна переглянути й почистити, особисті дані маскуються перед відправкою в модель, а всю історію можна забрати з собою в CSV.",
    items: [
      {
        kind: "feature",
        text: "Фінансові цілі самі підтягують прогрес із банок Monobank — більше не треба вносити руками.",
      },
      {
        kind: "feature",
        text: "У транзакціях з'явились власні нотатки, вибір категорії списком і фільтри в історії витрат.",
      },
      {
        kind: "feature",
        text: "Пам'ять AI відкрита — подивись і видали будь-який факт; перед незворотними діями він питає дозвіл.",
      },
      {
        kind: "feature",
        text: "Експорт у CSV поряд із JSON, а особисті дані маскуються перед відправкою в AI.",
      },
      {
        kind: "improvement",
        text: "Вода в харчуванні: історія за попередні дні, міні-статистика і швидше введення.",
      },
      {
        kind: "fix",
        text: "Перший вхід у гроші більше не нав'язує фінплан, а підписи полів у формах стали видимими.",
      },
    ],
    cta: { label: "Відкрити гроші", href: "/finyk" },
  },
  {
