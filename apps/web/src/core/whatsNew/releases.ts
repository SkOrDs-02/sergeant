...
export const RELEASES: readonly WhatsNewRelease[] = [
  {
    id: "2026-06-26-calm-hub-polish",
    date: "2026-06-26",
    title: "Спокійніша головна, демо-режим і розумніший асистент",
    summary:
      "Головний екран став спокійнішим: модулі — на першому місці, з'явився режим «тиша» і дзвіночок сповіщень. Демо-режим тепер чітко позначений, з нього легко вийти. AI-асистент зберігає те, що ти йому диктуєш, прямо у відповідні розділи. А дні й нагадування рахуються за київським часом.",
    items: [
      {
        kind: "feature",
        text: "Спокійніша головна: модулі першими, режим «тиша» і дзвіночок сповіщень.",
      },
      {
        kind: "feature",
        text: "Демо-режим чітко позначений, а вийти з нього можна одним дотиком по бейджу.",
      },
      {
        kind: "improvement",
        text: "AI-асистент зберігає твої записи прямо в розділи: харчування, тренування, фінанси.",
      },
      {
        kind: "improvement",
        text: "Дні, нагадування й статистика тепер рахуються за київським часом.",
      },
      {
        kind: "fix",
        text: "Велика хвиля доступності: контраст, читачі екрана, навігація клавіатурою, менше зайвих анімацій.",
      },
    ],
    cta: { label: "До головної", href: "/" },
  },
  {
