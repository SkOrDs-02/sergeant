 ...
 *     акцентом модуля (Hard Rule #12 — акцент не виходить за свій сабтрі).
 */
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Каталог із ~60 сценаріїв із прикладами команд — від «додай витрату» до розбору тижня.",
        icon: "list",
        href: "/assistant",
      },
      {
        id: "insights",
        title: "Звіти й тижневий розбір",
        description:
          "Порада дня на головній і тижневий звіт по всіх модулях разом, з помітними звʼязками між ними.",
        icon: "bar-chart",
        href: "/insights",
      },
    ],
