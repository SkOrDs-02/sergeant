...
export function ProposalsUXSection() {
  return (
    <Sec
      ...
      intro="Мокапи UX-ідей у форматі порівняння: ліворуч поточна поведінка застосунку, праворуч пропозиція. Прототипи без привʼязки до реальних даних; тему перемикай у шапці."
    >
