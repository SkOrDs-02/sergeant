 ...
 *
 * Today the Hub shows a single hero total. The proposal turns the top strip
 * into a horizontally swipeable, scroll-snapped set of KPI cards (spend /
 * streak / calories …) so the most-glanced numbers live one thumb-flick
 * apart. Snap points keep each card centred; dots reflect the active card.
 *
 * Mock only — swipe the strip (or tap a dot) to move between KPIs.
 */
...
export function KpiCarouselDemo() {
  ...
  return (
    <ProposalCard
      ...
      intent="Замість однієї цифри — свайпабельна стрічка ключових метрик зі snap-центруванням. Свайпни або тапни крапку."
    >
      <PhoneFrame>
