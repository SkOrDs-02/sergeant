 ...
 * після бети або раніше, якщо зʼявиться бодай одна картка, у якій власник
 * упізнає шум.
 *
 * Чому це борг, а не норма: на пʼяти точках `|r| = 0.4` трапляється на
 ...
 * робить доказ сильнішим. Розширення набору пар (2026-08-05, з 9 до 15)
