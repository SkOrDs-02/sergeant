 ...
 * Status: Active
 *
 * Компактний рядок зв'язку — згорнутий вигляд другого й наступних зв'язків
 ...
 * зв'язки рівноцінні, — а вони не рівноцінні: `notablePairsFromSeries`
 * повертає їх упорядкованими за силою. Густина ранжує, однорідна сітка
 * зрівнює.
 *
 * Чому не таб «Зв'язки / Звіти» (розглядалось і відхилено власником
 * 2026-08-05): таб зрівняв би зв'язки зі звітами одразу після того, як
 * сторінку перейменували на «Зв'язки» саме через їхню цінність, і сховав би
 * стан мовчання — а він має бути видимим за каноном §6. Рядок не ховає
 * нічого: видно, що зв'язок є, з ким він і наскільки впевнений.
 */
...
/**
 * Згорнутий зв'язок, який розгортається в повну картку.
 *
...
export function CrossModuleLinkRow(props: CrossModuleLinkCardProps) {
  ...
  // Той самий градієнт, що і в картці. Якщо зв'язку не видно, ступеня немає
