  ...
  return (
    <SettingsGroup title="PWA та офлайн" icon="smartphone">
      ...
      {/* AI-CONTEXT: попередження «несинхронізовані зміни в офлайн-черзі
          ...
          там, де її нема, гірше за мовчання: людина не тисне кнопку, яка
          є єдиним виходом із застряглої версії. Справжня ціна дії інша,
          і саме вона тепер у тексті: прекеш зникає, і застосунок тягне
          файли з мережі заново. */}
      <ConfirmDialog
        open={confirmOpen}
