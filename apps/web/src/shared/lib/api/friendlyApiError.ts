...
export function friendlyApiError(
  ...
  // «мапер не мав чого сказати» і підставляє caller-специфічний fallback
  // («Помилка генерації звіту»), який КОНКРЕТНІШИЙ за будь-який загальний
  // текст про шлюз. Поставивши тут «Сервер тимчасово недоступний», ми
  // мовчки забрали б у кожного викликача його контекст.
  //
  // Тому текст із дією живе в доменній обгортці — див. `friendlyApiError`
  // у `core/lib/hubChatUtils.ts`, де caller-fallback-у немає і голий номер
  // доходив просто до екрана (звіт власника 2026-09-02).
