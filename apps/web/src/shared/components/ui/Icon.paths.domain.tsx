...
export const DOMAIN_PATHS: Record<string, ReactNode> = {
  ...
  // Два гліфи нижче додано 2026-08-29 разом із розширенням каталогу комори
  // з 7 до 13 категорій (спека `pantry-generic-names.md`): «Заморожене» і
  // «Соуси та пасти» не мали в атласі нічого, що не читалось би як інша
  // категорія — заморожене під `package` не відрізнялось від «Іншого», а
  // соуси під `droplet` — від бакалії.
  // `snowflake` — nutrition: frozen category.
  snowflake: (
    <>
  ...
  // `bottle` — nutrition: sauces & spreads category.
  bottle: (
    <>
