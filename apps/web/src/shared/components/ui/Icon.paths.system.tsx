/**
 * UI / chrome icon paths (chevrons + базові контроли). Виокремлено з
 * Icon.tsx (initiative 0001 Phase 2 — module decomposition). Ці маленькі
 * `ReactNode`-фрагменти імпортуються Icon.tsx-ом і зливаються у
 * спільний `PATHS` лукап.
 */

import type { ReactNode } from "react";

export const SYSTEM_PATHS: Record<string, ReactNode> = {
  ...
  // "Зміна пароля" eyebrow icon) and `OnboardingWizard`'s privacy step.
  lock: (
    <>
  ...
  // ("Активні сесії") to mark the device row.
  monitor: (
    <>
