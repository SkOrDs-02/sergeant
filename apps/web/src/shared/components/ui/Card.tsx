...
> = {
  finyk: {
    ...
    hero: "border shadow-hero-finyk bg-hero-grad-finyk border-finyk-soft-border/50 dark:bg-hero-ink-finyk dark:border-brand-400/25 dark:shadow-glow-inset-emerald",
  ...
  fizruk: {
    hero: "border shadow-hero-fizruk bg-hero-grad-fizruk border-fizruk-soft-border/50 dark:bg-hero-ink-fizruk dark:border-cyan-400/25 dark:shadow-glow-inset-cyan",
  ...
  routine: {
    hero: "border shadow-hero-routine bg-hero-grad-routine border-routine-soft-border/50 dark:bg-hero-ink-routine dark:border-coral-400/25 dark:shadow-glow-inset-coral",
  ...
  nutrition: {
    hero: "border shadow-hero-nutrition bg-hero-grad-nutrition border-nutrition-soft-border/50 dark:bg-hero-ink-nutrition dark:border-lime-400/25 dark:shadow-glow-inset-lime",
