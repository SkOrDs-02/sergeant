 ...
 *    в'їжджає з того боку, куди вів палець. Робиться transition-ом на
...
/** З якого зсуву в'їжджає нова сторінка. */
...
export function SwipePages<Id extends string>({
  ...
  // Спрямований в'їзд нової сторінки. `useLayoutEffect` ставить стартовий
