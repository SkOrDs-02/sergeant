...
export const messages = {
  ...
  onboarding: {
    ...
    tourCopyExplanation:
      "Огляд можливостей — що вміє кожен модуль і як вони працюють разом. Дані не зміняться. Почати з початку — знову обрати модулі та побачити перші підказки. Записи в модулях лишаться як є.",
