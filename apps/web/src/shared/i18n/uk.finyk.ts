...
export const finykPageMessages = {
  ...
  /**
   * Рівень 3: що бачить людина, коли міняє розподіл операції ВЖЕ ПІСЛЯ
   * привʼязки платежу (рішення власника 2026-09-11, канон § 4a). Обидва
   * тексти існують саме тому, що мовчазний перерахунок суми чи мовчазне
   * відвʼязування суперечать правилу модуля «нічого не пишеться мовчки».
   */
  /**
   * Аркуш ручної витрати/надходження. Рядки зʼїхали сюди при декомпозиції
   * аркуша (2026-09-12): доти файл цілком стояв в `eslint.i18n-allowlist`,
   * і винесені секції успадкували б 10 нових попереджень — тобто розпад
   * файлу погіршив би базу, яку той список існує скорочувати.
   */
  manualExpenseSheet: {
    kindTablistLabel: "Тип запису",
    kindExpense: "Витрата",
    kindIncome: "Надходження",
    dateLabel: "Дата",
    dateScrubberLabel: "Дата витрати",
    dateOther: "Інша дата",
    dateReveal: "Не сьогодні? Змінити дату",
    cancel: "Скасувати",
    save: "Зберегти",
    saveAndAddMore: "Зберегти й додати ще",
    delete: "Видалити",
  },
  debtSplitSync: {
    amountUpdated: "Сплату по «{debt}» оновлено: {from} → {to}",
    unlinkTitle: "У розподілі більше немає боргу",
    unlinkQuestion:
      "Ця операція зарахована як сплата {amount} по «{debt}», але на борг у ній тепер не розписано нічого. Відвʼязати її від пасиву?",
    unlinkConfirm: "Відвʼязати",
    unlinkKeep: "Залишити",
  },
