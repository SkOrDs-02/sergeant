...
export function SessionView({
  ...
  // Умова саме по `focused`, а не по `focusItemId`: у неіснуючого id
  // рендериться список, і режим вибору там має працювати — так само, як
  // вирішує `canGroup` нижче (знахідки рев'ю 2026-09-11).
  const selectMode = groupSelectMode && !focused;
