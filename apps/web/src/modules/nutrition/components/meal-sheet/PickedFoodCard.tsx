/**
 * PickedFoodCard — картка зв'язаного продукту на кроці «fill»: КБЖВ з
 * етикетки на 100 г, вага з'їденої порції і живий перерахунок макросів
 * під цю вагу.
 *
 ...
 * рендері, у якому з'являється `pickedFood` (авто-перехід). Через це
 * поле ваги розмонтовувалось рівно тоді, коли мало б з'явитись: продукт
