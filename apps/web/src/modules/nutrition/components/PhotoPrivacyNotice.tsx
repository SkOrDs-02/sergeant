...
export function PhotoPrivacyNotice({
  ...
  return (
    <div className="mb-3 rounded-2xl border border-line bg-panelHi p-3">
      ...
      {/* AI-NOTE: попередження-дисклеймер у компактній картці: дрібний
          кегль тут свідомий, банер не має перекривати сам крок із фото. */}
      ...
      {/* AI-NOTE: той самий регістр, що й абзац вище: підпис усередині
          нотіса, а не самостійний текст сторінки. */}
      {blockingAnalysis && (
