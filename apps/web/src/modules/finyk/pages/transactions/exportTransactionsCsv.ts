 ...
 * - **Сума — у гривнях із крапкою.** У домені гроші живуть копійками як
 *   `number`; ділення на 100 робиться один раз тут. Крапка, а не кома, бо
 *   роздільник полів — кома: число з комою довелося б брати в лапки, і
