...
// своєї вкладки («Додатково») — forced-first-of-tab (Варіант A, чинний на
// момент фіксу) сама по собі давала той самий результат, тож гейт лишався
// б зеленим навіть без `anchorId`-логіки в SettingsGroup. `#settings-plan`
// — ДРУГА секція вкладки «Загальні» (Дашборд — перша): розгорнути її може
// ЛИШЕ хеш. Forced-first-of-tab скасовано рішенням власника 2026-09-11 —
// «Дашборд» тепер не відкривається автоматично взагалі, тож нижче це
// заразом і пряме регресійне покриття.
