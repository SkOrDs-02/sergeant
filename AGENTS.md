...
> **Last touched:** 2026-08-18 by @claude. **Next review:** 2026-11-23.
> **Status:** Active
...
**Ратчет 2026-08-18 (JS 1.35 → 1.42 MB).** Дві фічі приїхали в один день і разом зʼїли ~5% запасу, який лишав ратчет 2026-08-02: сканування чеків (PR #818, #822–#825, у main) і інтеграція Silpo (PR #819). Факт після їх злиття — **1.36 MB**, тобто перебір 14 kB.
