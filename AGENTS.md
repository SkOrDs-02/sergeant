...
| Backend `/health` p95                       | < 100 ms                                                                 | Formalized in [`docs/observability/SLO.md §2.1`](./docs/observability/SLO.md#21-health-endpoint-p95); Alertmanager ticket `BackendHealthP95High`. |
